...
<div class="pop_layer_cont">
    <div class="tip" style="margin-bottom: 10px;padding-bottom: 0px;padding-top: 0px; text-align: center;">正在更新角色'${roleVO.name }'的权限</div>
    <form action="${pageContext.request.contextPath}/mm/role/update.do" method="post" id="postform">
    <input type="hidden" name="id" value="${roleVO.id }"/>
    <input type="hidden" name="name" value="${roleVO.name }"/>
    <input type="hidden" name="description" value="${roleVO.description }"/>
