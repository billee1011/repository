...
<div id="mulSelectCrossAreaDiv" style="display:none;" class="pop_layer_v2">
    ...
    <div class="pop_layer_main">
        ...
        <div class="pop_layer_cont">
        	<input type="checkbox" class="btn_select_16" onchange="allCrossSelectOrNot(this)"/>当前页全选
...
<div class="pop_layer_ft"><a class="btn btn_submit not_close btn_blue" href="javascript:multiCrossAssure();"><span class="">确定</span></a><a class="btn btn_white_2 btn_close" href="javascript:multiCrossCancel();"><span>取消</span></a></div>
</div>
