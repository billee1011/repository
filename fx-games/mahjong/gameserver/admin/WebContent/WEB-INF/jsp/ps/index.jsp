...
<div class="manage_content mod_cdb">
	...
	<div class="mod_slidenav" id="slide_nav">
		<h3><div><em>运维系统</em></div></h3>
		<div class="slidenav_area">
			<ul>
			   <li>
                	<a href="javascript:void(0);" class="parentmenu">服务器列表<i class="ico ico_arrowright"></i></a>
                	<ul class="submenu">
						<li><a href="${ctx}/ps/area/gamelist.do" class="submenu_link">游戏服务器</a></li>
					</ul>
            	</li>
				<li>
					<a href="javascript:void(0);" class="parentmenu">服务器维护管理<i class="ico ico_arrowright"></i></a>
                	<ul class="submenu">
						<li><a href="${ctx }/ps/serverManager.do" class="submenu_link">服务器维护</a></li>
					</ul>
            	</li>
        	</ul>
    	</div>
