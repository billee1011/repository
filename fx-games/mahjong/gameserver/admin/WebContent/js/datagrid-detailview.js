var detailview = $.extend({}, $.fn.datagrid.defaults.view, {
	...
	onBeforeRender: function(target){
		...
		if (!hasExpander){
			...
			if ($('tr',t).length == 0){
				td.find('.datagrid-header-expander').html('<span class="datagrid-row-expander datagrid-row-expand" onclick="toggleExpand(this);" style="display:inline-block;width:16px;height:16px;cursor:pointer;"></span>');
