...
public class ActivityDict {
	...
	public List<ActivityDetailResponse> getActivityDetailResponse(int gameID){
		 ...
		 for(ActivityModel model :list) {
			 ...
			 activityDetailResponse.setActivityType(model.getType());
			 activityDetailResponse.setHref(model.getHref()==null?"":model.getHref());
			 activityDetailResponse.setName(model.getName()==null?"":model.getName());
			 activityDetailResponse.setContent(model.getContent()==null?"":model.getContent());
