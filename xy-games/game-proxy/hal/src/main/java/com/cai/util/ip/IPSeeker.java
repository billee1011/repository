...
/**
 * <pre>
 *  // 在并发下有问题，临时加锁一下，每次操作少于2ms，以后再看是否要改为并发的
...
public class IPSeeker {
	...
	private IPSeeker() {
		...
		String pathname = WRSystem.HOME+"../common/qqwry.dat";
		...
		try {
			...
			ipFile = new RandomAccessFile(_file, "r");
		} catch (FileNotFoundException e) {
			System.out.println("IP地址信息文件没有找到，IP显示功能将无法使用:" + pathname);
			ipFile = null;
	...
	public static void main(String[] args) {
		...
		System.out.println(p.getAddress("163.125.34.84"));
	}
}