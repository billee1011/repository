...
public class PtAPIServiceImpl extends AbstractService {
	 ...
	 * @return
	 */
	public String getPrepayId(String gameOrderID, String body, int total_fee, String create_ip, int productID) {
		...
		SysParamModel sysParamModel5002 = SysParamDict.getInstance().getSysParamModelDictionaryByGameId(1).get(5002);// 微信支付回调地址str1
	...
	public PayBuyResponse getPayBuyResponse(String prepayID,String gameOrderID) {
