...
public class MessageResponse {
	...
	public static AccountResponse.Builder getAccountResponse(Account account){
		...
		accountResponseBuilder.setIp(account.getLast_login_ip());
		accountResponseBuilder.setIpAddr(account.getIp_addr());
	...
	public static LogicRoomAccountItemRequest.Builder getLogicRoomAccountItemRequest(Session session){
		...
		buider.setAccountIp(session.getClientIP());
		buider.setIpAddr(account.getIp_addr());
	 ...
	 * @return
	 */
	public static AccountPropertyResponse.Builder getAccountPropertyResponse(int prop_id,Integer val1,Integer val2,Integer val3,String str1,String str2,Long vallong1){
	...
	public static List<AccountPropertyResponse> getSysAccountPropertyResponseList(int game_id,Account account){
		...
		for(SysParamModel model : map.values()){
			if(model.getSend_client()!=1)
				continue;
			AccountPropertyResponse.Builder accountPropertyResponseBuilder = getAccountPropertyResponse(model.getId(), model.getVal1(), model.getVal2(), model.getVal3(), model.getStr1(), model.getStr2(),null);
		...
		if(accountParamModel!=null){
			...
			if(sysNoticeModel!=null){
				...
				AccountPropertyResponse.Builder accountPropertyResponseBuilder =getAccountPropertyResponse(EPropertyType.RED_SYS_NOTIC.getId(), flag, null, null, null, null, null);
				list.add(accountPropertyResponseBuilder.build());
			}
		}
