		...
		try {
			...
			case RsResponseType.ACCOUNT_UP_VALUE: {
				...
				if (new_gold != old_gold) {
					AccountPropertyResponse.Builder accountPropertyResponseBuilder = MessageResponse.getAccountPropertyResponse(EPropertyType.GOLD.getId(), null, null, null, null, null, new_gold);
					accountPropertyListResponseBuilder.addAccountProperty(accountPropertyResponseBuilder);
				}
				if(old_agent != new_agent){
					AccountPropertyResponse.Builder accountPropertyResponseBuilder = MessageResponse.getAccountPropertyResponse(EPropertyType.VIP.getId(), new_agent, null, null, null, null, null);
					accountPropertyListResponseBuilder.addAccountProperty(accountPropertyResponseBuilder);
				}
				if(new_password!=null && !new_password.equals(old_password)){
					...
					AccountPropertyResponse.Builder accountPropertyResponseBuilder = MessageResponse.getAccountPropertyResponse(EPropertyType.IS_NULL_AGENT_PW.getId(), is_null_agent_pw, null, null, null, null, null);
					accountPropertyListResponseBuilder.addAccountProperty(accountPropertyResponseBuilder);
				}
