 ...
 * @author wu_hc
 */
public final class TestPlayerViewHandler extends ClientHandler<PlayerViewRequest> {

	/**
	 * 该命令需要查询数据库，限制玩家请求频率
	 */
	private static final AttributeKey<Integer> REQ_TIME_KEY = AttributeKey.valueOf("REQ_TIME_KEY");
