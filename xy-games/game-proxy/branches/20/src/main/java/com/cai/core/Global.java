...
public class Global {
	 ...
	 * 微信获取订单
	 */
	private static ScheduledThreadPoolExecutor wxPayService = new ScheduledThreadPoolExecutor(20,
	 ...
	 * 微信登录
	 */
	private static ScheduledThreadPoolExecutor wxService = new ScheduledThreadPoolExecutor(50,
	 ...
	 * 预留接口可以根据标识指定线程池执行
	 */
	private static ScheduledExecutorService getService(String taskCategary) {
