...
public final class ServiceManager
{
	...
	private Map<Integer, AbstractService> allServices = null;
	 ...
	 */
	private AbstractService loadService(int order, String _className, String serviceName) throws ClassNotFoundException,
