...
//		}
	...
	private void show_xiao_hu(MJTable table, int seat_index){
		ChiHuRight start_hu_right = table.GRR._start_hu_right[seat_index];
		//效果
		table.operate_effect_action(seat_index,MJGameConstants.EFFECT_ACTION_TYPE_HU,start_hu_right.type_count,start_hu_right.type_list,start_hu_right.type_count,MJGameConstants.INVALID_SEAT);
		...
		table.operate_show_card(seat_index,MJGameConstants.Show_Card_XiaoHU, hand_card_count,cards,MJGameConstants.INVALID_SEAT);
	}
