 ...
 *
 */
public class MJHandlerDispatchCard_ZhuZhou extends MJHandlerDispatchCard {

	private GangCardResult m_gangCardResult;
	
	public MJHandlerDispatchCard_ZhuZhou(){
			...
			if(cbActionMask!=MJGameConstants.WIK_NULL){//有杠
				...
				for(int i= 0; i < m_gangCardResult.cbCardCount; i++){
					...
					if (table.GRR._left_card_count > 2) {
						...
						is_ting = table.is_zhuzhou_ting_card(table.GRR._cards_index[_seat_index],
