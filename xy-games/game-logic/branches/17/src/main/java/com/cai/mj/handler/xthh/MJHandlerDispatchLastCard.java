...
//			table.operate_player_status();
			int next_player =  (_seat_index + MJGameConstants.GAME_PLAYER + 1) % MJGameConstants.GAME_PLAYER;
			table.exe_dispatch_last_card(next_player,MJGameConstants.WIK_NULL,1500);
		}
