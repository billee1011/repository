...
public class MJHandlerDispatchCard_HZ extends MJHandlerDispatchCard {
	...
	public MJHandlerDispatchCard_HZ(){
	...
	public void exe(MJTable table) {
		...
		if(table.DEBUG_CARDS_MODE)_send_card_data = 0x18;
	...
	public boolean handler_operate_card(MJTable table,int seat_index, int operate_code, int operate_card){
		...
		switch (operate_code) {
			...
			case MJGameConstants.WIK_ZI_MO: // 自摸
			{
				...
				// 下局胡牌的是庄家
				table.set_niao_card(_seat_index,MJGameConstants.INVALID_VALUE,true,add_niao);// 结束后设置鸟牌
