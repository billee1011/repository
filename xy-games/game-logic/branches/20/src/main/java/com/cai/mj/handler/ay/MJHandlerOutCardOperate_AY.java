...
public class MJHandlerOutCardOperate_AY extends MJHandlerOutCardOperate {
	//执行出牌动作
	@Override
...
//			int ting_count = table._playerStatus[_out_card_player]._hu_card_count;
		...
		// 玩家出牌 响应判断,是否有吃碰杠补胡
		boolean bAroseAction = table.estimate_player_out_card_respond_ay(_out_card_player, _out_card_data);//, EstimatKind.EstimatKind_OutCard
