...
# memory options
MEM_CONFIG="-Xms$TOTAL_AVAILABLE_MEMORY -Xmx$TOTAL_AVAILABLE_MEMORY -Xmn$YOUNG_EDEN -XX:+UseConcMarkSweepGC -XX:SurvivorRatio=6"
...
#GC_LOG
GC_LOG="-XX:+PrintGCDateStamps -XX:+PrintGCDetails -XX:+PrintHeapAtGC -Xloggc:./gc.log"
