...
public class MJHandlerDispatchCard_HeNanxy extends MJHandlerDispatchCard<MJTable> {
	...
	public void exe(MJTable table) {
		...
		if(table._player_result.nao[_seat_index]>0 && _seat_index==table._banker_select 
		...
		if(table._player_result.nao[_seat_index]>0 && _seat_index!=table._banker_select && table.GRR._dispatch_count[_seat_index] == 0){
			real_card+=8000;
		}
		else{
			if(table._player_result.nao[_seat_index]>0 && _seat_index==table._banker_select && table.GRR._dispatch_count[_seat_index]==1){
				real_card+=8000;
			}
		}
		// 发送数据
...
//		}
	...
	public boolean handler_player_be_in_room(MJTable table,int seat_index) {
		...
		if(table._player_result.nao[_seat_index]>0 && _seat_index!=table._banker_select && table.GRR._dispatch_count[_seat_index] == 1){
			...
			if(table._player_result.nao[_seat_index]>0 && _seat_index==table._banker_select && table.GRR._dispatch_count[_seat_index]==2){
				real_card+=8000;
			}
		}
