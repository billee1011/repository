...
public class MJHandlerOutCardOperate_HeNan_lh extends MJHandlerOutCardOperate<MJTable> {
	...
	public void exe(MJTable table) {
		...
		// 河南麻将,检查听牌
		table._playerStatus[_out_card_player]._hu_card_count = table.get_henan_lh_ting_card(table._playerStatus[_out_card_player]._hu_cards,
		...
		// 玩家出牌 响应判断,是否有吃碰杠补胡
		boolean bAroseAction = table.estimate_player_out_card_respond_henan_luo_he(_out_card_player, _out_card_data);// ,
	...
	public boolean handler_operate_card(MJTable table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_he_nan_lh(target_player, _out_card_player, _out_card_data, false);
