...
public class MJHandlerChiPeng_XC extends MJHandlerChiPeng<MJTable> {
	...
	public void exe(MJTable table) {
		...
		if (table.GRR._left_card_count > 0) {
			// 只检测手上的牌能不能杠
			int cbActionMask = table._logic.analyse_gang_card_all_xc(table.GRR._cards_index[_seat_index], table.GRR._weave_items[_seat_index], table.GRR._weave_count[_seat_index],
