...
public abstract class BTZHandler {

	public abstract void exe(BTZTable table);
	 ...
	 * @return
	 */
	public boolean handler_operate_card(BTZTable table, int seat_index, int operate_code, int operate_card,int luoCode) {
		return false;
	}
	public boolean handler_call_banker(BTZTable table, int seat_index,int call_banker) {
		return false;
	}
	public boolean handler_add_jetton(BTZTable table, int seat_index, int jetton) {
		return false;
	}
	...
	public boolean handler_release_room(BTZTable table, Player player, int opr_code) {
		return table.handler_release_room(player, opr_code);
	}

	public boolean handler_audio_chat(BTZTable table, Player player, com.google.protobuf.ByteString chat, int l,
			float audio_len) {
		return false;
	}
