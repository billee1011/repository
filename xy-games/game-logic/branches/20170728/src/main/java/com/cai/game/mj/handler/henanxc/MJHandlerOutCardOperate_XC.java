...
public class MJHandlerOutCardOperate_XC extends MJHandlerOutCardOperate<MJTable> {
	...
	public void exe(MJTable table) {
		...
		if(table._playerStatus[_out_card_player].is_bao_ting()){
			...
			table._playerStatus[_out_card_player]._hu_card_count = table.get_xc_ting_card(_out_card_player,table._playerStatus[_out_card_player]._hu_cards, table.GRR._cards_index[_out_card_player], 
		...
		bAroseAction = table.estimate_player_out_card_respond_henan_xc(_out_card_player, _out_card_data);//, EstimatKind.EstimatKind_OutCard
		// 如果没有需要操作的玩家，派发扑克
		if (bAroseAction == false) {
//			if(table.has_rule(GameConstants.GAME_RULE_HENAN_DAI_HUN)&&table._playerStatus[_out_card_player].is_bao_ting()==false){
//				table._playerStatus[_out_card_player]._hu_card_count = table.get_xc_ting_card(_out_card_player,table._playerStatus[_out_card_player]._hu_cards, table.GRR._cards_index[_out_card_player], 
//						table.GRR._weave_items[_out_card_player], table.GRR._weave_count[_out_card_player]);
//				ting_count = table._playerStatus[_out_card_player]._hu_card_count;
//				if(ting_count>0){
...
//
//				// 删除扑克
//				if (table._logic.remove_card_by_index(table.GRR._cards_index[_out_card_player], operate_card) == false) {
...
//				}
				...
				table.exe_dispatch_card(next_player,GameConstants.WIK_NULL,GameConstants.DELAY_SEND_CARD_DELAY);
				// 报听
//				table.exe_out_card_bao_ting(_out_card_player, operate_card, GameConstants.WIK_NULL);
				return true;
			}
			default:
				return false;
