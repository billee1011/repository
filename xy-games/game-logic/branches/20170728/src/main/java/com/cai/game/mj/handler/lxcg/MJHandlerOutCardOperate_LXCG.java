...
public class MJHandlerOutCardOperate_LXCG extends MJHandlerOutCardOperate<MJTable> {
	...
	public void exe(MJTable table) {
		...
		// 玩家出牌 响应判断,是否有吃碰杠补胡
		boolean bAroseAction = table.estimate_player_out_card_respond_lxcg(_out_card_player, _out_card_data);// ,
	...
	public boolean handler_operate_card(MJTable table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			// MJGameConstants.GAME_PLAYER + 1) % MJGameConstants.GAME_PLAYER;
			// }else{
			// table._banker_select = table.GRR._banker_player;
			// }
			...
			table.process_chi_hu_player_score_lxcg(target_player, _out_card_player, _out_card_data, false);
