...
public class MJHandlerOutCardOperate_HeNanpds extends MJHandlerOutCardOperate<MJTable> {
...
//		}
		...
		//河南麻将,检查听牌
		table._playerStatus[_out_card_player]._hu_card_count = table.get_henan_ting_card(table._playerStatus[_out_card_player]._hu_cards, table.GRR._cards_index[_out_card_player], 
		...
		// 玩家出牌 响应判断,是否有吃碰杠补胡
		boolean bAroseAction = table.estimate_player_out_card_respond_henan(_out_card_player, _out_card_data);//, EstimatKind.EstimatKind_OutCard
...
//				}
				...
				table.process_chi_hu_player_score_henan_pds(target_player,_out_card_player, _out_card_data,false);
