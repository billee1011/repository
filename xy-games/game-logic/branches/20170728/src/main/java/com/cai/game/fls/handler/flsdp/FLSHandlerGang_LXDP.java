...
public class FLSHandlerGang_LXDP extends FLSHandlerGang {
...
//				}
	...
	public boolean handler_player_be_in_room(FLSTable table,int seat_index) {
		...
		//效果
		table.operate_effect_action(_seat_index,GameConstants.EFFECT_ACTION_TYPE_ACTION, 1, new long[]{_action}, 1,seat_index,_center_card,_p,false);
