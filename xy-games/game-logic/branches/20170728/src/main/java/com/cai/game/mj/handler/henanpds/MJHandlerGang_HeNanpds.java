		...
		if(GameConstants.GANG_TYPE_AN_GANG == _type){
			for (int i = 0; i < table.getTablePlayerNumber(); i++) {
				...
				if(gang_pao) {//杆跑--双方下跑分数+底分
					...
					int xiapaoF=0;
					int xiaopaoS=0;
					xiapaoF=(table._player_result.pao[i]>table._player_result.qiang[i])?table._player_result.pao[i]:table._player_result.qiang[i];
					xiaopaoS=(table._player_result.pao[_seat_index]>table._player_result.qiang[_seat_index])?table._player_result.pao[_seat_index]:table._player_result.qiang[_seat_index];					
...
//					score += table._player_result.pao[i]+table._player_result.pao[_seat_index];
			...
			if(gang_pao) {//杆跑--双方下跑分数+底分
				...
				int xiapaoF=0;
				int xiaopaoS=0;
				xiapaoF=(table._player_result.pao[_provide_player]>table._player_result.qiang[_provide_player])?table._player_result.pao[_provide_player]:table._player_result.qiang[_provide_player];
				xiaopaoS=(table._player_result.pao[_seat_index]>table._player_result.qiang[_seat_index])?table._player_result.pao[_seat_index]:table._player_result.qiang[_seat_index];					
				score +=xiapaoF+xiaopaoS;
