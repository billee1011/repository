...
public class LHQHandlerGang_HD extends HHHandlerGang {
...
//			}
	...
	protected boolean exe_gang(HHTable table) {
		...
		if(an_long_count > 0 && (table._long_count[_seat_index] == 0 ||(table._long_count[_seat_index]==1&&_type == GameConstants.PAO_TYPE_TI_MINE_LONG)) )
		{
