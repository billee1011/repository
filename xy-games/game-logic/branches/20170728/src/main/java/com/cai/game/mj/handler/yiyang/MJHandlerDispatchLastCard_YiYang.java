...
public class MJHandlerDispatchLastCard_YiYang extends MJHandlerDispatchCard<MJTable_YiYang> {
	...
	@Override
	public boolean handler_be_set_trustee(MJTable_YiYang table, int seat_index) {
