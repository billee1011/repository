...
public class MJHandlerOutCardOperate_HeNan_ZhouKou extends MJHandlerOutCardOperate<MJTable> {
	...
	public void exe(MJTable table) {
		...
		//红中麻将,检查听牌
		table._playerStatus[_out_card_player]._hu_card_count = table.get_henan_zhou_kou_ting_card(table._playerStatus[_out_card_player]._hu_cards, table.GRR._cards_index[_out_card_player], 
		...
		// 玩家出牌 响应判断,是否有吃碰杠补胡
		boolean bAroseAction = table.estimate_player_out_card_respond_henan_zhou_kou(_out_card_player, _out_card_data);//, EstimatKind.EstimatKind_OutCard
