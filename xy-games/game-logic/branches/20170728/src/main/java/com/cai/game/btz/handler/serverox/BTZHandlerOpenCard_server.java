package com.cai.game.btz.handler.serverox;
...
public class BTZHandlerOpenCard_server extends BTZHandlerOpenCard{
	...
	public boolean handler_open_cards(BTZTable table, int seat_index,boolean open_flag) {
		...
		table._card_type_ox[seat_index] = table._logic.get_card_type(table.GRR._cards_data[seat_index], GameConstants.OX_MAX_CARD_COUNT,table._game_rule_index);
