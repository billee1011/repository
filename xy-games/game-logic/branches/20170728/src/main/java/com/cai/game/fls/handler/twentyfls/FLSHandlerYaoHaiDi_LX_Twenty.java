 ...
 *
 */
public class FLSHandlerYaoHaiDi_LX_Twenty extends FLSHandlerYaoHaiDi {
	...
	public boolean handler_operate_card(FLSTable table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_fls_twenty(target_player, _seat_index, target_card, false);
