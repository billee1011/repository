...
import com.cai.game.hh.handler.axwmq.WMQHandlerChiPeng_AX;
import com.cai.game.hh.handler.axwmq.WMQHandlerChuLiFirstCard_AX;
import com.cai.game.hh.handler.axwmq.WMQHandlerDispatchCard_AX;
import com.cai.game.hh.handler.axwmq.WMQHandlerDispatchFirstCard_AX;
import com.cai.game.hh.handler.axwmq.WMQHandlerGang_AX;
import com.cai.game.hh.handler.axwmq.WMQHandlerOutCardOperate_AX;
...
//		int cards[] = new int[] {0x07,0x07,0x07,0x04,0x02,0x02,0x02,0x04,0x12,0x13,0x11,0x12,0x13,0x19,0x19,0x19,0x18,0x18,0x18,0x11};
//		int cards1[] = new int[] {0x08,0x06,0x04,0x04,0x02,0x02,0x02,0x04,0x12,0x13,0x11,0x12,0x13,0x19,0x19,0x19,0x18,0x18,0x18,0x11};
//		int cards2[] = new int[] {0x08,0x06,0x04,0x04,0x02,0x02,0x02,0x04,0x12,0x13,0x11,0x12,0x13,0x19,0x19,0x19,0x18,0x18,0x18,0x11};
...
//				 0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04,
//				 0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04,
//				 0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04,
//				 0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04,
//				 0x08, 0x04, 0x03, 3, 5, 5, 5, 5, 26, 6, 6, 21, 9, 17, 18, 24, 10, 7, 1, 
//				 21, 26, 7};
//		 testRealyCard(realyCards);
	...
	public int analyse_chi_hu_card(int cards_index[], WeaveItem weaveItems[], int weave_count, int seat_index,
		...
		if (GameConstants.GAME_TYPE_PHZ_CHD == _game_type_index) {
			return analyse_chi_hu_card_phz_chd(cards_index, weaveItems, weave_count, seat_index, provider_index, cur_card,
					chiHuRight, card_type,hu_xi);
		}
		if (GameConstants.GAME_TYPE_PHZ_XT == _game_type_index) {
			return analyse_chi_hu_card_phz_xt(cards_index, weaveItems, weave_count, seat_index, provider_index, cur_card,
					chiHuRight, card_type,hu_xi);
		}
		...
		if (GameConstants.GAME_TYPE_LHQ_HD == _game_type_index) {
			return analyse_chi_hu_card_lhqhd(cards_index, weaveItems, weave_count, seat_index, provider_index, cur_card,
					chiHuRight, card_type,dispatch);
		}
		if (GameConstants.GAME_TYPE_THK_HY == _game_type_index) {
			return analyse_chi_hu_card_thk(cards_index, weaveItems, weave_count, seat_index, provider_index, cur_card,
					chiHuRight, card_type,dispatch);
		}
		if(GameConstants.GAME_TYPE_WMQ_AX == _game_type_index){
			return analyse_chi_hu_card_wmq(cards_index, weaveItems, weave_count, seat_index, provider_index, cur_card,
					chiHuRight, card_type,dispatch);
		}
		return 0;
	}
	 ...
	 * @return
	 */
	public int analyse_chi_hu_card_wmq(int cards_index[], WeaveItem weaveItems[], int weaveCount, int seat_index,
		...
		boolean bValue = _logic.analyse_card_wmq(cbCardIndexTemp, weaveItems, weaveCount, seat_index, provider_index,
		...
		{
			if(!(weaveItems[i].weave_kind == GameConstants.CHR_TIAN_HU))
	 ...
	 * @return
	 */
	public int analyse_chi_hu_card_lhqhd(int cards_index[], WeaveItem weaveItems[], int weaveCount, int seat_index,
			int provider_index, int cur_card, ChiHuRight chiHuRight, int card_type,boolean dispatch) {
		...
		if (cur_card != 0) {
			for (int i = 0; i < weaveCount; i++) {
				if ((cur_card == weaveItems[i].center_card) && ((weaveItems[i].weave_kind == GameConstants.WIK_PENG)
					...
					boolean temp_bValue = _logic.analyse_card_fphz(cbCardIndexTemp, weaveItems, weaveCount, seat_index,
	 ...
	 * @return
	 */
	public int analyse_chi_hu_card_thk(int cards_index[], WeaveItem weaveItems[], int weaveCount, int seat_index,
			int provider_index, int cur_card, ChiHuRight chiHuRight, int card_type,boolean dispatch) {
	 ...
	 * @return
	 */
	public int analyse_chi_hu_card_phz_chd(int cards_index[], WeaveItem weaveItems[], int weaveCount, int seat_index,
			int provider_index, int cur_card, ChiHuRight chiHuRight, int card_type,int hu_xi_hh[]) {
		...
		for (int j = 0; j < 7; j++) {
			...
			_xiao_pai_count[seat_index] += _logic.get_xiao_card(_hu_weave_items[seat_index][j].weave_kind ,_hu_weave_items[seat_index][j].center_card);
		}
		if (analyseItem.curCardEye == true) {
			_hu_weave_items[seat_index][_hu_weave_count[seat_index]].weave_kind = GameConstants.WIK_DUI_ZI;
			_hu_weave_items[seat_index][_hu_weave_count[seat_index]].center_card = analyseItem.cbCardEye;
			...
			_da_pai_count[seat_index] += _logic.get_da_card(_hu_weave_items[seat_index][_hu_weave_count[seat_index]].weave_kind ,_hu_weave_items[seat_index][_hu_weave_count[seat_index]].center_card);
			_xiao_pai_count[seat_index] += _logic.get_xiao_card(_hu_weave_items[seat_index][_hu_weave_count[seat_index]].weave_kind ,_hu_weave_items[seat_index][_hu_weave_count[seat_index]].center_card);
			_hu_weave_count[seat_index]++;
		}
	 ...
	 * @return
	 */
	public int analyse_chi_hu_card_phz_xt(int cards_index[], WeaveItem weaveItems[], int weaveCount, int seat_index,
			int provider_index, int cur_card, ChiHuRight chiHuRight, int card_type,int hu_xi_hh[]) {
	...
	public int estimate_player_respond_hh(int seat_index, int provider_index, int card_data, int pao_type[],
		...
		// 玩家出版的动作检测 跑
		public int estimate_player_respond_phz_chd(int seat_index, int provider_index, int card_data, int pao_type[],
				boolean dispatch) {
			// 变量定义
			int bAroseAction = GameConstants.WIK_NULL;// 出现(是否)有
			pao_type[0] = 0;
		...
		// 玩家出版的动作检测 跑
		public int estimate_player_respond_xiao(int seat_index, int provider_index, int card_data, int pao_type[],
				boolean dispatch) {
			// 变量定义
			int bAroseAction = GameConstants.WIK_NULL;// 出现(是否)有
			pao_type[0] = 0;
	...
	public void process_chi_hu_player_score_phz_chd(int seat_index, int provide_index, int operate_card, boolean zimo) {
		...
		int wFanShu = _logic.get_chi_hu_action_rank_phz_chd(seat_index,_da_pai_count[seat_index],_xiao_pai_count[seat_index],_tuan_yuan_count[seat_index],this._huang_zhang_count,this._hong_pai_count[seat_index],chr);// 番数
	...
	public void process_chi_hu_player_score_phz_xt(int seat_index, int provide_index, int operate_card, boolean zimo) {
		...
		if(this.has_rule(GameConstants.GAME_RULE_JI_BENMING_TANG)){
			...
			wFanShu= _logic.get_chi_hu_action_rank_phz_xt(seat_index,_da_pai_count[seat_index],_xiao_pai_count[seat_index],_tuan_yuan_count[seat_index],this._huang_zhang_count,this._hong_pai_count[seat_index],chr);// 番数
		}
		// 统计
		if (zimo) {
			// 自摸
...
//			this.log_error("nickname = "+this.get_players()[seat_index].getNick_name() + "nickname =  "+this.get_players()[i].getNick_name() +roomResponse.getAudioLen()+ "time=" + System.currentTimeMillis());
	...
	private void countCardType(ChiHuRight chiHuRight, int seat_index) {
		try {
			...
			if (!(chiHuRight.opr_and(GameConstants.CHR_HAI_HU)).is_empty()) {
				wFanShu = 3;
				MongoDBServiceImpl.getInstance().card_log(this.get_players()[seat_index], ECardType.hhhaihu, "", 0,
						0l, this.getRoom_id());
			}

			if (!(chiHuRight.opr_and(GameConstants.CHR_TING_HU)).is_empty()) {
				MongoDBServiceImpl.getInstance().card_log(this.get_players()[seat_index], ECardType.hhtinghu, "", 0,
						0l, this.getRoom_id());
			}

			if (!(chiHuRight.opr_and(GameConstants.CHR_DA_HU).is_empty())) {
				MongoDBServiceImpl.getInstance().card_log(this.get_players()[seat_index], ECardType.hhdahu, "", 0,
						0l, this.getRoom_id());
			}
			...
			if (!(chiHuRight.opr_and(GameConstants.CHR_DUI_ZI_HU)).is_empty()) {
				MongoDBServiceImpl.getInstance().card_log(this.get_players()[seat_index], ECardType.hhduizihu, "", 0, 0l,
						this.getRoom_id());
			}
			...
			if (!(chiHuRight.opr_and(GameConstants.CHR_HANG_HANG_XI)).is_empty()) {
				MongoDBServiceImpl.getInstance().card_log(this.get_players()[seat_index], ECardType.hhhanghangxi, "", 0, 0l,
						this.getRoom_id());
			}
	...
	public boolean is_tian_hu(int seat_index ,int provider, int cur_card_data)
	{
