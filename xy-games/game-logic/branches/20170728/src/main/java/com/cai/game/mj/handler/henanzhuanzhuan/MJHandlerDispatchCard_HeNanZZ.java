 ...
 *
 */
public class MJHandlerDispatchCard_HeNanZZ extends MJHandlerDispatchCard<MJTable> {
	...
	public void exe(MJTable table) {
		...
		if (table.GRR._left_card_count == 0) {
			...
			table._banker_select=(table._banker_select + 1) %  table.getTablePlayerNumber();
			// 流局
