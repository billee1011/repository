 ...
 *
 */
public class THKHandlerDispatchCard_HY extends HHHandlerDispatchCard {
...
//		table._playerStatus[_seat_index].chi_hu_round_valid();// 可以胡了
		...
		--table.GRR._left_card_count;
		 ...
		 table.log_error(_seat_index + "牌" +_send_card_data );
//		 _send_card_data = 0x25;
		...
		table.log_error(_seat_index+"发牌 "+_send_card_data+"ti_sao = " + ti_sao);
	...
	public boolean handler_operate_card(HHTable table, int seat_index, int operate_code, int operate_card,int luoCode) {
		...
		case GameConstants.WIK_LEFT: // 上牌操作
		{
			...
			table.exe_chi_peng(target_player, _seat_index, target_action, target_card,
					GameConstants.CHI_PENG_TYPE_DISPATCH,luoCode);
			return true;
		}
