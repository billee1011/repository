...
public abstract class NNHandler {
	...
	// 准备
	public boolean handler_player_ready(NNTable table, int seat_index) {
	...
	public boolean handler_audio_chat(NNTable table, Player player, com.google.protobuf.ByteString chat, int l,
			float audio_len) {
		return false;
	}
