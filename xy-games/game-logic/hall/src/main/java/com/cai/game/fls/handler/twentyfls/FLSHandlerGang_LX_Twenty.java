...
public class FLSHandlerGang_LX_Twenty extends FLSHandlerGang {
...
//				}
	...
	public boolean handler_operate_card(FLSTable table, int seat_index, int operate_code, int operate_card) {
		...
		if (jie_pao_count > 0) {
			...
			table.process_chi_hu_player_score_fls_twenty(target_player, _seat_index, _center_card, false);
	...
	protected boolean exe_gang(FLSTable table) {
		...
		//检查听牌
		table._playerStatus[_seat_index]._hu_card_count = table.get_fls_ting_card_twenty(
