...
public class FLSHandlerDispatchLastCard_LX_Twenty extends FLSHandlerDispatchCard {
	...
	public void exe(FLSTable table) {
		...
		if (curPlayerStatus.has_action()) {// 有动作
			...
			table.exe_dispatch_last_cardtwenty(next_player, GameConstants.WIK_NULL, 1000);
		}
...
//			table.operate_player_status();
			...
			int next_player =  (_seat_index + table.getTablePlayerNumber() + 1) % table.getTablePlayerNumber();
			table.exe_dispatch_last_cardtwenty(next_player,GameConstants.WIK_NULL,1500);
