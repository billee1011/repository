...
public class FLSGameLogic {
	...
	public boolean is_pengpeng_hu(AnalyseItem analyseItem) {
		...
		return analyseItem.isShuangDui || (same && num == 4) || analyseItem.eyeKind == GameConstants.WIK_PENG;// 2对子
	}
	...
	// 分析扑克
	public boolean analyse_card_twenty(int cards_index[], WeaveItem weaveItem[], int cbWeaveCount,
			List<AnalyseItemTwenty> analyseItemArray, boolean has_feng, int cur_card) {
		// 计算数目
		int cbCardCount = get_card_count_by_index(cards_index);
