...
public class MJHandlerOutCardOperate_HeNan_ZhouKou extends MJHandlerOutCardOperate<MJTable> {
    ...
    public void exe(MJTable table) {
        ...
        // 显示听牌
        table._playerStatus[_out_card_player]._hu_card_count = table.get_henan_zhou_kou_ting_card(
        ...
        if (!table._logic.is_magic_card(_out_card_data)) {
            bAroseAction = table.estimate_player_out_card_respond_henan_zhou_kou(_out_card_player, _out_card_data);
        }
            ...
            for (int i = 0; i < table.getTablePlayerNumber(); i++) {
                ...
                if (playerStatus.has_action()) {
                    ...
                    if (playerStatus.has_chi_hu()) {
                         ...
                         * table.exe_jian_pao_hu(i,GameConstants.WIK_CHI_HU,_out_card_data); }else{
