...
public class HandlerGang_GXLZ extends MJHandlerGang<Table_GXLZ> {
    ...
    public void exe(Table_GXLZ table) {
        ...
        // TODO 柳州麻将，抢杠之后，杠也算分，所有挪到执行杠之前算分
    ...
    public boolean exe_gang(Table_GXLZ table) {
    ...
    public boolean handler_operate_card(Table_GXLZ table, int seat_index, int operate_code, int operate_card) {
        ...
        if (jie_pao_count > 0) {
            ...
            table.get_player_niao_count_liu_zhou();
