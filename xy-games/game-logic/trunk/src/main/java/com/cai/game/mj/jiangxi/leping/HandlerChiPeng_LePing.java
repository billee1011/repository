...
public class HandlerChiPeng_LePing extends MJHandlerChiPeng<Table_LePing> {
	...
	@Override
	public boolean handler_player_out_card(Table_LePing table, int seat_index, int card) {
