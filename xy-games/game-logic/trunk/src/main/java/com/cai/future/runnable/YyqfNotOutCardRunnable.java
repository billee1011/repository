...
public class YyqfNotOutCardRunnable extends BaseFuture {

	private static Logger logger = LoggerFactory.getLogger(YyqfNotOutCardRunnable.class);

	private int _room_id;
	private int _seat_index;
	private YYQFTable _table;

	public YyqfNotOutCardRunnable(int room_id, int seat_index, YYQFTable table) {
		super(room_id);
		_room_id = room_id;
