...
public class MJHandlerOutCardBaoTing_ShanXi_LOUFAN extends AbstractMJHandler<MJTable_ShanXi_LOUFAN> {
	...
	public void exe(MJTable_ShanXi_LOUFAN table) {
		...
		int _hide_out_card_data = _out_card_data + GameConstants_SXLF.CARD_ESPECIAL_TYPE_HIDE;
		...
		table.exe_add_discard(_out_card_player, 1,
				new int[] { _out_card_data + GameConstants_SXLF.CARD_ESPECIAL_TYPE_HIDE }, false,
	...
	public boolean handler_player_be_in_room(MJTable_ShanXi_LOUFAN table, int seat_index) {
		...
		// int real_card =
		// _out_card_data+GameConstants_SXLF.CARD_ESPECIAL_TYPE_HIDE;
