...
public class MJHandlerDispatchCard_ShanXi_HuaShui extends MJHandlerDispatchCard<MJTable_ShanXi_HuaShui> {
	protected GangCardResult m_gangCardResult;
	private boolean ting_send_card = false;
	protected int _type;

	public MJHandlerDispatchCard_ShanXi_HuaShui() {
	...
	public void exe(MJTable_ShanXi_HuaShui table) {
		...
		// 胡牌检测
		int card_type = Constants_MJ_SXHS.GAME_RULE_ZIMOHU;
		if (_type == Constants_MJ_SXHS.HU_GANG_SHANG_KAI_HUA) {
			card_type = Constants_MJ_SXHS.HU_GANG_SHANG_KAI_HUA;
		}
	...
	@Override
	public boolean handler_operate_card(MJTable_ShanXi_HuaShui table, int seat_index, int operate_code,
			int operate_card) {
