...
public class PHZHandlerGang_SY extends PHZHandlerGang<SCPHZTable> {
...
//			}
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_sy(target_player, _seat_index, _center_card, false);
...
//		if((table._ti_two_long[_seat_index] == false)&&(table._is_xiang_gong[_seat_index] == false)){
//			// 变量定义
...
//					table.GRR._weave_count[_seat_index],_seat_index,_provide_player,0, chr, card_type,hu_xi,_depatch);// 自摸
//			if(action_hu != GameConstants.WIK_NULL){
//				if(table._logic.get_chi_hu_action_rank_yj(chr)< table._fan_shu[_seat_index])
...
//				}
//				if((chr.opr_and_long(GameConstants.CHR_YJ_SKHU)).is_empty())
//				{
