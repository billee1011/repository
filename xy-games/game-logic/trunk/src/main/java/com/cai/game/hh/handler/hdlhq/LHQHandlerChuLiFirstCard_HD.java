...
public class LHQHandlerChuLiFirstCard_HD extends HHHandlerDispatchCard<HHTable> {
...
//				table.GRR._card_count[_seat_index] = table._logic.get_card_count_by_index(table.GRR._cards_index[_seat_index]);
			...
			while(loop < table.getTablePlayerNumber()){
				...
				if(table._current_player == i)
					...
					continue;
				if(table.is_mj_type(GameConstants.GAME_TYPE_LHQ_HY)==true||table.is_mj_type(GameConstants.GAME_TYPE_LHQ_QD)==true
						||table.is_mj_type(GameConstants.GAME_TYPE_LHQ_QD_SAPP)==true){
					if(i != _seat_index)
						continue;
				}
