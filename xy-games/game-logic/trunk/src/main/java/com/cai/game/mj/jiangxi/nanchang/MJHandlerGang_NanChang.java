...
public class MJHandlerGang_NanChang extends MJHandlerGang<MJTable_NanChang> {
	...
	public boolean exe_gang(MJTable_NanChang table) {
		...
		if (GameConstants.GANG_TYPE_AN_GANG == _type) {
			...
			table.GRR._weave_items[_seat_index][cbWeaveIndex].provide_player_before = _provide_player;
	...
	public boolean handler_player_be_in_room(MJTable_NanChang table, int seat_index) {
		...
		table._logic.switch_to_cards_data(table.GRR._cards_index[seat_index], hand_cards,table.getJingData(_seat_index));
