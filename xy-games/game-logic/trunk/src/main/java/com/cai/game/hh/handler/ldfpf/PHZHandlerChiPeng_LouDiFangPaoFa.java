 ...
 *
 */
public class PHZHandlerChiPeng_LouDiFangPaoFa extends HHHandlerChiPeng<LouDiFangPaoFaHHTable> {

	public PHZHandlerChiPeng_LouDiFangPaoFa() {
		m_gangCardResult = new GangCardResult();
	}

	@Override
	public void exe(LouDiFangPaoFaHHTable table) {
		if (table.has_shoot[_seat_index]) { // 如果放跑了就不能进行吃碰
			return ;
		}
		// 组合扑克
		...
		if (table._ti_two_long[_seat_index] == false) {
			...
			LouDiFangPaoFaUtils.setNextPlay(table, _seat_index, 500, 0, "吃或碰，下家发牌");
		}
	 ...
	 */
	@Override
	public boolean handler_operate_card(LouDiFangPaoFaHHTable table, int seat_index, int operate_code, int operate_card, int lou_pai) {
