...
public class SCHCPHandlerChiPeng_DSS extends SCHCPDSSHandlerChiPeng<SCHCPDSSTable> {

	public SCHCPHandlerChiPeng_DSS() {
	 ...
	 */
	@Override
	public boolean handler_operate_card(SCHCPDSSTable table, int seat_index, int operate_code, int operate_card, int lou_pai) {
