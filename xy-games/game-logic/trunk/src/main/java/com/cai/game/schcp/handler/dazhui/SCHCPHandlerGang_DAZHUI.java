...
public class SCHCPHandlerGang_DAZHUI extends SCHCPHandlerGang<SCHCPTable> {
	 ...
	 */
	@Override
	public boolean handler_operate_card(SCHCPTable table, int seat_index, int operate_code, int operate_card,
			int luoCode) {
		// 抢杠胡
	 ...
	 * 
	 ***/
	protected boolean exe_gang(SCHCPTable table) {
