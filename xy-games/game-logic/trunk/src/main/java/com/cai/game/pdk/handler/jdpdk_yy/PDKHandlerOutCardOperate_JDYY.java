...
public class PDKHandlerOutCardOperate_JDYY extends PDKHandlerOutCardOperate {
	@Override
	...
	public boolean handler_player_be_in_room(PDKTable table, int seat_index) {
		...
		// // table._auto_out_card_scheduled = GameSchedule.put(new
		// // PDKAutoOutCardRunnable(table.getRoom_id(),
		// // seat_index, table, GameConstants.PDK_CT_PASS), 1,
		// // TimeUnit.SECONDS);
		// // }
		// // } else {
		// table._auto_out_card_scheduled = GameSchedule.put(
		// new PDKAutoOutCardRunnable(table.getRoom_id(), seat_index, table,
		// GameConstants.PDK_CT_PASS), 1,
		// TimeUnit.SECONDS);
		// // }
		// }
		// }
