...
public class WHZHandlerGang_YuanJiang extends PHZHandlerGang<YuanJiangGHZTable> {
	...
	public boolean handler_operate_card(YuanJiangGHZTable table, int seat_index, int operate_code, int operate_card, int luoCode) {
		...
		case GameConstants.WIK_ZI_MO: // 自摸
		{
			...
			table.process_chi_hu_player_score(_seat_index, _provide_player, operate_card, true);
	 ...
	 * 
	 ***/
	protected boolean exe_gang(YuanJiangGHZTable table) {
