 ...
 *
 */
public class LHQHandlerDispatchCard_HD extends HHHandlerDispatchCard<HHTable> {
	...
	public boolean handler_operate_card(HHTable table, int seat_index, int operate_code, int operate_card, int luoCode) {
		...
		case GameConstants.WIK_ZI_MO: // 自摸
		{
			...
			table.process_chi_hu_player_score_lhq(target_player, _seat_index, operate_card, true);
			table.process_chi_hu_player_operate_lhq(target_player, operate_card, true);

			table.countChiHuTimes_lhq(target_player, seat_index, true);
