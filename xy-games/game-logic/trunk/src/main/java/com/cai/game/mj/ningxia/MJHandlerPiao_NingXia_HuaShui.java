...
public class MJHandlerPiao_NingXia_HuaShui extends AbstractMJHandler<MJTable_NingXia_HuaShui> {
	...
	public boolean handler_pao_qiang(MJTable_NingXia_HuaShui table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_NingXia_HuaShui table, int seat_index) {
