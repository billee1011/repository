...
public class MJHandlerChiPeng_ShanXi_XiangYuan extends MJHandlerChiPeng<MJTable_ShanXi_XiangYuan> {
	...
	public MJHandlerChiPeng_ShanXi_XiangYuan() {
		_type = 0;
	...
	public boolean handler_operate_card(MJTable_ShanXi_XiangYuan table, int seat_index, int operate_code,
		...
		if (table._playerStatus[_seat_index].is_lzlk() && operate_code == GameConstants.WIK_NULL) {
			...
			GameSchedule.put(new OutCardRunnable(table.getRoom_id(), _seat_index, _card), table.delay,
	...
	@Override
	public boolean handler_player_out_card(MJTable_ShanXi_XiangYuan table, int seat_index, int card) {
