...
public class MJHandlerChiPeng_ShanXi_ll extends MJHandlerChiPeng<MJTable_LVlIANG> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_ShanXi_ll() {
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_LVlIANG table, int seat_index, int card) {
