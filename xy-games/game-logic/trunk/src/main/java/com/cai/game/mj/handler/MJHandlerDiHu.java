...
public class MJHandlerDiHu<T extends AbstractMJTable> extends AbstractMJHandler<T> {
    ...
    public void reset_status(int seat_index, int card) {
        _out_card_player = seat_index;
        _out_card_data = card;
    }

    public MJHandlerDiHu() {
    ...
    //
    // table.exe_chi_peng(target_player,target_player,target_action,target_card,MJGameConstants.CHI_PENG_TYPE_OUT_CARD);
    //
    // }
