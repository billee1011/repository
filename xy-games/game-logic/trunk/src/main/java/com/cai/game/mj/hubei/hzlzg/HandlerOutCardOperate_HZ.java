...
public class HandlerOutCardOperate_HZ extends MJHandlerOutCardOperate<Table_HZ> {
    ...
    public void exe(Table_HZ table) {
        ...
        if (table.is_gang_card(_out_card_data) || table._logic.is_magic_card(_out_card_data)) {
            table.exe_lai_gang(_out_card_player, _out_card_player, _out_card_data, GameConstants_HZLZG.WIK_NULL,
                    GameConstants_HZLZG.WIK_NULL, false, false);
            return;
        }
        ...
        case GameConstants.WIK_CHI_HU: {
            ...
            if (jie_pao_count > 0) {
                ...
                for (int i = 0; i < GameConstants.GAME_PLAYER; i++) {
                    ...
                    if (_type == GameConstants_NanNing.OutCard_Type_Di_Hu) {
                        table.GRR._chi_hu_rights[i].opr_or(GameConstants_NanNing.CHR_HUNAN_DI_HU);
                    }
