...
public class HandlerGang_JingDian_CS_QY extends MJHandlerGang<Table_JingDian_CS_QY> {
	@Override
	...
	@Override
	protected boolean exe_gang(Table_JingDian_CS_QY table) {
	...
	public void show_tou_zi(Table_JingDian_CS_QY table) {
	...
	public boolean operate_tou_zi_effect(Table_JingDian_CS_QY table, int tou_zi_one, int tou_zi_two, int time_for_animate, int time_for_fade) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
