...
public class SJHandlerOutCardOperate_NCEQW extends SJHandlerOutCardOperate<SJTable_NCEQW> {

	@Override
	public void exe(SJTable_NCEQW table) {
	...
	public int adjust_out_card_right(SJTable_NCEQW table) {
	...
	@Override
	public boolean handler_player_be_in_room(SJTable_NCEQW table, int seat_index) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(SJMsgConstants.RESPONSE_YZBP_RECONNECT_DATA);
		// 发送数据
		TableResponse_Nceqw.Builder tableResponse = TableResponse_Nceqw.newBuilder();
