...
import protobuf.clazz.fkpsh.fkpshRsp.ButtonOperateFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.GameStartFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.JettonResultFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.LiangCardFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.OpenCardFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.Opreate_Fkpsh_Request;
import protobuf.clazz.fkpsh.fkpshRsp.PlayerResultFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.PukeGameEndFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.SelectdBankerFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.SelectdBankerResultFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.SendCardFkpsh;
import protobuf.clazz.fkpsh.fkpshRsp.TableResponseFkpsh;

///////////////////////////////////////////////////////////////////////////////////////////////
public class FKPSHTable extends AbstractRoom {
	/**
	 * 
	 */
	...
	private static Logger logger = Logger.getLogger(FKPSHTable.class);
	...
	public FKPSHGameLogic _logic = null;
	...
	public boolean game_start_fkn() {
		...
		for (int index = 0; index < this.getTablePlayerNumber(); index++) {
			...
			roomResponse.setType(MsgConstants.RESPONSE_FKPSH_GAME_START);
			roomResponse.setGameStatus(this._game_status);
			// 发送数据
			GameStartFkpsh.Builder gamestart = GameStartFkpsh.newBuilder();
	...
	public boolean update_button(int opr_type, int seat_index, int display_time, boolean is_grr) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_UPDATE_BTN);
		ButtonOperateFkpsh.Builder button_operate = ButtonOperateFkpsh.newBuilder();
	...
	public boolean send_call_banker_to_room(int seat_index) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_ROBOT_BANKER);
		SelectdBankerFkpsh.Builder robot_banker = SelectdBankerFkpsh.newBuilder();
	...
	public boolean set_banker_to_room() {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_ROBOT_BANKER_RESULT);
		SelectdBankerResultFkpsh.Builder robot_banker = SelectdBankerResultFkpsh.newBuilder();
	...
	public void send_jetton_to_room(int seat_index) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_JETTON);
		JettonResultFkpsh.Builder jetton_result = JettonResultFkpsh.newBuilder();
	...
	public boolean send_card(int card_count, int opr_type) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_SEND_CARD);
		SendCardFkpsh.Builder send_card = SendCardFkpsh.newBuilder();
	...
	public boolean open_card(int seat_index, boolean is_ox) {
		...
		if (_ox_value[seat_index] > 0) {
			if (is_ox == false) {
				this.send_error_notify(seat_index, 2, "您的牌有十哦，请再仔细看看");
				return true;
			}
		} else {
			if (is_ox == true) {
				this.send_error_notify(seat_index, 2, "您的牌没有十哦");
				return true;
			}
		}
	...
	public boolean liang_pai_result(int seat_index) {
		...
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_LIANG_PAI);
		LiangCardFkpsh.Builder liang_card = LiangCardFkpsh.newBuilder();
	...
	public boolean send_open_to_room(int seat_index) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_OPEN_CARD);
		OpenCardFkpsh.Builder open_card = OpenCardFkpsh.newBuilder();
	...
	public void load_player_info_data_game_start(GameStartFkpsh.Builder roomResponse) {
		Player rplayer;
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
			rplayer = this.get_players()[i];
			if (rplayer == null)
	...
	public void load_player_info_data_game_end(PukeGameEndFkpsh.Builder roomResponse) {
		Player rplayer;
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
			rplayer = this.get_players()[i];
			if (rplayer == null)
	...
	public void load_player_info_data_reconnect(TableResponseFkpsh.Builder roomResponse) {
		Player rplayer;
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
			rplayer = this.get_players()[i];
			if (rplayer == null)
	...
	public boolean handler_game_finish_fkn(int seat_index, int reason) {
		...
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_FKPSH_GAME_END);
		GameEndResponse.Builder game_end = GameEndResponse.newBuilder();
		PukeGameEndFkpsh.Builder game_end_fkn = PukeGameEndFkpsh.newBuilder();
		RoomInfo.Builder room_info = getRoomInfo();
	...
	public boolean handler_player_be_in_room(int seat_index) {
		...
		if ((GameConstants.GS_MJ_FREE != _game_status && GameConstants.GS_MJ_WAIT != _game_status) && this.get_players()[seat_index] != null) {
			...
			RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
			roomResponse.setType(MsgConstants.RESPONSE_FKPSH_RECONNECT_DATA);

			TableResponseFkpsh.Builder tableResponse_fkn = TableResponseFkpsh.newBuilder();
	...
	public boolean handler_requst_message_deal(Player player, int seat_index, RoomRequest room_rq, int type) {
		if (type == MsgConstants.REQUST_FKPSH_OPERATE) {

			Opreate_Fkpsh_Request req = PBUtil.toObject(room_rq, Opreate_Fkpsh_Request.class);
			// 逻辑处理
	...
	private PlayerResultFkpsh.Builder process_player_result_fkn(int reason) {
		int win_idx = 0;
		float max_score = 0;
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
			int winner = -1;
		...
		PlayerResultFkpsh.Builder player_result = PlayerResultFkpsh.newBuilder();
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
