...
public class MJHandlerChiPeng_TT extends MJHandlerChiPeng<MJTable_TT> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_TT() {
	...
	public void exe(MJTable_TT table) {
		...
		int action = table.analyse_chi_hu_card(in_card_arr, table.GRR._weave_items[_seat_index],
				table.GRR._weave_count[_seat_index], card, chr, GameConstants.HU_CARD_TYPE_PAOHU, _seat_index);
