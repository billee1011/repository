...
public class MJHandlerOutCardOperate_AY extends MJHandlerOutCardOperate<MJTable> {
    // 执行出牌动作
    @Override
    public void exe(MJTable table) {
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_ay(_out_card_player, _out_card_data);// ,
    ...
    public boolean handler_operate_card(MJTable table, int seat_index, int operate_code, int operate_card) {
        ...
        case GameConstants.WIK_CHI_HU: // 胡
        {
            ...
            table.process_chi_hu_player_score_ay(target_player, _out_card_player, _out_card_data, false);
