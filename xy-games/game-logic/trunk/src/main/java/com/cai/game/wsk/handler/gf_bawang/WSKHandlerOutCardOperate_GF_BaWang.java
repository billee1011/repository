...
public class WSKHandlerOutCardOperate_GF_BaWang extends WSKHandlerOutCardOperate<WSKTable_GF_BaWang> {
	...
	public void table_pai_socre(WSKTable_GF_BaWang table) {
		int pai_score = 0;
	...
	public void user_pass_card(WSKTable_GF_BaWang table) {
	...
	public int adjust_out_card_right(WSKTable_GF_BaWang table) {
