 ...
 *
 */
public class GZPHandlerPickUpCard_TC extends GZPHandlerPickUpOperate {
...
//		table.operate_player_get_card(_pick_up_index, 1, new int[] { _pick_up_data }, GameConstants.INVALID_SEAT);
		...
		table.cannot_pickup_card(_pick_up_index, 1, _pick_up_data, true);
		// 设置变量
		_pick_up_data = 0; 
	...
	public boolean handler_operate_card(GZPTable table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_ZI_MO: // 自摸
		{
			...
			table.process_chi_hu_player_score_gzp(_pick_up_index, _pick_up_index, operate_card, true);
