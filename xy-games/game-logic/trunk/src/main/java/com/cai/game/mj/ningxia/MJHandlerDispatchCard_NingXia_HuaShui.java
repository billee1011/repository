...
public class MJHandlerDispatchCard_NingXia_HuaShui extends MJHandlerDispatchCard<MJTable_NingXia_HuaShui> {
	protected GangCardResult m_gangCardResult;
	private boolean ting_send_card = false;
	protected int _type;

	public MJHandlerDispatchCard_NingXia_HuaShui() {
	...
	@Override
	public void exe(MJTable_NingXia_HuaShui table) {
		// 用户状态 清除
		...
		table.is_gang_valid[_seat_index] = false;
		// 荒庄结束
		if (table.GRR._left_card_count == 0) {
			table.is_shang_ju_huang_zhuang = true;
			for (int i = 0; i < table.getTablePlayerNumber(); i++) {
		...
		// 胡牌检测
		int card_type = Constants_MJ_NXHS.GAME_RULE_ZIMOHU;
		if (_type == Constants_MJ_NXHS.HU_GANG_SHANG_KAI_HUA) {
			card_type = Constants_MJ_NXHS.HU_GANG_SHANG_KAI_HUA;
		}
	...
	@Override
	public boolean handler_operate_card(MJTable_NingXia_HuaShui table, int seat_index, int operate_code,
			int operate_card) {
	...
	@Override
	public boolean handler_player_be_in_room(MJTable_NingXia_HuaShui table, int seat_index) {
