 ...
 * 
 */
package com.cai.game.pdk.handler.ll_jdpdk;
...
///////////////////////////////////////////////////////////////////////////////////////////////
public class LL_PDK_JD_Table extends PDKTable {

	public LL_PDK_JD_Table() {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_JD_LL();
		_bomb_cell_score = 10;
		if (this.matchId != 0) {
			_bomb_cell_score = 4;
		}
	...
	private void shuffle(int repertory_card[], int mj_cards[]) {
		...
		int xi_pai_count = 0;
		int rand = RandomUtil.generateRandomNumber(1, 5);
		while (xi_pai_count < 5 && xi_pai_count < rand) {
			if (xi_pai_count == 0)
	...
	private void test_cards() {
		int cards[] = new int[] { 0x03, 0x13, 0x23, 0x04, 0x14, 0x24, 0x25, 0x15, 0x05, 0x01, 0x02, 0x12, 0x2A, 0x2B,
				0x2C, 0x2D, 0x06, 0x16, 0x26, 0x07, 0x17, 0x27, 0x28, 0x18, 0x08, 0x09, 0x29, 0x31, 0x1A, 0x2B, 0x2C,
				0x2D };
