...
public class HandlerOutCardOperate_YiFeng extends MJHandlerOutCardOperate<Table_YiFeng> {
    ...
    public void exe(Table_YiFeng table) {
		...
		// 跟庄处理
		if (table.has_rule(GameConstants.GAME_RULE_ZHUI_ZHUANG) && table.isCanGenZhuang()) {
