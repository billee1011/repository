...
public class MJHandlerQiShouHongZhong_HuNan_ChenZhou extends AbstractMJHandler<MJTable_HuNan_ChenZhou> {
    ...
    @Override
    public boolean handler_operate_card(MJTable_HuNan_ChenZhou table, int seat_index, int operate_code,
            int operate_card) {
