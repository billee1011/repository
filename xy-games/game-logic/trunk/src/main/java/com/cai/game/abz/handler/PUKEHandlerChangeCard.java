...
public class PUKEHandlerChangeCard<T extends PUKETable> extends AbstractPUKEHandler<T> {
	...
	public  boolean handler_change_card(PUKETable table,int seat_index,int origin_card,int target_card,int change_cation){
		return true;
	}
