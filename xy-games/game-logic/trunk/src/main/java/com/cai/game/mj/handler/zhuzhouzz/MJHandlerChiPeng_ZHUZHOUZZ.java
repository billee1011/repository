...
public class MJHandlerChiPeng_ZHUZHOUZZ extends MJHandlerChiPeng<MJTable_ZHUZHOUZZ> {
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_ZHUZHOUZZ table, int seat_index, int card) {
