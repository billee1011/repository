...
public class MJTable_KFZZ extends AbstractMJTable {
	private static final long serialVersionUID = 9171444142458092230L;

	private PerformanceTimer timer;

	public MJHandlerPao_KFZZ _handler_pao_henna;
	public MJHandlerQiShouHun_KFZZ _handler_qishou_hun;
	public MJHandlerHun_KFZZ _handler_hun;
	...
	protected void onInitTable() {
		_handler_dispath_card = new MJHandlerDispatchCard_KFZZ();
		_handler_out_card_operate = new MJHandlerOutCardOperate_KFZZ();
		_handler_gang = new MJHandlerGang_KFZZ();
		_handler_chi_peng = new MJHandlerChiPeng_KFZZ();

		_handler_qishou_hun = new MJHandlerQiShouHun_KFZZ();
		_handler_pao_henna = new MJHandlerPao_KFZZ();
		_handler_hun = new MJHandlerHun_KFZZ();
