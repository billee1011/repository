...
public class MJHandlerOutCardOperate_KLDS extends MJHandlerOutCardOperate<MJTable_KLDS> {
    // 执行出牌动作
    @Override
    public void exe(MJTable_KLDS table) {
        ...
        if (!table._logic.is_magic_card(_out_card_data)) {
            ...
            bAroseAction = table.estimate_player_out_card_respond_sheng(_out_card_player, _out_card_data);// ,
        }
        ...
        if (table._playerStatus[_out_card_player]._hu_card_count > 0) {
            table.operate_chi_hu_cards(_out_card_player, table._playerStatus[_out_card_player]._hu_card_count,
                    table._playerStatus[_out_card_player]._hu_cards);
        } else {
            table.operate_chi_hu_cards(_out_card_player, 0, new int[] {});
        }
