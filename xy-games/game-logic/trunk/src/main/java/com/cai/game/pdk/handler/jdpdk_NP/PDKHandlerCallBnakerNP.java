...
public class PDKHandlerCallBnakerNP extends PDKHandlerCallBanker<PDK_JD_Table_NP> {
	@Override
	...
	@Override
	public boolean handler_call_banker(PDK_JD_Table_NP table, int seat_index, int call_action) {
