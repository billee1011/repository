...
public class HandlerGang_HZ extends MJHandlerGang<Table_HZ> {
    ...
    @Override
    public boolean exe_gang(Table_HZ table) {
        ...
        } else if (GameConstants_HZLZG.GANG_TYPE_JIE_GANG == _type) {
            cbWeaveIndex = table.GRR._weave_count[_seat_index];
            table.GRR._weave_count[_seat_index]++;

            table.kai_kou[_seat_index] = true;
            table.operate_remove_discard(this._provide_player, table.GRR._discard_count[_provide_player]);

            if (table.quan_bao[_seat_index] == -1 && (table.bao_pai[_seat_index] == GameConstants_HZLZG.BAO_QING
                    || table.bao_pai[_seat_index] == GameConstants_HZLZG.BAO_JIANG))
                table.quan_bao[_seat_index] = _provide_player;
        } else if (GameConstants_HZLZG.GANG_TYPE_ADD_GANG == _type) {
