...
public class SDHConstants {
	...
	public static final int SDH_CELL_PACK = 54 - 4 * 2; // 三打哈没有3、4
	public static final int SDH_CELL_PACK_REMOVE6 = 54 - 4 * 3; // 去掉6
	public static final int SDH_DIPAI_COUNT = 8; // 底牌数量
	public static final int SDH_CARD_COUNT = (SDH_PACK_COUNT * SDH_CELL_PACK - SDH_DIPAI_COUNT) / SDH_GAME_PLAYER; // 手牌数量
	public static final int SDH_CARD_COUNT_REMOVE6 = (SDH_PACK_COUNT * SDH_CELL_PACK_REMOVE6) / SDH_GAME_PLAYER; // 去掉6的玩法下  不用埋牌
	public static final int SDH_SCORE_CARD_COUNT = 24; // 分牌数量(5、10、K) 3 * 4 * 2
	public static final int SDH_MAX_COUNT = SDH_CARD_COUNT + SDH_DIPAI_COUNT; // 最大手牌数量
	public static final int SDH_MAX_COUNT_REMOVE6 = SDH_CARD_COUNT_REMOVE6; // 最大手牌数量
	...
	// 扑克牌值
	public static final int CARD_DATA_SDH[] = new int[] { 
	...
	public static final int SDH_QING_GUANG_SCORE = 2; // 清光分数
	public static final int SDH_XIAO_GUANG_DI = 40; // 小光
	public static final int SDH_XIAO_GUANG = 40; // 小光
	public static final int SDH_XIAO_GUANG_SCORE = 1; // 小光分数
	public static final int SDH_DA_GUANG = 70; // 大光
	public static final int SDH_DA_GUANG_SCORE = 2; // 大光分数
