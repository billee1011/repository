package com.cai.game.chdphz.handler.hhd;
...
public class HHHandlerGang_CHD extends PHZHandlerGang<CHDPHZTable> {
...
//			}
			...
			table.process_chi_hu_player_score_hh(_seat_index, _provide_player, operate_card, true);
	        ...
	        if(pai_count == 0)
	        {
	        	...
	        	if(all_hu_xi>=15)
	        	{
	        		...
	        		if (hong_pai_count >= 13) {
	        			chr.opr_or(GameConstants.CHR_THIRTEEN_HONG_PAI_CHD);
	        		}
	        		if (hong_pai_count == 1) {
