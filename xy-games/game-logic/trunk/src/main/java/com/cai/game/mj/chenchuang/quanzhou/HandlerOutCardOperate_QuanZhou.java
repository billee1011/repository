...
public class HandlerOutCardOperate_QuanZhou extends MJHandlerOutCardOperate<Table_QuanZhou> {
	...
	public void exe(Table_QuanZhou table) {
		...
		if(!table._logic.is_magic_card(_out_card_data) && _out_card_data < 0x38)
		...
		if (bAroseAction == false) {
			...
			if(_out_card_data > 0x37){
				table.exe_dispatch_card(_out_card_player, GameConstants.WIK_NULL, GameConstants.DELAY_SEND_CARD_DELAY);
			}else 
	...
	private void handler_operate_bu_tong_pao(Table_QuanZhou table, int seat_index,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_QUAN_ZHOU.CHR_FANG_PAO);
	...
	private void handler_operate_tong_pao(Table_QuanZhou table, int seat_index,
			int operate_code, int operate_card) {
		if (operate_code == GameConstants.WIK_CHI_HU) {
