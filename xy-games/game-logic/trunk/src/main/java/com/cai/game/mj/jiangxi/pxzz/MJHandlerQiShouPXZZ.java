...
public class MJHandlerQiShouPXZZ extends AbstractMJHandler<MJTable_PXZZ>{
    ...
    public boolean handler_operate_card(MJTable_PXZZ table, int seat_index, int operate_code, int operate_card) {
        ...
        if (operate_code == GameConstants.WIK_NULL) {
            ...
            table.operate_player_status();
            //下面这样写为什么不行
            /*table.exe_out_card(table.getTablePlayerNumber()-1, GameConstants.WIK_NULL, 0);*/
	...
	@Override
	public boolean handler_player_out_card(MJTable_PXZZ table, int seat_index, int card) {
		// 错误断言
