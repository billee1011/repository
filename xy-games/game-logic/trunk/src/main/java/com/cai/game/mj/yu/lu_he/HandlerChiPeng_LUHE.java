...
public class HandlerChiPeng_LUHE extends MJHandlerChiPeng<Table_LUHE> {
	...
	@Override
	public boolean handler_player_out_card(Table_LUHE table, int seat_index, int card) {
