...
public class HandlerOutCardOperate_KWX_XG extends MJHandlerOutCardOperate<Table_KWX_XG_2D> {
	...
	public void exe(Table_KWX_XG_2D table) {
		...
		if (table.player_liang[_out_card_player] != 1) {
			...
			int[] temp_cards_index = Arrays.copyOf(table.GRR._cards_index[_out_card_player], table.GRR._cards_index[_out_card_player].length);
			table.liangShowCard(table, _out_card_player, 0, temp_cards_index);
		}
			...
			if (table._playerStatus[seat_index].has_action_by_code(GameConstants_KWX.WIK_CHI_HU)) {
				...
				table.pass_hu_fan[seat_index] = table.pass_hu_fan[seat_index] > table.get_fan(seat_index, _out_card_player,
						table.GRR._chi_hu_rights[seat_index], true) ? table.pass_hu_fan[seat_index]
								: table.get_fan(seat_index, _out_card_player, table.GRR._chi_hu_rights[seat_index], true);
