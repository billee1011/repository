...
public class HandlerChiPeng_XY extends MJHandlerChiPeng<Table_XY> {
	...
	public void exe(Table_XY table) {
		...
		if (table.is_ji_card(_card)) {
			if (_card == GameConstants_ZYZJ.YJ_CARD /*&& table.chong_feng_ji_seat_yj == -2*/) {
