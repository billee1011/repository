...
public class HandlerOutCardOperate_GZCG extends MJHandlerOutCardOperate<Table_GZCG> {
	...
	public void exe(Table_GZCG table) {
		...
		int hand_card_count = table._logic.switch_to_cards_data_gzcg(table.GRR._cards_index[_out_card_player], cards);
	...
	public boolean handler_operate_card(Table_GZCG table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_GZCG.HU_CARD_TYPE_JIE_PAO);
