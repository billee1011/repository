...
public class HandlerXiaoHu_LX_CS_QY extends AbstractMJHandler<Table_LX_CS_QY> {
    private static Logger logger = Logger.getLogger(HandlerXiaoHu_LX_CS_QY.class);
    ...
    private void show_xiao_hu(Table_LX_CS_QY table, int seat_index) {
        ChiHuRight start_hu_right = table.GRR._start_hu_right[seat_index];
        ...
        if (start_hu_right._show_all) {
            ...
            if (!start_hu_right.opr_and_long(Constants_LX_CS_QY.CHR_JIN_TONG_YU_NV).is_empty()) {
            ...
            if (!start_hu_right.opr_and_long(Constants_LX_CS_QY.CHR_HOU_BA_LUN).is_empty()) {
            ...
            if (!start_hu_right.opr_and_long(Constants_LX_CS_QY.CHR_MEI_HUA_SAN_NONG).is_empty()) {
