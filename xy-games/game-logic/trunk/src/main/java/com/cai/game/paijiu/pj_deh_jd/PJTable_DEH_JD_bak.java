...
///////////////////////////////////////////////////////////////////////////////////////////////
public class PJTable_DEH_JD_bak extends PJTable {
	...
	public boolean deal_give_up(int seat_index) {
		...
		// 庄家必管
		if (this._jetton_current == 0 && this._end_index == 2
				&& this.has_rule(GameConstants.GAME_RULE_DEH_BANKER_MUST_CALL)) {
			return true;
		}
		this.kill_timer();
	...
	public void Refresh_User_Operate(int seat_index) {
		...
		if (_jetton_current == 0 && this._end_index == 2
				&& this.has_rule(GameConstants.GAME_RULE_DEH_BANKER_MUST_CALL)) {
