 ...
 *
 */
public class PHZHandlerDispatchCard_YJ extends PHZHandlerDispatchCard<SCPHZTable> {
...
//		}
	...
	public boolean handler_operate_card(SCPHZTable table, int seat_index, int operate_code, int operate_card, int luoCode) {
		...
		case GameConstants.WIK_ZI_MO: // 自摸
		{
			...
			table.process_chi_hu_player_score_yj(target_player, _seat_index, operate_card, true);
