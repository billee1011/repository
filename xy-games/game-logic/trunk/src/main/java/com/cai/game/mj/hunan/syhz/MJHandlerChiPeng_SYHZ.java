...
public class MJHandlerChiPeng_SYHZ extends MJHandlerChiPeng<MJTable_SYHZ> {
    private GangCardResult m_gangCardResult;

    public MJHandlerChiPeng_SYHZ() {
    ...
    public void exe(MJTable_SYHZ table) {
        ...
        if(table.is_match() || table.isCoinRoom()){
        	table.chi_peng_index(_seat_index);
        }
        ...
        int action = table.analyse_chi_hu_card_hz(in_card_arr, table.GRR._weave_items[_seat_index],
                table.GRR._weave_count[_seat_index], card, chr, GameConstants.HU_CARD_TYPE_PAOHU);
