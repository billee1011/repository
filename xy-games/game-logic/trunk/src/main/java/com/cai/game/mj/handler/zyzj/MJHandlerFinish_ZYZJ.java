...
public class MJHandlerFinish_ZYZJ extends AbstractMJHandler<Table_ZYZJ> {
	...
	public boolean handler_player_show_card(Table_ZYZJ table, int seat_index) {
		if (table.GRR == null)
	...
	public boolean operate_player_cards(Table_ZYZJ table, int seat_index, int card_count, int cards[], int weave_count, WeaveItem weaveitems[]) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
