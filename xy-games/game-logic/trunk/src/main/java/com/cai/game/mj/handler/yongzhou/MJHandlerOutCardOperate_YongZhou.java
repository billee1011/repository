...
public class MJHandlerOutCardOperate_YongZhou extends MJHandlerOutCardOperate<MJTable_YongZhou> {
    ...
    public void exe(MJTable_YongZhou table) {
        ...
        // 刷新手牌
        Tuple<Integer, List<Integer>> t = table.switch_to_cards_data(_out_card_player);
        ...
        if (table._logic.is_magic_card(real_card)) {
            real_card = real_card + GameConstants.CARD_ESPECIAL_TYPE_WANG_BA;
        }
        // 显示出牌
