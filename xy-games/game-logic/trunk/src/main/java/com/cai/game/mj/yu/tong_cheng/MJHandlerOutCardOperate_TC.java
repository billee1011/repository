...
public class MJHandlerOutCardOperate_TC extends MJHandlerOutCardOperate<Table_TC> {
	...
	public void exe(Table_TC table) {
		...
		int out_real_card = _out_card_data;
		if (table._logic.is_magic_card(out_real_card))
			out_real_card += GameConstants.CARD_ESPECIAL_TYPE_LAI_ZI;
		table.operate_out_card(_out_card_player, 1, new int[] { out_real_card }, GameConstants.OUT_CARD_TYPE_MID, GameConstants.INVALID_SEAT);
	...
	public boolean handler_operate_card(Table_TC table, int seat_index, int operate_code, int operate_card) {
		...
		if (operate_code == GameConstants.WIK_CHI_HU) {
			table.operate_effect_action(seat_index, GameConstants.EFFECT_ACTION_TYPE_ACTION, 1, new long[] { GameConstants.WIK_CHI_HU }, 1,
		...
		case GameConstants.WIK_GANG: {
			table.remove_discard_after_operate(_out_card_player, _out_card_data);
			table.exe_gang(target_player, _out_card_player, target_card, target_action, GameConstants_TC.TC_GANG_TYPE_JIE_GANG, false, false);
			return true;
		}
