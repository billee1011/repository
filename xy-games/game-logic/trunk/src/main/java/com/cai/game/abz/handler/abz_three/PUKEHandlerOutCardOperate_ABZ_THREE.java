...
public class PUKEHandlerOutCardOperate_ABZ_THREE extends PUKEHandlerOutCardOperate<PUKETable_ABZ_THREE> {

	@Override
	public void exe(PUKETable_ABZ_THREE table) {
	...
	public int adjust_out_card_right(PUKETable_ABZ_THREE table) {
	...
	@Override
	public boolean handler_player_be_in_room(PUKETable_ABZ_THREE table, int seat_index) {
