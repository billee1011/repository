...
public class HandlerOutCardOperate_Shan_Xi_TDH extends MJHandlerOutCardOperate<Table_Shan_Xi_TDH> {
	...
	public void exe(Table_Shan_Xi_TDH table) {
		...
		if(_type == Constants_MJ_SAN_XI_TDH.HU_CARD_TYPE_BAO_TING)
			data = _out_card_data + Constants_MJ_SAN_XI_TDH.CARD_ESPECIAL_TYPE_HIDE;
	...
	private void handler_operate_bu_tong_pao(Table_Shan_Xi_TDH table, int seat_index,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_SAN_XI_TDH.CHR_FANG_PAO);
