...
public class PHZHandlerChiPeng_SY extends PHZHandlerChiPeng<SCPHZTable> {
	
	private GangCardResult m_gangCardResult;
	
	public PHZHandlerChiPeng_SY(){
	...
	public void exe(SCPHZTable table) {
		...
		if(an_long_count > 0 )
		{
			...
			//效果
//			table.operate_effect_action(_seat_index,GameConstants.EFFECT_ACTION_TYPE_ACTION, 1, new long[]{GameConstants.WIK_AN_LONG}, 1,GameConstants.INVALID_SEAT);
