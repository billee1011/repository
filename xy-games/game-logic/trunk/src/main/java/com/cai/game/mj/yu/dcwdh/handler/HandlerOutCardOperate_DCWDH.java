...
public class HandlerOutCardOperate_DCWDH extends MJHandlerOutCardOperate<MJTable_DCWDH> {
	...
	public void exe(MJTable_DCWDH table) {
		...
		table.player_continue_gang_count[_out_card_player] = 0;
		...
		table._playerStatus[_out_card_player]._hu_card_count = table.get_ting_card_bao_hu(table._playerStatus[_out_card_player]._hu_cards,
