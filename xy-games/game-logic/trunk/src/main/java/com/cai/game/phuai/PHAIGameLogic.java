...
public class PHAIGameLogic {
	...
	private static Logger logger = Logger.getLogger(PHAIGameLogic.class);
   ...
   public boolean check_lou_weave(int cards_index[],int cur_card,int action,int type_count[],int type_eat_count,LouWeaveItem lou_weave_item[],
    ...
    public void calculate_game_weave_score(int game_mid_score[],int game_weave_score[],int score[],int user_count,boolean add)
    {
    	if(add == true)
    	{
    		for(int i = 0; i< user_count;i++)
	    	{
	    		game_weave_score[i] += score[i];
	    	}
    	}
    	else
    	{
...
//							return false;
	...
	public static void main(String[] args) {
		// 插入扑克
		PHAIGameLogic logic = new PHAIGameLogic();
