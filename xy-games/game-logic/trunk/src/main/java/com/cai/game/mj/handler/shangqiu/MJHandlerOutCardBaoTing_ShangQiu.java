 ...
 *
 */
public class MJHandlerOutCardBaoTing_ShangQiu extends AbstractMJHandler<MJTable_ShangQiu> {
    ...
    public void exe(MJTable_ShangQiu table) {
        ...
        // 刷新亮牌
        if (table.GRR.get_liang_card_count_show(_out_card_player) == GameConstants.GAME_LIANG_ZHANG_MAX
        		&&  table.has_rule(GameConstants_SQ.GAME_RULE_SQ_LIANG_SI_DA_YI)) {
            if (table.GRR.remove_liang_pai(_out_card_data, _out_card_player)) {
                table.operate_show_card_other(_out_card_player, GameConstants_SQ.SEND_OTHER_TYPE1);
            }
        }
