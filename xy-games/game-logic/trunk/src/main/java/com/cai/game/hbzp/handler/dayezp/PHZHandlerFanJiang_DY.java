 ...
 *
 */
public class PHZHandlerFanJiang_DY extends PHZHandler {
...
//		--table.GRR._left_card_count;
		...
		_da_dian_card = table._repertory_card[table._all_card_len-1];
		
		if(table.DEBUG_CARDS_MODE)_da_dian_card=0x18;//
		//显示
		table.operate_fan_jiang(-1,GameConstants.Show_Card_Center, 1,new int[]{_da_dian_card},GameConstants.INVALID_SEAT);

		
		table._fan_jiang_card = _da_dian_card;
...
//		table.send_response_to_player(seat_index, roomResponse);
		...
		//显示
		table.operate_fan_jiang(-1,GameConstants.Show_Card_Center, 1,new int[_da_dian_card],seat_index);
