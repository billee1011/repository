...
public class MJHandlerChiPeng_YiYang_QY extends MJHandlerChiPeng<MJTable_YiYang_QY> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_YiYang_QY() {
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_YiYang_QY table, int seat_index, int card) {
