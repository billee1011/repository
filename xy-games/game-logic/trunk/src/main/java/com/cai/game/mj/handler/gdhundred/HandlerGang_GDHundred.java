...
public class HandlerGang_GDHundred extends MJHandlerGang<Table_GDHundred> {

	protected int _seat_index;
	public static int _provide_player;
	...
	@Override
	public boolean exe_gang(Table_GDHundred table) {
	...
	public boolean handler_operate_card(Table_GDHundred table, int seat_index, int operate_code, int operate_card) {
		...
		if (operate_code == GameConstants.WIK_CHI_HU) {
			...
			// 客户端播放放炮动画
			table.GRR._chi_hu_rights[_seat_index].opr_or(GameConstants_GD_HUNDRED.CHR_FANG_PAO);
