...
public class HandlerGang_HYHD extends MJHandlerGang<Table_HYHD> {
	@Override
	public void exe(Table_HYHD table) {
		...
		if (table.has_rule(GameConstants_HYHD.GAME_RULE_KE_JIE_PAO_HU)) {
	...
	@Override
	protected boolean exe_gang(Table_HYHD table) {
