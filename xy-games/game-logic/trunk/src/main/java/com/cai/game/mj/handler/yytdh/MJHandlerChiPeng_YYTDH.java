...
public class MJHandlerChiPeng_YYTDH extends MJHandlerChiPeng<MJTable_YYTDH> {

    private GangCardResult m_gangCardResult;

    public MJHandlerChiPeng_YYTDH() {
    ...
    public void exe(MJTable_YYTDH table) {
        ...
        if(_action != GameConstants.WIK_PENG){
        	if(table.chi_color[_seat_index] == GameConstants.INVALID_SEAT){
        		table.chi_color[_seat_index] = table._logic.get_card_color(_card);
        	}
        }
