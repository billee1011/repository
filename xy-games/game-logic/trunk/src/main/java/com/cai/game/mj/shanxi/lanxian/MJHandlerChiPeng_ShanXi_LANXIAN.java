...
public class MJHandlerChiPeng_ShanXi_LANXIAN extends MJHandlerChiPeng<MJTable_ShanXi_LANXIAN> {
	...
	public MJHandlerChiPeng_ShanXi_LANXIAN() {
	...
	@Override
	public boolean handler_operate_card(MJTable_ShanXi_LANXIAN table, int seat_index, int operate_code, int operate_card) {
	...
	@Override
	public boolean handler_player_out_card(MJTable_ShanXi_LANXIAN table, int seat_index, int card) {
