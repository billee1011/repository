...
public class MJHandlerOutCardOperate_ND extends MJHandlerOutCardOperate<MJTable_ND> {
	...
	public void exe(MJTable_ND table) {
		...
		// 跟庄处理
		if (table.has_rule(GameConstants_ND.GAME_RULE_GEN_ZHUANG) && table.isCanGenZhuang()) {
