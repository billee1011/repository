...
public class MJHandlerOutCardOperate_NingXia_HuaShui extends MJHandlerOutCardOperate<MJTable_NingXia_HuaShui> {
	...
	public void exe(MJTable_NingXia_HuaShui table) {
		...
		// 跟庄处理
		if (table.has_rule(Constants_MJ_NXHS.GAME_RULE_DAI_GEN_ZHUANG) && table.isCanGenZhuang()) {
	...
	public boolean handler_player_be_in_room(MJTable_NingXia_HuaShui table, int seat_index) {
		...
		// if (cards[i] == table._playerStatus[seat_index]._hu_out_card_ting[j])
		// {
		// // 如果既是听牌 又是癞子的牌
