...
public class HandlerOutCardOperate_HYHD extends MJHandlerOutCardOperate<Table_HYHD> {
	// 执行出牌动作
	@Override
	public void exe(Table_HYHD table) {
		...
		if (table._logic.is_magic_card(_out_card_data)) {
			table.exe_add_discard(_out_card_player, 1,
					new int[] { _out_card_data + GameConstants.CARD_ESPECIAL_TYPE_LAI_ZI }, false,
