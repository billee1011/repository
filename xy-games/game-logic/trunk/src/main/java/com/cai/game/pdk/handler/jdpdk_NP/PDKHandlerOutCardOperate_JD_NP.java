...
public class PDKHandlerOutCardOperate_JD_NP extends PDKHandlerOutCardOperate<PDK_JD_Table_NP> {
	@Override
	...
	// 玩家不出
	public void no_out_card(PDK_JD_Table_NP table) {
		int can_out_card_data[] = new int[table.get_hand_card_count_max()];
	...
	// 判断玩家出牌合法
	public int adjust_out_card_right(PDK_JD_Table_NP table) {
	...
	// 放走包赔
	public boolean fang_zou_bao_pei(PDK_JD_Table_NP table) {
	...
	// 必须出最大牌
	public boolean mustmax(PDK_JD_Table_NP table) {
	...
	// 自动出牌
	public void adjustAutoOutCard(PDK_JD_Table_NP table, int seat_index) {
		int auto_out_card_dely = 1;
		if (table.matchId != 0) {
