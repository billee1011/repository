...
public class HandlerChiPeng_SW extends MJHandlerChiPeng<Table_SW> {
	...
	@Override
	public boolean handler_player_out_card(Table_SW table, int seat_index, int card) {
