...
public class MJHandlerChiPeng_ShanXi_NINGWU extends MJHandlerChiPeng<MJTable_ShanXi_NINGWU> {
	...
	public MJHandlerChiPeng_ShanXi_NINGWU() {
	...
	@Override
	public boolean handler_operate_card(MJTable_ShanXi_NINGWU table, int seat_index, int operate_code, int operate_card) {
	...
	@Override
	public boolean handler_player_out_card(MJTable_ShanXi_NINGWU table, int seat_index, int card) {
