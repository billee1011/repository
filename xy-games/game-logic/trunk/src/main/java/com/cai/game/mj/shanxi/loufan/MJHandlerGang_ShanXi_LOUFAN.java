...
public class MJHandlerGang_ShanXi_LOUFAN extends MJHandlerGang<MJTable_ShanXi_LOUFAN> {
	...
	public MJHandlerGang_ShanXi_LOUFAN() {
	}
	...
	@Override
	public boolean exe_gang(MJTable_ShanXi_LOUFAN table) {
		int no_feng_operate_card = _center_card;
