...
public class LPHandlerChiPeng_XP extends LPHandlerChiPeng<LPTable_XP> {
	private GangCardResult m_gangCardResult;

	public LPHandlerChiPeng_XP() {
	...
	public void exe(LPTable_XP table) {
		...
		WeaveItem weaves[] = new WeaveItem[GameConstants.MAX_WEAVE_LAOPAI];// table.GRR._weave_items[_seat_index];
		...
		if (table.has_rule(GameConstants.GAME_RULE_XP_LP_PENG_CAN_OUT)) {
	 ...
	 */
	@Override
	public boolean handler_player_out_card(LPTable_XP table, int seat_index, int card) {
