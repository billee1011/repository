...
public class MJHandlerGang_LZ extends MJHandlerGang<MJTable> {
    @Override
    public void exe(MJTable table) {
        ...
        // 检查对这个杠有没有 胡
        boolean bAroseAction = table.estimate_gang_lz_respond(_seat_index, _center_card);
    ...
    public boolean handler_operate_card(MJTable table, int seat_index, int operate_code, int operate_card) {
        ...
        if (jie_pao_count > 0) {
            ...
            table.process_chi_hu_player_score_lz(target_player, _seat_index, _center_card, false);
    ...
    protected boolean exe_gang(MJTable table) {
        ...
        if (GameConstants.GANG_TYPE_AN_GANG == _type) {
            ...
            // -MJGameConstants.CELL_SCORE;// 暗杠，其他玩家扣分
            // table.GRR._gang_score[_seat_index].scores[cbGangIndex][_seat_index] +=
            // MJGameConstants.CELL_SCORE;//一共加分
            // }
