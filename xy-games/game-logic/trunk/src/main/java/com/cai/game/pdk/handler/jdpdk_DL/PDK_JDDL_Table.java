 ...
 * 
 */
package com.cai.game.pdk.handler.jdpdk_DL;
...
public class PDK_JDDL_Table extends PDKTable {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_JDDL();
	...
	private void test_cards() {
		...
		int cards[] = new int[] { 0x01, 0x02, 0x33, 0x04, 0x14, 0x24, 0x34, 0x08, 0x09, 0x0A, 0x1C, 0x0C, 0x2C, 0x3C,
				0x33, 0x3 };
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
