...
public final class ClientTransmitHandler extends IServerHandler<TransmitProto> {

	@Override
	public void execute(TransmitProto resp, S2SSession session) throws Exception {
