...
public class HandlerPiao_TongCheng extends AbstractHandler_TongCheng {
	@Override
	public void exe(Table_TongCheng table) {
		table._game_status = GameConstants.GS_TC_WSK_PIAO;

		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_WSK_TCDG_PIAO);
	...
	public boolean handler_pao_qiang(Table_TongCheng table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_TongCheng table, int seat_index) {
