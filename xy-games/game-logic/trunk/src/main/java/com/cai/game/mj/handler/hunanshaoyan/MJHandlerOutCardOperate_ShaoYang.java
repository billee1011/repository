...
public class MJHandlerOutCardOperate_ShaoYang extends MJHandlerOutCardOperate<MJTable_ShaoYang> {
	...
	public boolean handler_operate_card(MJTable_ShaoYang table, int seat_index, int operate_code, int operate_card) {
		...
		if (operate_code == GameConstants.WIK_CHI_HU) {// 不能通炮-点了胡不一定能胡seat_index
