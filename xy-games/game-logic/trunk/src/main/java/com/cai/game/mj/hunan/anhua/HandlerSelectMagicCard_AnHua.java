...
public class HandlerSelectMagicCard_AnHua extends AbstractMJHandler<Table_AnHua> {
	...
	public void exe(Table_AnHua table) {
		...
		if (table.has_rule(Constants_AnHua.GAME_RULE_SEVEN_MAGIC)) {
			...
			table.GRR._especial_show_cards[0] = table.joker_card_1 + GameConstants.CARD_ESPECIAL_TYPE_WANG_BA;
