...
public class MJHandlerDispatchCard_ShaoYang extends MJHandlerDispatchCard<MJTable_ShaoYang> {
    ...
    public void exe(MJTable_ShaoYang table) {
        ...
        if (table.GRR._left_card_count <= llcard) {
            ...
            int temp_banker = table._cur_banker;
            table._cur_banker = table.GRR._banker_player;
            table.GRR._banker_player = temp_banker;
            // 流局
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_ShaoYang table, int seat_index, int card) {
		// 错误断言
