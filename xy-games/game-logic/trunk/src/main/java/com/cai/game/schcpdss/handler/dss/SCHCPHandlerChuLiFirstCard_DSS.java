...
public class SCHCPHandlerChuLiFirstCard_DSS extends SCHCPDSSHandlerDispatchCard<SCHCPDSSTable> {
	...
	public void exe(SCHCPDSSTable table) {
		...
		if (table._playerStatus[table._cur_banker].has_zi_mo()) {
			...
			table._playerStatus[table._cur_banker].set_status(GameConstants.Player_Status_OPR_CARD);// 出牌状态
