package com.cai.game.hh.handler.hgw468;
...
public class HGW468HandlerGang_HH extends HHHandlerGang<HHTable> {
...
//			}
			...
			table.process_chi_hu_player_score_hgw468(target_player, _seat_index, operate_card, true);
	        ...
	        if(pai_count == 0)
	        {
	        	...
	        	if(all_hu_xi>=15)
	        	{
	        		...
	        		for(int i = 0; i<table.GRR._weave_count[_seat_index];i++ )
	            	{
	            		...
	            		table._hong_pai_count[_seat_index] += table._logic.calculate_weave_hong_pai(table._hu_weave_items[_seat_index][i]);
	            		hei_pai_count += table._logic.calculate_weave_hei_pai(table._hu_weave_items[_seat_index][i]);
	            		table._da_pai_count[_seat_index] += table._logic.get_da_card(table._hu_weave_items[_seat_index][i].weave_kind,
