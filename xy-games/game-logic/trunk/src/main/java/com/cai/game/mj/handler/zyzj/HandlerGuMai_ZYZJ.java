...
public class HandlerGuMai_ZYZJ extends AbstractMJHandler<Table_ZYZJ> {
	@Override
	...
	public boolean handler_pao_qiang(Table_ZYZJ table, int seat_index, int pao, int qiang) {
