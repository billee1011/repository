...
public class MJHandlerLaiGen extends MJHandler {
	...
	public void exe(MJTable table) {
		...
		_lai_gen_card = table._repertory_card[table._all_card_len-table.GRR._left_card_count];
		
		--table.GRR._left_card_count;
		
		if(table.DEBUG_CARDS_MODE)_lai_gen_card=0x28;//
		//显示
		table.operate_show_card(_banker,GameConstants.Show_Card_Center, 1,new int[]{_lai_gen_card+GameConstants.CARD_ESPECIAL_TYPE_LAI_GEN},GameConstants.INVALID_SEAT);
		...
		table.GRR._especial_show_cards[1] +=GameConstants.CARD_ESPECIAL_TYPE_LAI_ZI;
	...
	public boolean handler_player_be_in_room(MJTable table,int seat_index) {
		...
		//显示
		table.operate_show_card(_banker,GameConstants.Show_Card_Center, 1,new int[_lai_gen_card],seat_index);
