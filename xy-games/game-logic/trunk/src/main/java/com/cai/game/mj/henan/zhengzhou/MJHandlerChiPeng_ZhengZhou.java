...
public class MJHandlerChiPeng_ZhengZhou extends MJHandlerChiPeng<MJTable_ZhengZhou> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_ZhengZhou() {
	...
	@Override
	public boolean handler_player_out_card(MJTable_ZhengZhou table, int seat_index, int card) {
