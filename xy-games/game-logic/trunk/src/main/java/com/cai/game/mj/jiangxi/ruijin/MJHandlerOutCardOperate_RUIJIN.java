...
public class MJHandlerOutCardOperate_RUIJIN extends MJHandlerOutCardOperate<MJTable_RUIJIN> {
	...
	public boolean handler_operate_card(MJTable_RUIJIN table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_LEFT: {
			...
			//需要解析
			if(target_card != operate_card){
				cbRemoveCard[0] = table.getOne(operate_card);
				cbRemoveCard[1] = table.getTwo(operate_card);
				target_card = operate_card;
			}
