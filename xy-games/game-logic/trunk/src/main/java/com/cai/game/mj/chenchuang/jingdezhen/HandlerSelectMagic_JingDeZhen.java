...
public class HandlerSelectMagic_JingDeZhen extends AbstractMJHandler<Table_JingDeZhen> {
	...
	public void exe(Table_JingDeZhen table) {
        ...
        int _da_dian_card = table._repertory_card[table._all_card_len - table.GRR._left_card_count];
