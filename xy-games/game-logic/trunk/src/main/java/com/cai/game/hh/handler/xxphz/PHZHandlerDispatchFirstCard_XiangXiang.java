...
public class PHZHandlerDispatchFirstCard_XiangXiang extends HHHandlerDispatchCard<XiangXiangHHTable> {
	...
	public void exe(XiangXiangHHTable table) {
		...
		table.exe_chuli_first_card(_seat_index, GameConstants_XiangXiang.WIK_NULL, 2500);
		_send_card_data = 0;
		return;
	}
