...
public class HandlerGang_HuangZhou extends MJHandlerGang<Table_HuangZhou> {
    ...
    public void exe(Table_HuangZhou table) {
        ...
        if (GameConstants.GANG_TYPE_ADD_GANG == _type) {
            if (!table.has_rule(Constants_HuangZhou.GAME_RULE_QIANG_GANG_HU)) {
                exe_gang(table);
                return;
            }
        }
    ...
    public boolean exe_gang(Table_HuangZhou table) {
