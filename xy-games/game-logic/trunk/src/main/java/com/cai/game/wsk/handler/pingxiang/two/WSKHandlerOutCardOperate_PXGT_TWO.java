package com.cai.game.wsk.handler.pingxiang.two;
...
public class WSKHandlerOutCardOperate_PXGT_TWO extends WSKHandlerOutCardOperate<WSKTable_PXGT_TWO> {

	@Override
	public void exe(WSKTable_PXGT_TWO table) {
	...
	public void user_pass_card(WSKTable_PXGT_TWO table) {
	...
	public int adjust_out_card_right(WSKTable_PXGT_TWO table) {
	...
	@Override
	public boolean handler_player_be_in_room(WSKTable_PXGT_TWO table, int seat_index) {
