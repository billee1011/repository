...
public class WSKHandlerOutCardOperate_HS extends WSKHandlerOutCardOperate<WSKTable_HS> {
	...
	public void table_pai_socre(WSKTable_HS table) {
		int pai_score = 0;
	...
	public void user_pass_card(WSKTable_HS table) {
	...
	public int adjust_out_card_right(WSKTable_HS table) {
