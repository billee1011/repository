...
public class WSKGameLogic_YSDZ extends WSKGameLogic {

	public WSKGameLogic_YSDZ() {

	}

	public int GetCardType(int cbCardData[], int cbCardCount, boolean isLast) {
		if (cbCardCount == 0) {
			return WSKConstants.WSK_YSDZ_CT_ERROR;
		}
		...
		if (wang_count == 4 && cbCardCount == 4) {
			return WSKConstants.WSK_YSDZ_CT_KING_FOUR;
		}
		// 王加4炸
		if (wang_count > 0) {
			if (card_index.card_index[this.switch_card_to_idnex(cbCardData[0])] >= 4) {
				...
				if (count + wang_count == cbCardCount) {
					if (cbCardCount == 4) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_4;
					}
					if (cbCardCount == 5) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_5;
					}
					if (cbCardCount == 6) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_6;
					}
					if (cbCardCount == 7) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_7;
					}
					if (cbCardCount == 8) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_8;
					}
					if (cbCardCount == 9) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_9;
					}
					if (cbCardCount == 10) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_10;
					}
					if (cbCardCount == 11) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_11;
					}
					if (cbCardCount == 12) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_12;
					}
					if (cbCardCount == 13) {
						return WSKConstants.WSK_YSDZ_CT_BOMB_13;
					}
				}
			}
		}
		if (card_index.card_index[this.switch_card_to_idnex(cbCardData[cbCardCount - 1])] == cbCardCount
			...
			// 所有牌都为同一种牌
			if (cbCardCount == 1) {
				return WSKConstants.WSK_YSDZ_CT_SINGLE;
			}
			if (cbCardCount == 2) {
				return WSKConstants.WSK_YSDZ_CT_DOUBLE;
			}
			if (cbCardCount == 4) {
				return WSKConstants.WSK_YSDZ_CT_BOMB_4;
			}
		...
		if (cbCardCount == 3) {
			...
			if (card_index.card_index[this.switch_card_to_idnex(cbCardData[0])] == 3) {
				return WSKConstants.WSK_YSDZ_CT_THREE;
			}
			// 510K
			...
			if (card_index.card_index[2] > 0 && card_index.card_index[7] > 0 && card_index.card_index[10] > 0) {
				...
				for (int i = 1; i < cbCardCount; i++) {
					if (GetCardColor(cbCardData[i]) != color) {
						return WSKConstants.WSK_YSDZ_CT_510K_DC;
					}
				}
				return WSKConstants.WSK_YSDZ_CT_510K_SC;
			}
			return WSKConstants.WSK_YSDZ_CT_ERROR;
		}
		if (cbCardCount == 4) {
		...
		if (cbCardCount == 5) {
			...
			for (int i = 0; i < cbCardCount; i++) {
				if (card_index.card_index[this.switch_card_to_idnex(cbCardData[i])] >= 3
					...
					return WSKConstants.WSK_YSDZ_CT_THREE_TAKE_TWO;
				}
			}
			// }
		}
		...
		if (cbCardCount >= 5) {
			if (this.is_link(card_index, 1, cbCardCount)) {
				return WSKConstants.WSK_YSDZ_CT_SINGLE_LINK;
			}
		}
		...
		if (cbCardCount % 2 == 0) {
			...
			if (this.is_link(card_index, 2, cbCardCount / 2) && wang_count == 0 && er_count == 0) {
				return WSKConstants.WSK_YSDZ_CT_DOUBLE_LINK;
			}
		}
		// 三连
		if (cbCardCount % 3 == 0) {
			if (this.is_link(card_index, 3, cbCardCount / 3)) {
				return WSKConstants.WSK_YSDZ_CT_PLANE_LOST;
			}
		}
		// 飞机
		...
		if (nPlane == 0) {
			...
			return WSKConstants.WSK_YSDZ_CT_PLANE;
		}
		return WSKConstants.WSK_YSDZ_CT_ERROR;
	}
	...
	public int get_three_link_count(int cbCardData[], int cbCardCount, int type) {
		...
		if (type == WSKConstants.WSK_YSDZ_CT_PLANE_LOST) {
	...
	public boolean CompareCard_WSK(int cbFirstCard[], int cbNextCard[], int cbFirstCount, int cbNextCount,
		...
		// 炸弹以上一定大于单牌、对子和单龙
		if (cbNextType >= WSKConstants.WSK_YSDZ_CT_510K_DC && cbFirstType < WSKConstants.WSK_YSDZ_CT_510K_DC)
			return true;
		if (cbNextType < WSKConstants.WSK_YSDZ_CT_510K_DC && cbFirstType >= WSKConstants.WSK_YSDZ_CT_510K_DC) {
			return false;
		}
		if (cbNextType >= WSKConstants.WSK_YSDZ_CT_510K_DC && cbFirstType >= WSKConstants.WSK_YSDZ_CT_510K_DC) {
			if (cbNextType == cbFirstType) {
				if (cbNextType == WSKConstants.WSK_YSDZ_CT_510K_SC) {
		...
		switch (cbFirstType) {
		case WSKConstants.WSK_YSDZ_CT_SINGLE:
		case WSKConstants.WSK_YSDZ_CT_DOUBLE: {
			if (cbFirstType != cbNextType) {
				return false;
			}
			return GetCardLogicValue(cbNextCard[0]) > GetCardLogicValue(cbFirstCard[0]);
		}
		case WSKConstants.WSK_YSDZ_CT_SINGLE_LINK:
		case WSKConstants.WSK_YSDZ_CT_DOUBLE_LINK: {
			if (cbFirstType != cbNextType || cbFirstCount != cbNextCount) {
				return false;
			}
			return GetCardLogicValue(cbNextCard[0]) > GetCardLogicValue(cbFirstCard[0]);
		}
		case WSKConstants.WSK_YSDZ_CT_PLANE:
		case WSKConstants.WSK_YSDZ_CT_PLANE_LOST: {
			if (cbNextType != WSKConstants.WSK_YSDZ_CT_PLANE && cbNextType != WSKConstants.WSK_YSDZ_CT_PLANE_LOST) {
				return false;
			}
		...
		case WSKConstants.WSK_YSDZ_CT_THREE_TAKE_TWO:
		case WSKConstants.WSK_YSDZ_CT_THREE: {
			if (cbNextType != WSKConstants.WSK_YSDZ_CT_THREE_TAKE_TWO && cbNextType != WSKConstants.WSK_YSDZ_CT_THREE) {
				return false;
			}
			int next_index = -1;
			int first_index = -1;
	...
	public int search_out_card(int cbCardData[], int cbCardCount, int turn_card_data[], int turn_card_count,
		...
		case WSKConstants.WSK_YSDZ_CT_BOMB_13:
		case WSKConstants.WSK_YSDZ_CT_BOMB_12:
		case WSKConstants.WSK_YSDZ_CT_BOMB_11: {
			return tip_type_count;
		}
		case WSKConstants.WSK_YSDZ_CT_BOMB_10:
		case WSKConstants.WSK_YSDZ_CT_BOMB_9:
		case WSKConstants.WSK_YSDZ_CT_BOMB_8:
		case WSKConstants.WSK_YSDZ_CT_BOMB_7:
		case WSKConstants.WSK_YSDZ_CT_BOMB_6:
		case WSKConstants.WSK_YSDZ_CT_BOMB_5:
		case WSKConstants.WSK_YSDZ_CT_BOMB_4: {
		...
		case WSKConstants.WSK_YSDZ_CT_ERROR: {
	...
	public int search_out_single_double(int cbCardData[], int cbCardCount, int turn_card_data[], int turn_card_count,
		...
		// 不拆炸弹
		for (int add_count = 0; add_count < 4 - turn_card_count; add_count++) {
			for (int i = 0; i < GameConstants.WSK_MAX_INDEX; i++) {
				if (hand_card_idnex.card_index[i] == turn_card_count + add_count && hand_card_idnex.card_index[i] < 4
						&& i > turn_index) {
	...
	public int search_510k(int cbCardData[], int cbCardCount, int tip_out_card[][], int tip_out_count[],
			int all_tip_count) {
		if (!this.has_rule(WSKConstants.GAME_RULE_YSDZ_510K)) {
			return all_tip_count;
		}
		tagAnalyseIndexResult_WSK hand_card_idnex = new tagAnalyseIndexResult_WSK();
		AnalysebCardDataToIndex(cbCardData, cbCardCount, hand_card_idnex);
	...
	public boolean auto_no_out(int cbCardData[], int cbCardCount, int turn_card_data[], int turn_card_count) {
		int type = GetCardType(turn_card_data, turn_card_count, false);
		switch (type) {
		case WSKConstants.WSK_YSDZ_CT_BOMB_13:
		case WSKConstants.WSK_YSDZ_CT_BOMB_12:
		case WSKConstants.WSK_YSDZ_CT_BOMB_11: {
		...
		case WSKConstants.WSK_YSDZ_CT_BOMB_10: {
			if (this.GetCardValue(turn_card_data[0]) == 2) {
				return true;
			} else if (cbCardCount < 10) {
				return true;
			}
			return false;
		}
		case WSKConstants.WSK_YSDZ_CT_BOMB_9: {
			if (cbCardCount < 9) {
				return true;
			} else if (cbCardCount == 9 && this.GetCardValue(turn_card_data[0]) == 2) {
				return true;
			}
			return false;
		}
		case WSKConstants.WSK_YSDZ_CT_BOMB_8: {
			if (cbCardCount < 8) {
				return true;
			} else if (cbCardCount == 8 && this.GetCardValue(turn_card_data[0]) == 2) {
				return true;
			}
			return false;
		}
		case WSKConstants.WSK_YSDZ_CT_BOMB_7: {
			if (cbCardCount < 7) {
				return true;
			} else if (cbCardCount == 7 && this.GetCardValue(turn_card_data[0]) == 2) {
				return true;
			}
			return false;
		}
		case WSKConstants.WSK_YSDZ_CT_BOMB_6: {
			if (cbCardCount < 6) {
				return true;
			} else if (cbCardCount == 6 && this.GetCardValue(turn_card_data[0]) == 2) {
				return true;
			}
			return false;
		}
		case WSKConstants.WSK_YSDZ_CT_BOMB_5: {
			if (cbCardCount < 6) {
				return true;
			} else if (cbCardCount == 5 && this.GetCardValue(turn_card_data[0]) == 2) {
				return true;
			}
			return false;
		}
	...
	public int GetCardXianScore(int cbCardData[], int cbCardCount, int card_type) {
		...
		if (card_type >= WSKConstants.WSK_YSDZ_CT_BOMB_4) {
			...
			if (this.GetCardValue(cbCardData[0]) == 1) {
				if (has_rule(WSKConstants.GAME_RULE_YSDZ_A_REWARD)) {
					score = (int) Math.pow(2, (cbCardCount + 1 - 5));
				} else {
					score = (int) Math.pow(2, (cbCardCount - 5));
				}

			} else if (this.GetCardValue(cbCardData[0]) == 7) {
				if (has_rule(WSKConstants.GAME_RULE_YSDZ_7_REWARD)) {
					score = (int) Math.pow(2, (cbCardCount + 1 - 5));
				} else {
					score = (int) Math.pow(2, (cbCardCount - 5));
				}
			} else if (this.GetCardValue(cbCardData[0]) == 11) {
				if (has_rule(WSKConstants.GAME_RULE_YSDZ_J_REWARD)) {
					score = (int) Math.pow(2, (cbCardCount + 1 - 5));
				} else {
					score = (int) Math.pow(2, (cbCardCount - 5));
				}
			} else if (this.GetCardValue(cbCardData[0]) == 13) {
				if (has_rule(WSKConstants.GAME_RULE_YSDZ_K_REWARD)) {
					score = (int) Math.pow(2, (cbCardCount + 1 - 5));
				} else {
					score = (int) Math.pow(2, (cbCardCount - 5));
				}
			} else if (this.GetCardValue(cbCardData[0]) == 2) {
				score = (int) Math.pow(2, (cbCardCount + 1 - 5));
	...
	public int GetHandCardXianScore(int cbCardData[], int cbCardCount, int sheng_dang_biaozhi,
		...
		if (has_rule(WSKConstants.GAME_RULE_YSDZ_A_REWARD)) {
			if (card_index.card_index[11] + wang_count >= max_num) {
				max_num_index = 11;
				max_num = card_index.card_index[11] + wang_count;
			}
		}
		if (has_rule(WSKConstants.GAME_RULE_YSDZ_7_REWARD)) {
		...
		if (has_rule(WSKConstants.GAME_RULE_YSDZ_K_REWARD)) {
			if (card_index.card_index[10] + wang_count >= max_num) {
				max_num_index = 10;
				max_num = card_index.card_index[10] + wang_count;
			}
		}
		...
		for (int i = 0; i < GameConstants.WSK_MAX_INDEX; i++) {
			...
			if (i == 4 && card_index.card_index[i] >= 4 && has_rule(WSKConstants.GAME_RULE_YSDZ_7_REWARD)
					&& i != max_num_index) {
				...
				userCardDataBuilder.addCardsData(cards_card);
			} else if (i == 8 && card_index.card_index[i] >= 4 && has_rule(WSKConstants.GAME_RULE_YSDZ_J_REWARD)
					&& i != max_num_index) {
				int type1 = GetCardType(card_index.card_data[i], card_index.card_index[i], false);
				sscore = this.GetCardXianScore(card_index.card_data[i], card_index.card_index[i], type1);
				score += sscore;
				...
				userCardDataBuilder.addCardsData(cards_card);
			} else if (i == 10 && card_index.card_index[i] >= 4 && has_rule(WSKConstants.GAME_RULE_YSDZ_K_REWARD)
					&& i != max_num_index) {
				int type1 = GetCardType(card_index.card_data[i], card_index.card_index[i], false);
				sscore = this.GetCardXianScore(card_index.card_data[i], card_index.card_index[i], type1);
				score += sscore;
				...
				userCardDataBuilder.addCardsData(cards_card);
			} else if (i == 11 && card_index.card_index[i] >= 4 && has_rule(WSKConstants.GAME_RULE_YSDZ_A_REWARD)
					&& i != max_num_index) {
				int type1 = GetCardType(card_index.card_data[i], card_index.card_index[i], false);
				sscore = this.GetCardXianScore(card_index.card_data[i], card_index.card_index[i], type1);
				score += sscore;
				...
				userCardDataBuilder.addCardsData(cards_card);
			} else if (i == 12 && card_index.card_index[i] == 4 && i != max_num_index) {
				int type1 = GetCardType(card_index.card_data[i], card_index.card_index[i], false);
				sscore = this.GetCardXianScore(card_index.card_data[i], card_index.card_index[i], type1);
				score += sscore;
				cards_card = Int32ArrayResponse.newBuilder();
				...
				userCardDataBuilder.addCardsData(cards_card);
			} else if (card_index.card_index[i] >= 5 && i != max_num_index) {
				int type1 = GetCardType(card_index.card_data[i], card_index.card_index[i], false);
				sscore = this.GetCardXianScore(card_index.card_data[i], card_index.card_index[i], type1);
				score += sscore;
				cards_card = Int32ArrayResponse.newBuilder();
