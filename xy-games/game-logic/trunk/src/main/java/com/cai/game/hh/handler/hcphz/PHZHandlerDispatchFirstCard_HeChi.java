...
public class PHZHandlerDispatchFirstCard_HeChi extends HHHandlerDispatchCard<HeChiHHTable> {
	...
	public void exe(HeChiHHTable table) {
		...
		table.exe_chuli_first_card(_seat_index, GameConstants_HeChi.WIK_NULL, 2500);
		_send_card_data = 0;
		return;
	}
