...
public class HandlerChiPeng_ChenZhou extends HHHandlerChiPeng<Table_New_ChenZhou> {
	...
	@Override
	public boolean handler_operate_card(Table_New_ChenZhou table, int seat_index, int operate_code, int operate_card, int lou_pai) {
