...
public class MJHandlerxcChuZi_KWX_XG extends AbstractMJHandler<Table_KWX_XG> {
	...
	public boolean handler_chu_zi(Table_KWX_XG table, int seat_index, List<Integer> canCards) {
	...
	public boolean handler_token_chu_zi_detail(Table_KWX_XG table, int seat_index) {
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_CHU_ZI);
		table.load_room_info_data(roomResponse);
	...
	public void player_chu_zi(Table_KWX_XG table, int seat_index) {
