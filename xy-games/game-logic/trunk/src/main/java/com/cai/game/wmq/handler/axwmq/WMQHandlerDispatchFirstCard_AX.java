...
public class WMQHandlerDispatchFirstCard_AX extends WMQHandlerDispatchCard<WMQTable> {
...
//		_send_card_data = 0x18;
		...
		while(loop < table.getTablePlayerNumber()){
			...
			if(table.is_tian_hu(i,table._current_player ,chr, table._send_card_data ) == true)
			{
