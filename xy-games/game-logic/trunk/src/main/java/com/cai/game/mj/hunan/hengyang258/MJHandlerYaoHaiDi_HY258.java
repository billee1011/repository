...
public class MJHandlerYaoHaiDi_HY258 extends MJHandlerYaoHaiDi<MJTable_HY258> {

    private static Logger logger = Logger.getLogger(MJHandlerYaoHaiDi_HY258.class);
    ...
    public boolean handler_operate_card(MJTable_HY258 table, int seat_index, int operate_code, int operate_card) {
        ...
        case GameConstants.WIK_ZI_MO: // 自摸
        {
            ...
            // 下局胡牌的是庄家
            table.set_niao_card(table.GRR._banker_player, _send_card_data, false, 0, false,
        ...
        case GameConstants.WIK_CHI_HU: // 胡
        {
            ...
            if (jie_pao_count > 1) {
                table._cur_banker = _seat_index;
                table.set_niao_card(table.GRR._banker_player, _send_card_data, false, 0, true,
