...
import com.cai.game.pdk.PDKGameLogicAI_SW_LL;
import com.cai.game.pdk.PDKTable;

import protobuf.clazz.Protocol.RoomResponse;

@IRootAi(gameIds = { GameConstants.GAME_TYPE_PDK_SW_LL }, desc = "十五张跑得快", msgIds = {
		MsgConstants.RESPONSE_PDK_GAME_START, MsgConstants.RESPONSE_PDK_OUT_CARD })
public class PdkGameOutCardAi_SW_LL extends AbstractAi<PDKTable> {

	public PDKGameLogicAI_SW_LL _logic = new PDKGameLogicAI_SW_LL();

	public PdkGameOutCardAi_SW_LL() {
	}
