...
public class HandlerChiPeng_JingDian_CS_QY extends MJHandlerChiPeng<Table_JingDian_CS_QY> {
	@Override
	public void exe(Table_JingDian_CS_QY table) {
		...
		if (table.GRR._left_card_count > 1) {
			...
			cbActionMask = table._logic.analyse_gang_card_all(table.GRR._cards_index[_seat_index], table.GRR._weave_items[_seat_index],
