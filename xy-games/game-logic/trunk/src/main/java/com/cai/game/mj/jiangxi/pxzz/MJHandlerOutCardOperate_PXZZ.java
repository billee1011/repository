...
public class MJHandlerOutCardOperate_PXZZ extends MJHandlerOutCardOperate<MJTable_PXZZ> {
    ...
    public void exe(MJTable_PXZZ table) {
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_pxzz(_out_card_player, _out_card_data);// ,
    ...
    public boolean handler_operate_card(MJTable_PXZZ table, int seat_index, int operate_code, int operate_card) {
        // 效验状态
    	table.outcard_count[seat_index]++;
