...
public class PHHandlerGang<T extends PHTable> extends PHHandler<T> {
...
//		boolean bAroseAction = table.estimate_gang_respond_fls(_seat_index, _center_card,_type);
	 ...
	 */
	@Override
	public boolean handler_status_operate_card(T table,int seat_index, int operate_code, int operate_card,int lou_pai,int handler_status){
		//抢杠胡
