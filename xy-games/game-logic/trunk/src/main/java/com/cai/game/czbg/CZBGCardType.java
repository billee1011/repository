...
public enum CZBGCardType {

	SINGLE(1) {
		@Override
		public int getRate(CZBGTable table, int[] card_data) {
	 ...
	 * @return
	 */
	public abstract int getRate(CZBGTable table, int[] card_data);

	public static CZBGCardType getType(int[] card_datas, int rule) {
