...
public class MJHandlerOutCardOperate_LZ extends MJHandlerOutCardOperate<MJTable> {
    @Override
    public void exe(MJTable table) {
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_lz(_out_card_player, _out_card_data);// ,
