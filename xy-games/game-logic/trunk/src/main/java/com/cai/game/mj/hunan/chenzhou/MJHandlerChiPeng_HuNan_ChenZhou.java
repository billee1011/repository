...
public class MJHandlerChiPeng_HuNan_ChenZhou extends MJHandlerChiPeng<MJTable_HuNan_ChenZhou> {
	protected GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_HuNan_ChenZhou() {
		_type = 0;
	...
	@Override
	public boolean handler_player_out_card(MJTable_HuNan_ChenZhou table, int seat_index, int card) {
