...
public class Table_KWX_XG_2D extends AbstractMJTable {
	...
	public int liangShowCard(Table_KWX_XG_2D table, int _seat_index, int _operate_card, int[] temp_cards_index) {
	...
	public int showCard(Table_KWX_XG_2D table, int _seat_index, int[] cards_index, int out_card_data, int[] _show_cards) {
		int _count = 0;
		int[] card_index_temp = Arrays.copyOf(cards_index, cards_index.length);
	...
	public void test_cards() {
		int[] cards_of_player2 = new int[] { 0x13, 0x27, 0x28, 0x29, 0x13, 0x14, 0x14, 0x15, 0x16, 0x16, 0x15, 0x35, 0x35 };
		int[] cards_of_player3 = new int[] { 0x11, 0x11, 0x11, 0x18, 0x18, 0x14, 0x14, 0x16, 0x16, 0x16, 0x17, 0x18, 0x18 };
		// int[] cards_of_player1 = new int[] { 0x19, 0x19, 0x19, 0x15, 0x14,
		// 0x14, 0x29, 0x29, 0x21, 0x22, 0x23, 0x14, 0x14 };
		// int[] cards_of_player0 = new int[] { 0x15, 0x22, 0x23, 0x24, 0x12,
		// 0x12, 0x13, 0x14, 0x14, 0x15, 0x21, 0x21, 0x21 };

		// int[] cards_of_player1 = new int[] { 0x19, 0x19, 0x19, 0x3, 0x5, 0x6,
		// 0x7, 0x8, 0x8, 0x8, 0x14, 0x14, 0x14 };
		// int[] cards_of_player0 = new int[] { 0x29, 0x29, 0x29, 0x14, 0x15,
		// 0x15, 0x16, 0x16, 0x16, 0x17, 0x17, 0x18, 0x19 };

		int[] cards_of_player1 = new int[] { 0x14, 0x14, 0x16, 0x17, 0x18, 0x22, 0x23, 0x24, 0x24, 0x25, 0x26, 0x26, 0x27 };
		int[] cards_of_player0 = new int[] { 0x17, 0x17, 0x17, 0x8, 0x6, 0x7, 0x3, 0x4, 0x5, 0x6, 0x9, 0x7, 0x8 };

		// int[] cards_of_player1 = new int[] { 0x11, 0x12, 0x13, 0x13, 0x13,
		// 0x16, 0x16, 0x29, 0x29, 0x29, 0x21, 0x21, 0x21 };
		// int[] cards_of_player0 = new int[] { 0x14, 0x14, 0x14, 0x28, 0x15,
		// 0x16, 0x11, 0x11, 0x29, 0x29, 0x29, 0x28, 0x28 };
		// int[] cards_of_player2 = new int[] { 0x23, 0x24, 0x24, 0x25, 0x26,
		// 0x28, 0x28, 0x11, 0x11, 0x11, 0x19, 0x19, 0x19 };
		// int[] cards_of_player3 = new int[] { 0x16, 0x16, 0x16, 0x16, 0x14,
		// 0x14, 0x17, 0x18, 0x18, 0x18, 0x11, 0x11, 0x11 };

		// int[] cards_of_player2 = new int[] { 0x12, 0x13, 0x13, 0x13, 0x11,
		// 0x14, 0x15, 0x29, 0x29, 0x29, 0x21, 0x21, 0x21 };
		// int[] cards_of_player3 = new int[] { 0x11, 0x12, 0x13, 0x13, 0x13,
		// 0x16, 0x16, 0x29, 0x29, 0x29, 0x21, 0x21, 0x21 };
		// int[] cards_of_player0 = new int[] { 0x14, 0x14, 0x16, 0x17, 0x18,
		// 0x22, 0x23, 0x24, 0x24, 0x25, 0x26, 0x26, 0x27 };
		// int[] cards_of_player1 = new int[] { 0x17, 0x17, 0x17, 0x18, 0x26,
		// 0x27, 0x28, 0x13, 0x14, 0x14, 0x15, 0x16, 0x16 };
