...
public class MJHandlerChiPeng_ShanXi_LOUFAN extends MJHandlerChiPeng<MJTable_ShanXi_LOUFAN> {
	...
	public MJHandlerChiPeng_ShanXi_LOUFAN() {
	...
	@Override
	public boolean handler_operate_card(MJTable_ShanXi_LOUFAN table, int seat_index, int operate_code, int operate_card) {
	...
	@Override
	public boolean handler_player_out_card(MJTable_ShanXi_LOUFAN table, int seat_index, int card) {
