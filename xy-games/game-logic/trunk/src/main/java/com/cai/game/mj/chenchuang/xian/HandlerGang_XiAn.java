...
public class HandlerGang_XiAn extends MJHandlerGang<Table_XiAn> {
	...
	@Override
	public boolean exe_gang(Table_XiAn table) {
		int cbCardIndex = table._logic.switch_to_card_index(_center_card);
		int cbWeaveIndex = -1;
		
		table.room_gang_count++;
	...
	@Override
	public boolean handler_operate_card(Table_XiAn table, int seat_index, int operate_code, int operate_card) {
		 // 效验状态
		...
		if (table.has_rule(Constants_MJ_XI_AN.GAME_RULE_PU_TONG_PING_HU)) {
	...
	private void handler_operate_tong_pao(Table_XiAn table, int seat_index,
	...
	private void handler_operate_bu_tong_pao(Table_XiAn table, int seat_index,
			int operate_code, int operate_card) {
		int target_player = seat_index;
	...
	@Override
	public boolean handler_player_be_in_room(Table_XiAn table, int seat_index) {
