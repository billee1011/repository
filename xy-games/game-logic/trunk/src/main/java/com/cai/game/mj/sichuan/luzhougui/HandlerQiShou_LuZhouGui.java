...
public class HandlerQiShou_LuZhouGui extends NewHandlerQiShou<AbstractSiChuanMjTable> {
	public HandlerQiShou_LuZhouGui() {
	...
	public void exe(AbstractSiChuanMjTable table) {
		...
		int action = table.analyse_chi_hu_card(table.GRR._cards_index[_seat_index], table.GRR._weave_items[_seat_index],
				table.GRR._weave_count[_seat_index], 0, chr, Constants_SiChuan.HU_CARD_TYPE_ZI_MO, _seat_index, _seat_index);
