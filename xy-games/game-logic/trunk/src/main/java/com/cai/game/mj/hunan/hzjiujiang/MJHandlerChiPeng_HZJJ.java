...
public class MJHandlerChiPeng_HZJJ extends MJHandlerChiPeng<MJTable_HZJJ> {
    private GangCardResult m_gangCardResult;

    public MJHandlerChiPeng_HZJJ() {
    ...
    public void exe(MJTable_HZJJ table) {
        ...
        int action = table.analyse_chi_hu_card_hz_new(in_card_arr, table.GRR._weave_items[_seat_index],
