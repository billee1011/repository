...
public class BankerJettonRunnable extends BaseFuture {
	private static Logger logger = LoggerFactory.getLogger(BankerJettonRunnable.class);

	
	private int _room_id;
	
	public BankerJettonRunnable(int room_id){
		super(room_id);
		_room_id = room_id;
	}
