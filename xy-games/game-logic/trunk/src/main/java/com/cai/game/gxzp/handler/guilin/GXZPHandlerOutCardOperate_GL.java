...
public class GXZPHandlerOutCardOperate_GL extends GXZPHandlerOutCardOperate<GXZPTable> {
	@Override
	public void exe(GXZPTable table) {
		...
		if(bHupai == 0&&ti_pao == GameConstants.WIK_NULL )
		{
...
//		}
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_glzp(target_player, this._out_card_player, operate_card, false);
