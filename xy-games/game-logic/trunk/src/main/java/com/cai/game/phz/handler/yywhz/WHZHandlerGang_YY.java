...
public class WHZHandlerGang_YY extends PHZHandlerGang<YYWHZTable> {
	 ...
	 */
	@Override
	public boolean handler_operate_card(YYWHZTable table, int seat_index, int operate_code, int operate_card,int luoCode) {
		// 抢杠胡
...
//			}
	 ...
	 * 
	 ***/
	protected boolean exe_gang(YYWHZTable table) {
