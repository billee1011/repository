...
public class BYZPHandlerGang_GL extends GXZPHandlerGang<GXZPTable> {
...
//		}
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_bayi(target_player, this._provide_player, operate_card, false);
...
//			}
			...
			table.countChiHuTimes_bayi(_seat_index, true);
