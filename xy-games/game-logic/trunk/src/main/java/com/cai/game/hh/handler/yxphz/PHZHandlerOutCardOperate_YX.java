...
public class PHZHandlerOutCardOperate_YX extends HHHandlerOutCardOperate<HHTable> {
	@Override
	public void exe(HHTable table) {
		...
		for(int i = 0; i<table.getTablePlayerNumber();i++)
		{
			...
			int pao_type[] = new int[1];
			ti_pao = table.estimate_player_respond_hh(i,_out_card_player ,_out_card_data, pao_type,false);
