...
public class PHZHandlerDispatchFirstCard_XT extends HHHandlerDispatchCard<HHTable> {
...
//		_send_card_data = 0x18;
		...
		for(int i = 0;i<table.getTablePlayerNumber();i++)
		{
			...
			if(((ti_count >= 3)||(sao_count >= 5))&&(table.has_rule(GameConstants.GAME_RULE_ALL_MING_TANG)))
			{
