...
public class MJHandlerHaiDi_HY258 extends MJHandlerHaiDi<MJTable_HY258> {

    private static Logger logger = Logger.getLogger(MJHandlerHaiDi_HY258.class);
    ...
    public void exe(MJTable_HY258 table) {
        ...
        boolean isTing = table.is_hy_ting_card(table.GRR._cards_index[_seat_index], table.GRR._weave_items[_seat_index],
