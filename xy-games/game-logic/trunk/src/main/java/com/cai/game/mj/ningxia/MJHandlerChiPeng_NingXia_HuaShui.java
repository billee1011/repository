...
public class MJHandlerChiPeng_NingXia_HuaShui extends MJHandlerChiPeng<MJTable_NingXia_HuaShui> {
	...
	public MJHandlerChiPeng_NingXia_HuaShui() {
		_type = 0;
	...
	public void exe(MJTable_NingXia_HuaShui table) {
		...
		if (table.GRR._cards_index[_seat_index][table._logic.switch_to_card_index(_card)] == 1) {// 碰完之后手上还有一张这个牌
			...
			table.is_gang_valid[_seat_index] = true;
		}
		...
		if (table.GRR._left_card_count > 0) {
			...
			int cbActionMask = table.analyse_gang(curPlayerStatus, table.GRR._cards_index[_seat_index],
	...
	@Override
	public boolean handler_player_out_card(MJTable_NingXia_HuaShui table, int seat_index, int card) {
