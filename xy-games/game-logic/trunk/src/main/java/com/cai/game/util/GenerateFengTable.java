...
class GenerateFengTable {
    ...
    private static void generate() {
        System.out.println("Generating feng table begin ...");
        initialize();
        generate_table(false, false, false);
        generate_eye_table(true, false, false);
        TableManager.getInstance().dump_feng();
        System.out.println("Generating feng table finished ...");
    }
