...
///////////////////////////////////////////////////////////////////////////////////////////////
public class PDK_FIFTEEN_Table_CZ extends PDKTable {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_FIFTEEN_CZ();
	...
	private void test_cards() {
		if (DEBUG_CARDS_MODE) {
			int cards[] = new int[] { 59, 57, 49, 24, 3, 12, 45, 41, 39, 43, 36, 60, 35, 29, 61, 53, 4, 10, 8, 51, 26,
					42, 55, 7, 50, 20, 37, 9, 25, 58, 22, 6, 44, 11, 28, 52, 54, 40, 21, 23, 56, 38, 19, 5, 27 };
			// int cards[] = new int[]
