...
public class HandlerChuLiFirstCard extends HHHandlerDispatchCard<HongErShiTable> {
	...
	public void exe(HongErShiTable table) {
		...
		if (hu != GameConstants.WIK_NULL) {
			...
			table._playerStatus[table._cur_banker].add_tou(_send_card_data, HongErShiConstants.WIK_ZI_MO, table._cur_banker);
