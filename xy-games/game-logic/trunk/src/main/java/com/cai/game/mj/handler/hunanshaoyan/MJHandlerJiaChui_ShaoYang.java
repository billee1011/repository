...
public class MJHandlerJiaChui_ShaoYang extends AbstractMJHandler<MJTable_ShaoYang> {
	@Override
	...
	public boolean handler_pao_qiang(MJTable_ShaoYang table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_ShaoYang table, int seat_index) {
