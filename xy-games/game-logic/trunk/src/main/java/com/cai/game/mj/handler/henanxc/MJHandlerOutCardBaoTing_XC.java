...
public class MJHandlerOutCardBaoTing_XC extends MJHandlerOutCardBaoTing {
	...
	public void exe(MJTable table) {
		...
		// 出牌
		table.operate_out_card_bao_ting_zhou_kou(_out_card_player, 1, new int[] { _out_card_data + GameConstants.CARD_ESPECIAL_TYPE_BAO_TING },
		...
		if (!table._logic.is_magic_card(_out_card_data)) {
			bAroseAction = table.estimate_player_out_card_respond_henan_xc(_out_card_player, _out_card_data);
		}
