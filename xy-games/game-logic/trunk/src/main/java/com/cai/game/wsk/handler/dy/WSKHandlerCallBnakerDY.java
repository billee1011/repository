...
public class WSKHandlerCallBnakerDY extends WSKHandlerCallBnaker<WSKTable_DY> {
	@Override
	...
	public boolean handler_call_banker(WSKTable_DY table, int seat_index, int call_action) {
