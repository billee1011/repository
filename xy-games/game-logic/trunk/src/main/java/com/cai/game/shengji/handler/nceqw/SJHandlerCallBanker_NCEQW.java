...
public class SJHandlerCallBanker_NCEQW extends SJHandlerCallBanker<SJTable_NCEQW> {
	protected int _seat_index;
	protected int _game_status;
	protected int _call_ation;
	// private int _current_player =MJGameConstants.INVALID_SEAT;

	public SJHandlerCallBanker_NCEQW() {
	}
	 ...
	 * @return
	 */
	public boolean handler_call_banker(SJTable_NCEQW table, int seat_index, int call_action) {
