...
public class MJHandlerChiPeng_New_ZhenZhou extends MJHandlerChiPeng<MJTable_New_ZhenZhou> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_New_ZhenZhou() {
	...
	@Override
	public boolean handler_player_out_card(MJTable_New_ZhenZhou table, int seat_index, int card) {
