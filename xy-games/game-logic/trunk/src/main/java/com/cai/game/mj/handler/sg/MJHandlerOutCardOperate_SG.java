...
public class MJHandlerOutCardOperate_SG extends MJHandlerOutCardOperate<MJTable> {
    ...
    public void exe(MJTable table) {
        ...
        if (SysParamServerUtil.is_new_algorithm(3000, 3000, 1)) {
            // 显示听牌
            table._playerStatus[_out_card_player]._hu_card_count = MahjongTingPaiUtil.getInstance().get_sg_ting_card(
                    table._playerStatus[_out_card_player]._hu_cards, table.GRR._cards_index[_out_card_player],
                    table.GRR._weave_items[_out_card_player], table.GRR._weave_count[_out_card_player], table);
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_zz(_out_card_player, _out_card_data);// ,
    ...
    public boolean handler_operate_card(MJTable table, int seat_index, int operate_code, int operate_card) {
        ...
        case GameConstants.WIK_NULL: {
            ...
            // 用户切换
            _current_player = table._current_player = (_out_card_player + GameConstants.GAME_PLAYER + 1)
    ...
    // table.GRR._weave_items[target_player][i].provide_player;
    // //癞子
