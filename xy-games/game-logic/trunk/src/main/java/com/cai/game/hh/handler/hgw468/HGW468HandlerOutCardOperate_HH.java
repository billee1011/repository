...
public class HGW468HandlerOutCardOperate_HH extends HHHandlerOutCardOperate<HHTable> {
	@Override
...
//		}
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_hgw468(target_player, _out_card_player, _out_card_data, false);
