...
///////////////////////////////////////////////////////////////////////////////////////////////
public class DBNTable extends AbstractRoom {
	/**
	 * 
	 */
	...
	private static Logger logger = Logger.getLogger(DBNTable.class);
	...
	public DBNGameLogic _logic = null;
	...
	public boolean reset_init_data() {
		...
		SysParamModel sysParamModel4 = SysParamServerDict.getInstance()
				.getSysParamModelDictionaryByGameId(SysGameTypeDict.getInstance().getGameIDByTypeIndex(_game_type_index)).get(4);
	...
	protected boolean on_handler_game_start() {
		...
		_cur_jetton_round = 0;
		//
		if (is_mj_type(GameConstants.GAME_TYPE_DBN)) {
	...
	public boolean handler_game_finish_dbn(int seat_index, int reason) {
		...
		// "+banker_round+"_cur_banker_count = "+_cur_banker_count
		// +"_banker_count = "+_banker_count);
		// }
		// }
		// }
