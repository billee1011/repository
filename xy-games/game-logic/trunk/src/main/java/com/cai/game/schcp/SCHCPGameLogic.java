...
public class SCHCPGameLogic {
	...
	public int get_action_rank(int player_action) {
		...
		// 上牌等级
		if (player_action == GameConstants.CP_WIK_RIGHT || player_action == GameConstants.CP_WIK_CENTER
				|| player_action == GameConstants.CP_WIK_LEFT) {
			return 10;
		}
