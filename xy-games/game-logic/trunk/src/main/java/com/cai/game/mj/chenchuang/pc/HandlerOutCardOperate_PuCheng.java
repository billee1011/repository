...
public class HandlerOutCardOperate_PuCheng extends MJHandlerOutCardOperate<Table_PuCheng> {
	...
	@Override
	public void exe(Table_PuCheng table) {
		//烧庄处理
		if(table.is_chase_vaild){
			if(table.GRR._banker_player == _out_card_player)
				table.banker_out_card = _out_card_data;
			else if(_out_card_data != table.banker_out_card)
				table.is_chase_vaild = false;
		}
	...
	@Override
	public boolean handler_operate_card(Table_PuCheng table, int seat_index, int operate_code, int operate_card) {
		...
		table.operate_action_cancel_trustee(seat_index);
	...
	private void handler_operate_bu_tong_pao(Table_PuCheng table, int seat_index,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_PC.CHR_FANG_PAO);
	...
	private void handler_operate_tong_pao(Table_PuCheng table, int seat_index,
			int operate_code, int operate_card) {
		if (operate_code == GameConstants.WIK_CHI_HU) {
	...
	@Override
	public boolean handler_player_be_in_room(Table_PuCheng table, int seat_index) {
