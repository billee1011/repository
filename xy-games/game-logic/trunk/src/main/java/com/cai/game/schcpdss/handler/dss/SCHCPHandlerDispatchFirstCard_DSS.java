...
public class SCHCPHandlerDispatchFirstCard_DSS extends SCHCPDSSHandlerDispatchCard<SCHCPDSSTable> {
...
//					% table.getTablePlayerNumber();
	 ...
	 */
	@Override
	public boolean handler_operate_card(SCHCPDSSTable table, int seat_index, int operate_code, int operate_card,
			int luoCode) {
