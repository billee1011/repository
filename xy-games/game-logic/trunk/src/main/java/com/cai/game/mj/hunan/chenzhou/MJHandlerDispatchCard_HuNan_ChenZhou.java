...
public class MJHandlerDispatchCard_HuNan_ChenZhou extends MJHandlerDispatchCard<MJTable_HuNan_ChenZhou> {
	protected GangCardResult m_gangCardResult;
	private boolean ting_send_card = false;

	public MJHandlerDispatchCard_HuNan_ChenZhou() {
	...
	public boolean handler_operate_card(MJTable_HuNan_ChenZhou table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_ZI_MO: // 自摸
		{
			...
			if (GameConstants.GANG_TYPE_JIE_GANG == _type) {
				table.process_chi_hu_player_score(_seat_index, _seat_index, operate_card, 3); // 自摸胡算分
			} else {
