...
class GenerateTable_PengHu {
    ...
    private static void generate() {
        System.out.println("Generating peng hu table begin ...");
        initialize();
        generate_table(false, true, false);
        generate_eye_table(true, true, false);
        TableManager.getInstance().dump_ph();
        System.out.println("Generating peng hu table finished ...");
    }
