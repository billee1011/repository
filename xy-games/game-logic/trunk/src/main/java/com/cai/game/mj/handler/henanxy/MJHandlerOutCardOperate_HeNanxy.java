...
public class MJHandlerOutCardOperate_HeNanxy extends MJHandlerOutCardOperate<MJTable> {
    ...
    public void exe(MJTable table) {
            ...
            for (int i = 0; i < table.GRR._xianchu_count[_out_card_player]; i++) {
                if (table.GRR._xianchu_cards[_out_card_player][i] == _out_card_data) {
                    if (i == table.GRR._xianchu_count[_out_card_player] - 1) {
                        ...
                        table.GRR._xianchu_cards[_out_card_player][i] = table.GRR._xianchu_cards[_out_card_player][i
                                + 1];
                    }
        ...
        // 信阳麻将,检查听牌
        table._playerStatus[_out_card_player]._hu_card_count = table.get_henanxy_ting_card(
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_henan_xy(_out_card_player, _out_card_data);// ,
