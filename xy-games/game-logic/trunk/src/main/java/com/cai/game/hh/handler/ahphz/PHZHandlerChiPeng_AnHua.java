...
public class PHZHandlerChiPeng_AnHua extends HHHandlerChiPeng<AnHuaHHTable> {

	private GangCardResult m_gangCardResult;

	public PHZHandlerChiPeng_AnHua() {
	 ...
	 */
	@Override
	public boolean handler_operate_card(AnHuaHHTable table, int seat_index, int operate_code, int operate_card, int lou_pai) {
