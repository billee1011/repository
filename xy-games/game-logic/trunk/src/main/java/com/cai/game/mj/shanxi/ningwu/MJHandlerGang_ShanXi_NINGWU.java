...
public class MJHandlerGang_ShanXi_NINGWU extends MJHandlerGang<MJTable_ShanXi_NINGWU> {
	...
	public MJHandlerGang_ShanXi_NINGWU() {
	}
	...
	@Override
	public boolean exe_gang(MJTable_ShanXi_NINGWU table) {
		int no_feng_operate_card = _center_card;
