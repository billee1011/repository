...
public class HandlerChuLiFirstCard_ChenZhou extends HHHandlerDispatchCard<Table_ChenZhou> {
	...
	public boolean handler_operate_card(Table_ChenZhou table, int seat_index, int operate_code, int operate_card,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			if (target_player == _seat_index) {
				table.GRR._chi_hu_rights[target_player].opr_or(Constants_ChenZhou.CHR_TIAN_HU);
			}
