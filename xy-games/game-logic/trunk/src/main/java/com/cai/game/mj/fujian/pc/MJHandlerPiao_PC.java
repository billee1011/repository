...
public class MJHandlerPiao_PC extends AbstractMJHandler<Table_PC> {
	...
	public boolean handler_pao_qiang(Table_PC table, int seat_index, int pao, int qiang) {
		...
		if (table._game_status == GameConstants_KWX.GS_MJ_PIAO) {
			...
			table.operate_mai_ma_card(GameConstants_PC.INVALID_SEAT, false);
			table.on_game_start();
		}
	...
	private void player_reconnect(Table_PC table, int seat_index) {
