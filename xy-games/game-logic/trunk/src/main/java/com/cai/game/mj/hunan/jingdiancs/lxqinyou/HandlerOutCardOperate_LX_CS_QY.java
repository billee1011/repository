...
public class HandlerOutCardOperate_LX_CS_QY extends MJHandlerOutCardOperate<Table_LX_CS_QY> {
	...
	public boolean handler_operate_card(Table_LX_CS_QY table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_CHI_HU: {
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_LX_CS_QY.CHR_FANG_PAO);
