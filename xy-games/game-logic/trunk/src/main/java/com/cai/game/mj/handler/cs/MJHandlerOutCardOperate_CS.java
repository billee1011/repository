...
public class MJHandlerOutCardOperate_CS extends MJHandlerOutCardOperate<MJTable> {
    @Override
    public void exe(MJTable table) {
        ...
        table._playerStatus[_out_card_player]._hu_card_count = table.get_cs_ting_card(
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_cs(_out_card_player, _out_card_data);// ,
        ...
        case GameConstants.WIK_CHI_HU: // 胡
        {
            ...
            if (jie_pao_count > 0) {
                ...
                for (int i = 0; i < table.getTablePlayerNumber(); i++) {
                    ...
                    table.process_chi_hu_player_score_cs(i, _out_card_player, false);
