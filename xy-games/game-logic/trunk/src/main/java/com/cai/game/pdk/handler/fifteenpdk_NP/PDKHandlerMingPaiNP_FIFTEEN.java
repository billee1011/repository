...
public class PDKHandlerMingPaiNP_FIFTEEN extends PDKHandlerMingPai<PDK_FIFTEEN_Table_NP> {
	@Override
	...
	@Override
	public boolean handler_ming_pai(PDK_FIFTEEN_Table_NP table, int seat_index, int ming_action) {
