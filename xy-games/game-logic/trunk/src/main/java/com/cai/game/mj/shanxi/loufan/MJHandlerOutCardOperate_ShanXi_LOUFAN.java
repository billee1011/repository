...
public class MJHandlerOutCardOperate_ShanXi_LOUFAN extends MJHandlerOutCardOperate<MJTable_ShanXi_LOUFAN> {
	...
	@Override
	public void exe(MJTable_ShanXi_LOUFAN table) {
	...
	@Override
	public boolean handler_operate_card(MJTable_ShanXi_LOUFAN table, int seat_index, int operate_code,
			int operate_card) {
		PlayerStatus playerStatus = table._playerStatus[seat_index];

		// int no_feng_operate_card=operate_card;
		// if(operate_card==GameConstants_SXLF.DONG_FENG_CARD+GameConstants_SXLF.CARD_ESPECIAL_TYPE_GANG_NAN_FENG){
		// no_feng_operate_card=operate_card-GameConstants_SXLF.CARD_ESPECIAL_TYPE_GANG_NAN_FENG;
		// }
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or_xt(GameConstants_SXLF.CHR_TYPE_DIAN_PAO, false);
	...
	@Override
	public boolean handler_player_be_in_room(MJTable_ShanXi_LOUFAN table, int seat_index) {
		...
		for (int i = 0; i < table.getTablePlayerNumber(); i++) {
			...
			for (int j = 0; j < 55; j++) {
				...
				// GameConstants_SXLF.CARD_ESPECIAL_TYPE_HIDE);
				// }else{
				int_array.addItem(table.GRR._discard_cards[i][j]);
				// }
			}
