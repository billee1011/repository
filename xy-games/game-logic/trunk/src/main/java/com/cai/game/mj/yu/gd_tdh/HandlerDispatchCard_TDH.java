...
public class HandlerDispatchCard_TDH extends MJHandlerDispatchCard<Table_TDH> {
	...
	public HandlerDispatchCard_TDH() {
	...
	public void exe(Table_TDH table) {
		...
		int card_type_count = GameConstants_TDH.MAX_ZI_FENG;
		...
		case GameConstants_TDH.WIK_ZI_MO: {
			...
			if (_type == GameConstants_TDH.GANG_TYPE_AN_GANG || _type == GameConstants_TDH.GANG_TYPE_ADD_GANG
				...
				if (_type == GameConstants_TDH.GANG_TYPE_JIE_GANG) {
					table.process_chi_hu_player_score(_seat_index, table._out_card_player, operate_card, true, Table_TDH.HU_TYPE_GANG_KAI);
				} else {
					table.process_chi_hu_player_score(_seat_index, _seat_index, operate_card, true, Table_TDH.HU_TYPE_GANG_KAI);
				}
			} else {
				table.process_chi_hu_player_score(_seat_index, _seat_index, operate_card, true, Table_TDH.HU_TYPE_ZI_MO);
			}
