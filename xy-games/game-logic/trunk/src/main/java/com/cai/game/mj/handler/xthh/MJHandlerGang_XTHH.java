...
public class MJHandlerGang_XTHH extends MJHandlerGang<MJTable> {
	...
	public void exe(MJTable table) {
		...
		if ((GameConstants.WIK_MENG_XIAO == _type) || (GameConstants.WIK_DIAN_XIAO == _type) || (GameConstants.WIK_DA_CHAO_TIAN == _type)
	...
	protected boolean exe_gang(MJTable table) {
		...
		float base_score = table.game_cell;// *table.GRR._bei_shu;
		float gang_score = 0;
