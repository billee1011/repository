...
public class HandlerDispatchCard_LeiYang extends HHHandlerDispatchCard<Table_LeiYang> {
    ...
    public void exe(Table_LeiYang table) {
        ...
        for (int p = 0; p < table.getTablePlayerNumber(); p++) {
            ...
            if (_seat_index != i)
                ...
                card_type = Constants_LeiYang.HU_CARD_FAN_PAI_ZI_MO;
            ...
            if (table._playerStatus[_seat_index].lock_huan_zhang()) {
                ...
                if (bAroseAction == false) { // 并且没人吃碰牌
                    ...
                    if (table._last_card != 0)
                        table.exe_add_discard(_seat_index, 1, new int[] { table._last_card }, true, 500);
    ...
    public boolean handler_operate_card(Table_LeiYang table, int seat_index, int operate_code, int operate_card,
        ...
        case GameConstants.WIK_NULL: {
            ...
            if (table._playerStatus[_seat_index].lock_huan_zhang()) {
                ...
                table.exe_dispatch_card(next_player, GameConstants.WIK_NULL, 300);
                table._last_card = table._send_card_data;
            }
            return true;
        }
