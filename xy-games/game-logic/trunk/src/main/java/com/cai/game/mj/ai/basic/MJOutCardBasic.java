...
@IRootAi(gameIds = {},gameType = 1, desc = "麻将出牌", msgIds = {
				MsgConstants.RESPONSE_PLAYER_STATUS })
public class MJOutCardBasic extends AbstractAi<AbstractMJTable> {

	public MJOutCardBasic() {
	}
	...
	public void onExe(AbstractMJTable table, RobotPlayer player, RoomResponse rsp) {
		...
		MJAIGameLogic.AI_Out_Card(table, seat_index);
