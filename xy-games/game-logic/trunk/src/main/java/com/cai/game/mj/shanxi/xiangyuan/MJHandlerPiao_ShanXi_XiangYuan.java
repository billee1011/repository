...
public class MJHandlerPiao_ShanXi_XiangYuan extends AbstractMJHandler<MJTable_ShanXi_XiangYuan> {
	...
	public boolean handler_pao_qiang(MJTable_ShanXi_XiangYuan table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_ShanXi_XiangYuan table, int seat_index) {
		...
		roomResponse.setPaoMin(0);
		roomResponse.setPaoMax(4);
		roomResponse.setPaoDes("当前最多飘2个");
		table.send_response_to_player(seat_index, roomResponse);
