...
public class SCHCPHandlerDispatchAddCard_DAZHUI extends SCHCPHandlerDispatchCard<SCHCPTable> {
...
//		}
	 ...
	 */
	@Override
	public boolean handler_player_out_card(SCHCPTable table, int seat_index, int card) {
		// 错误断言
