...
private static Logger logger = Logger.getLogger(NNGameLogic.class);
	...
	public int get_card_type(int card_date[],int card_count,  Map<Integer, Integer> ruleMaps){
		...
		if((same_color==true)&&(line_card == true)&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_JIANG_XI)==1){
//			if(da_count == 1)
//				return GameConstants.KLOX_JX_DA_THSH;
//			else if(xiao_count == 1)
//				return GameConstants.KLOX_JX_XIAO_THSH;
//			else 
				return GameConstants.KLOX_JX_THSH;
		}
		...
		if(four_count + da_count + xiao_count >= 4&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_ZHA_DAN)==1)
		{
//			if(four_count == 4)
//				return GameConstants.KLOX_JX_BOOM;
//			else if(da_count == 1)
//				return GameConstants.KLOX_JX_DA_BOOM;
//			else if(xiao_count == 1)
//				return GameConstants.KLOX_JX_XIAO_BOOM;
//			else
				return GameConstants.KLOX_JX_BOOM;
		}
		...
		for(int i = 0; i< GameConstants.OX_MAX_CARD_COUNT;i++){
			if(get_card_color(card_date[i]) == 4)
				wxox_sum +=1;
			else if(get_card_value(card_date[i]) == 5)
				wxox_sum += 10;
			else 
				wxox_sum += get_card_value(card_date[i]);
		}
	
		if(this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_WU_XIAO_NIU)==1&&wxox_sum<10)
		{
			if(da_count == 1)
				return GameConstants.KLOX_JX_DA_HU_LU;
			else if(xiao_count == 1)
				return GameConstants.KLOX_JX_XIAO_WXOX;
			else return GameConstants.KLOX_JX_WXOX;
		}
		...
		if(card_real_count <= 2&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_HU_LU)==1)
		{
//			if(da_count == 1)
//				return  GameConstants.KLOX_JX_DA_HU_LU;
//			else if(xiao_count == 1)
//				return  GameConstants.KLOX_JX_XIAO_HU_LU;
			return GameConstants.KLOX_JX_HU_LU;
		}
		if(is_two ==  true&&is_three == true&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_HU_LU)==1)
		{
			return GameConstants.KLOX_JX_HU_LU;
		}
		...
		if((same_color==true)&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_TONG_HUAN)==1) 
		{
			if(da_count == 1)
				return  GameConstants.KLOX_JX_DA_TONG_HUA;
			else if(xiao_count == 1)
				return  GameConstants.KLOX_JX_XIAO_TONG_HUA;
			else
				return  GameConstants.KLOX_JX_TONG_HUA;
		}
		if(king_count == GameConstants.OX_MAX_CARD_COUNT&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_WU_HUA)==1)
		{
			if(da_count == 1)
				return GameConstants.KLOX_JX_DA_WU_HUA_NIU;
			else if(xiao_count == 1)
				return GameConstants.KLOX_JX_XIAO_WU_HUA_NIU;
			else 
				 return GameConstants.KLOX_JX_WU_HUA_NIU;
		}
		if((line_card == true)&&this.getRuleValue(ruleMaps, GameConstants.GAME_RULE_KLJX_SHU_ZI)==1)
		{
//			if(da_count == 1)
//				return  GameConstants.KLOX_JX_DA_SHUN_ZI;
//			else if(xiao_count == 1)
//				return  GameConstants.KLOX_JX_XIAO_SHUN_ZI;
//			else
				return  GameConstants.KLOX_JX_SHUN_ZI;
		}
	    count = 0;
		for(int i = 0; i< GameConstants.OX_MAX_CARD_COUNT;i++)
		{
		...
		if(da_count == 1 && xiao_count == 1)
			return  GameConstants.KLOX_JX_DA_TEN;
	...
	public int get_times_one(int card_date[],int card_count, Map<Integer, Integer> ruleMaps){
		...
		switch(times)
		{
		case GameConstants.KLOX_JX_VALUE0: // 混合牌型 无牛
		case GameConstants.KLOX_JX_XIAO_ONE:// 小牛1
		case GameConstants.KLOX_JX_DA_ONE:// 大牛1
		case GameConstants.KLOX_JX_ONE: // 牛1
		case GameConstants.KLOX_JX_XIAO_TWO:// 小牛2
		case GameConstants.KLOX_JX_DA_TWO://大牛2
		case GameConstants.KLOX_JX_TWO: // 牛2
		case GameConstants.KLOX_JX_XIAO_THREE:// 小牛3
		case GameConstants.KLOX_JX_DA_THREE: // 大牛3
		case GameConstants.KLOX_JX_THREE: // 牛3
		case GameConstants.KLOX_JX_XIAO_FOUR:// 小牛4
		case GameConstants.KLOX_JX_DA_FOUR: // 大牛4
		case GameConstants.KLOX_JX_FOUR: // 牛4
		case GameConstants.KLOX_JX_XIAO_FIVE:// 小牛5
		case GameConstants.KLOX_JX_DA_FIVE: // 大牛5
		case GameConstants.KLOX_JX_FIVE: // 牛5
		case GameConstants.KLOX_JX_XIAO_SIX:// 小牛6
		case GameConstants.KLOX_JX_DA_SIX: // 大牛6
		case GameConstants.KLOX_JX_SIX: // 牛6
			return 1;
		case GameConstants.KLOX_JX_XIAO_SEVEN:// 小牛7
		case GameConstants.KLOX_JX_DA_SEVEN: // 大牛7
		case GameConstants.KLOX_JX_SEVEN: // 牛7
			return 2;
		case GameConstants.KLOX_JX_XIAO_EIGHT:// 小牛8
		case GameConstants.KLOX_JX_DA_EIGHT:// 大牛8
		case GameConstants.KLOX_JX_EIGHT: // 牛8
			return 2;
		case GameConstants.KLOX_JX_XIAO_NINE:// 小牛9
		case GameConstants.KLOX_JX_DA_NINE:// 大牛9
		case GameConstants.KLOX_JX_NINE:// 牛9
			return 3;
		case GameConstants.KLOX_JX_XIAO_TEN:// 小牛10
		case GameConstants.KLOX_JX_DA_TEN:// 大牛10
		case GameConstants.KLOX_JX_TEN:// 牛10
			return 4;
		case GameConstants.KLOX_JX_XIAO_SHUN_ZI:// 小顺子牛 
		case GameConstants.KLOX_JX_DA_SHUN_ZI:// 大顺子 牛
		case GameConstants.KLOX_JX_SHUN_ZI:// 顺子
			return 5;
		case GameConstants.KLOX_JX_XIAO_WU_HUA_NIU:// 小五花牛
		case GameConstants.KLOX_JX_DA_WU_HUA_NIU: // 大五花牛
		case GameConstants.KLOX_JX_WU_HUA_NIU: // 五花牛
			return 5;
		case GameConstants.KLOX_JX_XIAO_TONG_HUA:// 小同花牌
		case GameConstants.KLOX_JX_DA_TONG_HUA: // 大同花牛
		case GameConstants.KLOX_JX_TONG_HUA: // 同花
			return 6;
		case GameConstants.KLOX_JX_XIAO_HU_LU:// 小葫芦牛
		case GameConstants.KLOX_JX_DA_HU_LU: // 大葫芦牛
		case GameConstants.KLOX_JX_HU_LU: // 葫芦牛
			return 7;
		case GameConstants.KLOX_JX_XIAO_WXOX:// 小五小牛
		case GameConstants.KLOX_JX_DA_WXOX :// 大五小牛
		case GameConstants.KLOX_JX_WXOX: // 五小牛
			return 8;
		case GameConstants.KLOX_JX_XIAO_BOOM:// 小炸弹牛
		case GameConstants.KLOX_JX_DA_BOOM: // 大炸弹牛
		case GameConstants.KLOX_JX_BOOM:// 炸弹
			return 8;
		case GameConstants.KLOX_JX_XIAO_THSH:// 小同花顺
		case GameConstants.KLOX_JX_DA_THSH: //大同花顺
		case GameConstants.KLOX_JX_THSH:// 同花顺
			return 10;
		}
		return times;
	}
			...
			, Map<Integer, Integer> ruleMaps)
	{
		...
		if(next_type == GameConstants.KLOX_JX_BOOM)
		{
		...
		if(next_type == GameConstants.KLOX_JX_HU_LU)
		{
		...
		if(next_type == GameConstants.KLOX_JX_SHUN_ZI
		||next_type == GameConstants.KLOX_JX_THSH)
		{
...
//			}
		...
		if(first_color == next_color)
		{
			...
			if(next_type == GameConstants.KLOX_JX_SHUN_ZI||next_type == GameConstants.KLOX_JX_DA_SHUN_ZI||next_type == GameConstants.KLOX_JX_XIAO_SHUN_ZI
			||next_type == GameConstants.KLOX_JX_TONG_HUA||next_type == GameConstants.KLOX_JX_DA_TONG_HUA||next_type == GameConstants.KLOX_JX_XIAO_TONG_HUA)
			{
				if(next_max_value == 13 && get_real_card_value(next_temp[GameConstants.OX_MAX_CARD_COUNT-1])==1)
				{
					next_max_value =  14;
