 ...
 * 
 */
package com.cai.game.pdk.handler.znpdk_cz;
...
///////////////////////////////////////////////////////////////////////////////////////////////
public class PDK_ZN_Table_CZ extends PDKTable {

	private Player[] _init_players;
	public long _init_account_id[];

	public PDK_ZN_Table_CZ() {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_ZN_CZ();
		_bomb_cell_score = 10;
		if (this.matchId != 0) {
			_bomb_cell_score = 4;
		}
	...
	private void test_cards() {
		int cards[] = new int[] { 0x03, 0x13, 0x33, 0x04, 0x14, 0x24, 0x34, 0x05, 0x15, 0x25, 0x06, 0x16, 0x26, 0x26,
				0x07, 0x0a };
