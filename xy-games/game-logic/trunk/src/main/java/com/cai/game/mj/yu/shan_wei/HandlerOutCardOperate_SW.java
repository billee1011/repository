...
public class HandlerOutCardOperate_SW extends MJHandlerOutCardOperate<Table_SW> {
    ...
    public boolean handler_operate_card(Table_SW table, int seat_index, int operate_code, int operate_card) {
        ...
        if (operate_code == GameConstants.WIK_CHI_HU && table.has_rule(GameConstants_SW.GAME_RULE_DUO_PAO)) {
        ...
        for (int i = 0; i < table.getTablePlayerNumber() && table.has_rule(GameConstants_SW.GAME_RULE_DUO_PAO); i++) {
        ...
        case GameConstants.WIK_CHI_HU: {
            ...
            if (jie_pao_count > 0) {
                ...
                if (table.has_rule(GameConstants_SW.GAME_RULE_PAO_HU_JIANG_MA))
                ...
                for (int i = 0; i < GameConstants.GAME_PLAYER; i++) {
                    ...
                    if (!table.has_rule(GameConstants_SW.GAME_RULE_DUO_PAO))
