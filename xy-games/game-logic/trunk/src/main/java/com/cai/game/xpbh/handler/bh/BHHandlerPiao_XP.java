...
public class BHHandlerPiao_XP extends BHHandler {
	
	private static Logger logger = Logger.getLogger(BHHandlerPiao_XP.class);
	...
	public boolean handler_pao_qiang(XPBHTable table, int seat_index, int pao, int qiang) {
...
//				GameConstants.INVALID_SEAT);
	...
	private void player_reconnect(XPBHTable table, int seat_index) {
