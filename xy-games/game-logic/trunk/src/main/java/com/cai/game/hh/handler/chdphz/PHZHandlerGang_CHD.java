package com.cai.game.hh.handler.chdphz;
...
public class PHZHandlerGang_CHD extends HHHandlerGang<HHTable> {
		...
		if((_depatch == true)&&(table._ti_two_long[_seat_index] == false)&&(table._is_xiang_gong[_seat_index] == false)){
	        ...
	        if(pai_count == 0)
	        {
	        	...
	        	if(all_hu_xi>=15)
	        	{
					...
					{  
						table._tuan_yuan_count[_seat_index] =table._logic.calculate_tuan_yuan_count(table._hu_weave_items[_seat_index],table._hu_weave_count[_seat_index]);
