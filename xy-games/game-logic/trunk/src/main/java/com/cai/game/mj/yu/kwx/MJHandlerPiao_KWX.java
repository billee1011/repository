...
public class MJHandlerPiao_KWX extends AbstractMJHandler<Table_KWX> {
	...
	public boolean handler_pao_qiang(Table_KWX table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_KWX table, int seat_index) {
