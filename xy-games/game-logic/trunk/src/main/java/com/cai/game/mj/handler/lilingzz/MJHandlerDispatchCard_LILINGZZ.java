 ...
 *
 */
public class MJHandlerDispatchCard_LILINGZZ extends MJHandlerDispatchCard<MJTable_LILINGZZ> {
	...
	@Override
	public boolean handler_player_be_in_room(MJTable_LILINGZZ table, int seat_index) {
