...
public class WHZHandlerDispatchFirstCard_YY extends PHZHandlerDispatchCard<YYWHZTable> {
	...
	public void exe(YYWHZTable table) {
		...
		// 发送数据
		// 只有自己才有数值
		table.operate_player_get_card(_seat_index, 1, new int[] { _send_card_data }, _seat_index, true);
		// 设置变量
