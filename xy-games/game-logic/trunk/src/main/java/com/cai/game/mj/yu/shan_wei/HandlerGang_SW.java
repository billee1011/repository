...
public class HandlerGang_SW extends MJHandlerGang<Table_SW> {
	...
	@Override
	public boolean exe_gang(Table_SW table) {
		...
		if (GameConstants.GANG_TYPE_AN_GANG == _type) {
			...
			int score = GameConstants.CELL_SCORE + 2;
