...
public class PHZHandlerChiPeng_HanShou extends HHHandlerChiPeng<HanShouHHTable> {

	private GangCardResult m_gangCardResult;

	public PHZHandlerChiPeng_HanShou() {
	 ...
	 */
	@Override
	public boolean handler_operate_card(HanShouHHTable table, int seat_index, int operate_code, int operate_card, int lou_pai) {
