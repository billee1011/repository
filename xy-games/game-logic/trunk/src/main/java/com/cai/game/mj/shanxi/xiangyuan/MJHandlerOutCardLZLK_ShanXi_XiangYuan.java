 ...
 *
 */
public class MJHandlerOutCardLZLK_ShanXi_XiangYuan extends AbstractMJHandler<MJTable_ShanXi_XiangYuan> {
	...
	public void exe(MJTable_ShanXi_XiangYuan table) {
		...
		table._playerStatus[_out_card_player].set_card_status(GameConstants.CARD_STATUS_LI_ZHUANG_LI_KOU);
		...
		if (ting_count > 0 && table._playerStatus[_out_card_player].is_lzlk()) {
