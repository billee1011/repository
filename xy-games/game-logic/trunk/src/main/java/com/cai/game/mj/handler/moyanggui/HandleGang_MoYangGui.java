...
public class HandleGang_MoYangGui extends AbstractMJHandler<MjTableMoYangGui> {
	...
	@Override
	public void exe(MjTableMoYangGui table) {
	...
	protected boolean exe_gang(MjTableMoYangGui table) {
		...
		float lGangScore[] = new float[table.getTablePlayerNumber()];
		...
		if (GameConstants.GANG_TYPE_AN_GANG == _type) {
			for (int i = 0; i < table.getTablePlayerNumber(); i++) {
				...
				lGangScore[i] -= GameConstants.CELL_SCORE * 2; 
				lGangScore[_seat_index] += GameConstants.CELL_SCORE * 2;
				//table.altlGangScore[i] -= GameConstants.CELL_SCORE * 2; 
				//table.altlGangScore[_seat_index] += GameConstants.CELL_SCORE * 2; 
			}

			table._player_result.an_gang_count[_seat_index]++;
		} else if (GameConstants.GANG_TYPE_JIE_GANG == _type) {
			if(table.has_rule(GameConstants.GAME_RULE_YF_FOUR)){
				table.GRR._gang_score[_seat_index].scores[cbGangIndex][_seat_index] += GameConstants.CELL_SCORE * 3;
				table.GRR._gang_score[_seat_index].scores[cbGangIndex][_provide_player] -= GameConstants.CELL_SCORE * 3;
				lGangScore[_seat_index] += GameConstants.CELL_SCORE * 3; 
				lGangScore[_provide_player] -= GameConstants.CELL_SCORE * 3;
				//table.altlGangScore[_seat_index] += GameConstants.CELL_SCORE * 3;
				//table.altlGangScore[_provide_player] -= GameConstants.CELL_SCORE * 3;
			}else if(table.has_rule(GameConstants.GAME_RULE_YF_THREE)){
				table.GRR._gang_score[_seat_index].scores[cbGangIndex][_seat_index] += GameConstants.CELL_SCORE * 2;
				table.GRR._gang_score[_seat_index].scores[cbGangIndex][_provide_player] -= GameConstants.CELL_SCORE * 2;
				lGangScore[_seat_index] += GameConstants.CELL_SCORE * 2; 
				lGangScore[_provide_player] -= GameConstants.CELL_SCORE * 2;
				//table.altlGangScore[_seat_index] += GameConstants.CELL_SCORE * 2;
				//table.altlGangScore[_provide_player] -= GameConstants.CELL_SCORE * 2;
			}else if(table.has_rule(GameConstants.GAME_RULE_YF_TWO)){
				...
				lGangScore[_seat_index] += GameConstants.CELL_SCORE; 
				lGangScore[_provide_player] -= GameConstants.CELL_SCORE;
				//table.altlGangScore[_seat_index] += GameConstants.CELL_SCORE ;
				//table.altlGangScore[_provide_player] -= GameConstants.CELL_SCORE ;
			}
			...
			for (int i = 0; i < table.getTablePlayerNumber(); i++) {
				...
				table.GRR._gang_score[_seat_index].scores[cbGangIndex][_seat_index] += GameConstants.CELL_SCORE;
				lGangScore[i] -= GameConstants.CELL_SCORE; 
				lGangScore[_seat_index] += GameConstants.CELL_SCORE;
				//table.altlGangScore[i] -= GameConstants.CELL_SCORE ; 
				//table.altlGangScore[_seat_index] += GameConstants.CELL_SCORE;
			}
		...
		//刷新玩家数据
		table.SendRealScoreToPlayer(lGangScore);
	...
	@Override
	public boolean handler_operate_card(MjTableMoYangGui table, int seat_index, int operate_code, int operate_card) {
	...
	@Override
	public boolean handler_player_be_in_room(MjTableMoYangGui table, int seat_index) {
