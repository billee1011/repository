...
public class HandlerChiPeng extends HHHandlerChiPeng<HongErShiTable_HY> {
	...
	@Override
	public boolean handler_operate_card(HongErShiTable_HY table, int seat_index, int operate_code, int operate_card, int lou_pai) {
