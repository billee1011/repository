...
public class MJHandlerChiPeng_KFZZ extends MJHandlerChiPeng<MJTable_KFZZ> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_KFZZ() {
	...
	@Override
	public boolean handler_player_out_card(MJTable_KFZZ table, int seat_index, int card) {
