...
public class MJHandlerYaoHaiDi_YYTDH extends MJHandlerYaoHaiDi<MJTable_YYTDH> {

    private static Logger logger = Logger.getLogger(MJHandlerYaoHaiDi_YYTDH.class);
    ...
    public void exe(MJTable_YYTDH table) {
        ...
        for (int i = 0; i < table.getTablePlayerNumber(); i++) {
            ...
            action = table.analyse_chi_hu_card(table.GRR._cards_index[i], table.GRR._weave_items[i],
                    table.GRR._weave_count[i], _send_card_data, chr, GameConstants.HU_CARD_TYPE_PAOHU, i, false);
    ...
    public boolean handler_operate_card(MJTable_YYTDH table, int seat_index, int operate_code, int operate_card) {
        ...
        // 变量定义
        int target_card = _send_card_data;
        ...
        case GameConstants.WIK_ZI_MO: // 自摸
        {
            ...
            // 下局胡牌的是庄家
            table.set_niao_card_yytdh(table.GRR._banker_player, _send_card_data, false, 0, false);// 结束后设置鸟牌
            // 吃牌权位
            ...
            // 要删除手上的牌,因为这张海底并没有入手
            table.process_chi_hu_player_operate_yytdh(_seat_index, new int[] { _send_card_data }, 1, false);
        ...
        case GameConstants.WIK_CHI_HU: // 胡
        {
            ...
            if (jie_pao_count > 1) {
                table._cur_banker = _seat_index;
                table.set_niao_card_yytdh(table.GRR._banker_player, _send_card_data, false, 0, true);
            } else {
                table._cur_banker = target_player;
                table.set_niao_card_yytdh(table.GRR._banker_player, _send_card_data, false, 0, false);
            }
            ...
            for (int i = 0; i < table.getTablePlayerNumber(); i++) {
                ...
                // {
                table.process_chi_hu_player_operate_yytdh(i, new int[] { _send_card_data }, 1, false);
