...
public class MJHandlerChiPeng_HeNan_smx extends MJHandlerChiPeng<MJTable_SMX> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_HeNan_smx() {
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_SMX table, int seat_index, int card) {
