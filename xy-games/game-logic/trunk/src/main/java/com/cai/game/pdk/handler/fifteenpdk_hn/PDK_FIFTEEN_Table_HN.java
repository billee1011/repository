 ...
 * 
 */
package com.cai.game.pdk.handler.fifteenpdk_hn;
...
public class PDK_FIFTEEN_Table_HN extends PDKTable {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_FIFTEEN_HN();
