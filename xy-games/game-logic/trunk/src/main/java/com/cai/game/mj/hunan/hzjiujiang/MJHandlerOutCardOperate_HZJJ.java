...
public class MJHandlerOutCardOperate_HZJJ extends MJHandlerOutCardOperate<MJTable_HZJJ> {
    ...
    public void exe(MJTable_HZJJ table) {
        ...
        if(!table._logic.is_magic_card(_out_card_data)){
        	bAroseAction = table.estimate_player_out_card_respond_hz(_out_card_player, _out_card_data);// ,
        }
            ...
            for (int i = 0; i < table.getTablePlayerNumber(); i++) {
                ...
                if (playerStatus.has_action()) {
                	...
                	if (playerStatus.has_chi_hu()) {
                        if (table.has_rule(GameConstants_HZJJ.GAME_RULE_QIANG_ZHI_HU)) {
                            // 见炮胡
...
//        }
        ...
        case GameConstants.WIK_CHI_HU: // 胡
        {
            ...
            if (jie_pao_count > 0) {
                ...
                if (jie_pao_count > 1) {
                    ...
                    table.set_niao_card_hz(_out_card_player, GameConstants.INVALID_VALUE, true, add_niao, target_card,true);
                    // 结束
                	...
                	add_niao = table.getAddNiao(target_player);
                    // 结束后设置鸟牌
                    table.set_niao_card_hz(target_player, GameConstants.INVALID_VALUE, true, add_niao, target_card,false);
    ...
    @Override
    public boolean handler_be_set_trustee(MJTable_HZJJ table, int seat_index) {
