package com.cai.game.wsk.handler.pingxiang.six;
...
public class WSKHandlerOutCardOperate_PXGT_SIX extends WSKHandlerOutCardOperate<WSKTable_PXGT_SIX> {

	@Override
	public void exe(WSKTable_PXGT_SIX table) {
	...
	public void user_pass_card(WSKTable_PXGT_SIX table) {
	...
	public int adjust_out_card_right(WSKTable_PXGT_SIX table) {
	...
	@Override
	public boolean handler_player_be_in_room(WSKTable_PXGT_SIX table, int seat_index) {
