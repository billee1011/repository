...
public class HandlerGang_XinYang extends MJHandlerGang<Table_XinYang> {
	...
	@Override
	public boolean exe_gang(Table_XinYang table) {
		//删除禁锢的牌
		if(_center_card == table._player_result.pao[_seat_index])
			table._player_result.pao[_seat_index] = 0;
		if(_center_card == table._player_result.qiang[_seat_index])
		...
		} else if (GameConstants.GANG_TYPE_JIE_GANG == _type || GameConstants.GANG_TYPE_ADD_GANG == _type) {
