...
public class MJHandlerPao_SanMenXia extends AbstractMJHandler<MJTable_SanMenXia> {
	...
	public boolean handler_pao_qiang(MJTable_SanMenXia table, int seat_index, int pao, int qiang) {
		...
		table.show_tou_zi(table.GRR._banker_player);
	...
	private void player_reconnect(MJTable_SanMenXia table, int seat_index) {
