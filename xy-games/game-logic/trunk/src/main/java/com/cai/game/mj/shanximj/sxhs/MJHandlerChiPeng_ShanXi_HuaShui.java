...
public class MJHandlerChiPeng_ShanXi_HuaShui extends MJHandlerChiPeng<MJTable_ShanXi_HuaShui> {
	...
	public MJHandlerChiPeng_ShanXi_HuaShui() {
		_type = 0;
	...
	@Override
	public boolean handler_player_out_card(MJTable_ShanXi_HuaShui table, int seat_index, int card) {
