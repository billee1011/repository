...
public class HandlerDispatchCard_KWX extends MJHandlerDispatchCard<Table_KWX_2D> {
	...
	public boolean handler_operate_card(Table_KWX_2D table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants_KWX.WIK_ZI_MO: {
			...
			GameSchedule.put(new GameFinishRunnable(table.getRoom_id(), _seat_index, GameConstants_KWX.Game_End_NORMAL), 500, TimeUnit.MILLISECONDS);
