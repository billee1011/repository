...
public class MJHandlerChiPeng_NanChang extends MJHandlerChiPeng<MJTable_NanChang> {
	...
	public MJHandlerChiPeng_NanChang() {
	...
	public void exe(MJTable_NanChang table) {
		...
		if (ting_count > 0) {
			...
			int tmp_hand_card_count = table._logic.switch_to_cards_data(table.GRR._cards_index[_seat_index], tmp_cards,table.getJingData(_seat_index));
			table.changeCard(tmp_cards, table.GRR._card_count[_seat_index],_seat_index);
