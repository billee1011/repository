...
public class SCHCPHandlerDispatchAddCard_DSS extends SCHCPDSSHandlerDispatchCard<SCHCPDSSTable> {
...
//		table.exe_chuli_first_card(_seat_index,GameConstants.WIK_NULL,0);
	 ...
	 */
	@Override
	public boolean handler_player_out_card(SCHCPDSSTable table, int seat_index, int card) {
		// 错误断言
