...
public class MJHandlerDispatchCard_HeNanzmd extends MJHandlerDispatchCard<MJTable> {
	...
	public void exe(MJTable table) {
		...
		int action = table.analyse_chi_hu_card_henan(table.GRR._cards_index[_seat_index], table.GRR._weave_items[_seat_index],
