...
@IRootAi(gameIds = { GameConstants.GAME_TYPE_PDK_JD_LD }, desc = "经典跑得快", msgIds = {
		MsgConstants.RESPONSE_PDK_GAME_START, MsgConstants.RESPONSE_PDK_OUT_CARD })
public class PdkGameOutCardAi_JD extends AbstractAi<PDKTable> {

	public PDKGameLogicAI_JD _logic = new PDKGameLogicAI_JD();

	public PdkGameOutCardAi_JD() {
	}
