...
public class HandlerPiao_LX_CS_QY extends AbstractMJHandler<Table_LX_CS_QY> {
	@Override
	...
	public boolean handler_pao_qiang(Table_LX_CS_QY table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_LX_CS_QY table, int seat_index) {
