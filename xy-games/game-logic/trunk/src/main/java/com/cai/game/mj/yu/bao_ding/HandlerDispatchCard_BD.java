...
public class HandlerDispatchCard_BD extends MJHandlerDispatchCard<Table_BD> {
	...
	public void exe(Table_BD table) {
		...
		if (_type == GameConstants_BD.DispatchCard_Type_Tian_Hu) {
	...
	@Override
	public boolean handler_player_out_card(Table_BD table, int seat_index, int card) {
