...
public class HandlerDispatchCard_YiFeng extends MJHandlerDispatchCard<Table_YiFeng> {
	...
	public HandlerDispatchCard_YiFeng() {
	...
	public void exe(Table_YiFeng table) {
		...
		if (table.GRR._left_card_count < table.HAIDIPAI) {
			for (int i = 0; i < table.getTablePlayerNumber(); i++) {
		...
		if (table.DEBUG_CARDS_MODE) {
			...
			// table.GRR._left_card_count = 15;
		}

		ChiHuRight chr = table.GRR._chi_hu_rights[_seat_index];
		chr.set_empty();

		int card_type = Constants_HuaXian.HU_CARD_TYPE_ZI_MO;
		...
		if (table.GRR._left_card_count > 0) {
			...
			/*
			 * int cbActionMask =
			 * table._logic.analyse_gang_hong_zhong_all(table.GRR._cards_index[
