 ...
 *
 */
public class MJHandlerDispatchCard_ZHUZHOUZZ extends MJHandlerDispatchCard<MJTable_ZHUZHOUZZ> {
	...
	@Override
	public boolean handler_player_be_in_room(MJTable_ZHUZHOUZZ table, int seat_index) {
