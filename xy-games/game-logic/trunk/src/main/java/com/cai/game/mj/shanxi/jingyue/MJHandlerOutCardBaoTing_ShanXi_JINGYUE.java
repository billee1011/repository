...
public class MJHandlerOutCardBaoTing_ShanXi_JINGYUE extends AbstractMJHandler<MJTable_ShanXi_JINGYUE> {
    ...
    public void exe(MJTable_ShanXi_JINGYUE table) {
		...
		int _hide_out_card_data=_out_card_data+GameConstants_SXJY.CARD_ESPECIAL_TYPE_HIDE;
		...
		table.exe_add_discard(_out_card_player, 1, new int[] { _out_card_data+GameConstants_SXJY.CARD_ESPECIAL_TYPE_HIDE }, false, GameConstants.DELAY_SEND_CARD_DELAY);
...
//        int real_card = _out_card_data+GameConstants_SXJY.CARD_ESPECIAL_TYPE_HIDE;
//        table.operate_out_card(_out_card_player, 1, new int[] { real_card }, GameConstants.OUT_CARD_TYPE_XIA_ZI,
//                seat_index);
