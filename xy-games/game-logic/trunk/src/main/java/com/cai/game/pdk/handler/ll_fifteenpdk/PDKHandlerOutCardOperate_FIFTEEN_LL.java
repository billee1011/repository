...
public class PDKHandlerOutCardOperate_FIFTEEN_LL extends PDKHandlerOutCardOperate {
	@Override
	public void exe(PDKTable table) {
		...
		if (table._logic.Player_Can_out_card(table.GRR._cards_data[next_player], table.GRR._card_count[next_player],
			...
			table._auto_out_card_scheduled = GameSchedule.put(
					new PDKAutoOutCardRunnable(table.getRoom_id(), next_player, table, GameConstants.PDK_CT_PASS), 1,
					TimeUnit.SECONDS);
			return;
		} else {
