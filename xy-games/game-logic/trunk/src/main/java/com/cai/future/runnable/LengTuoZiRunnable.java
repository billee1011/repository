...
public class LengTuoZiRunnable extends BaseFuture {

	private static Logger logger = LoggerFactory.getLogger(LengTuoZiRunnable.class);

	private int _room_id;
	private int _seat_index;
	private AbstractMJTable _table;

	public LengTuoZiRunnable(int room_id, int seat_index, AbstractMJTable table) {
		super(room_id);
		_room_id = room_id;
