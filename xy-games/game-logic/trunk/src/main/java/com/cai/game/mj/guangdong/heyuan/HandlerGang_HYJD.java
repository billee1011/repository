...
public class HandlerGang_HYJD extends MJHandlerGang<Table_HYJD> {
	@Override
	...
	@Override
	protected boolean exe_gang(Table_HYJD table) {
		...
		if (GameConstants.GANG_TYPE_AN_GANG == _type) {
			...
			int score = (GameConstants.CELL_SCORE << 1) + GameConstants.CELL_SCORE;
