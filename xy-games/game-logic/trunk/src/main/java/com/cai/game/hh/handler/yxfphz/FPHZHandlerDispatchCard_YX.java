 ...
 *
 */
public class FPHZHandlerDispatchCard_YX extends HHHandlerDispatchCard<HHTable> {
	...
	public boolean handler_operate_card(HHTable table, int seat_index, int operate_code, int operate_card, int luoCode) {
		...
		case GameConstants.WIK_LEFT: // 上牌操作
		{
			...
			table.exe_chi_peng(target_player, _seat_index, target_action, target_card, GameConstants.CHI_PENG_TYPE_DISPATCH, luoCode);
			return true;
		}
