...
public class MJHandlerOutCardOperate_ShanXi_HuaShui extends MJHandlerOutCardOperate<MJTable_ShanXi_HuaShui> {
	...
	public void exe(MJTable_ShanXi_HuaShui table) {
		...
		// 跟庄处理
		if (table.has_rule(Constants_MJ_SXHS.GAME_RULE_DAI_GEN_ZHUANG) && table.isCanGenZhuang()) {
