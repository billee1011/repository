 ...
 */
public class MJHandlerDispatchCard_YYTDH extends MJHandlerDispatchCard<MJTable_YYTDH> {
            ...
            for (int i = 0; i < card_type_count; i++) {
                ...
                if (count > 0) {
                    ...
                    table._playerStatus[_seat_index]._hu_out_card_ting_count[ting_count] = table.get_ting_card(
                            ...
                            table.GRR._weave_count[_seat_index], true, _seat_index);
        ...
        if (table.GRR._left_card_count > 4) {
            ...
            if (cbActionMask != GameConstants.WIK_NULL) {// 有杠
                ...
                for (int i = 0; i < m_gangCardResult.cbCardCount; i++) {
                	if(!table.isChi(_seat_index, m_gangCardResult.cbCardData[i])){
                		continue;
                	}
                    ...
                    if (table.GRR._left_card_count > 4) {
                        if (is_ting == true) {
                            ...
                            can_gang = table.is_yytdh_ting_card(table.GRR._cards_index[_seat_index],
    ...
    public boolean handler_operate_card(MJTable_YYTDH table, int seat_index, int operate_code, int operate_card) {
        ...
        case GameConstants.WIK_ZI_MO: // 自摸
        {
            ...
            // 下局胡牌的是庄家
            table.set_niao_card_yytdh(_seat_index, GameConstants.INVALID_VALUE, true, 0, false);// 结束后设置鸟牌

            table.GRR._chi_hu_card[_seat_index][0] = operate_card;

            table._cur_banker = _seat_index;
            table.process_chi_hu_player_operate_yytdh(_seat_index, new int[] { operate_card }, 1, true);
