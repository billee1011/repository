...
public class HandlerPiao_ZhuZhouWang extends AbstractMJHandler<Table_ZhuZhouWang> {
	...
	public boolean handler_pao_qiang(Table_ZhuZhouWang table, int seat_index, int pao, int qiang) {
...
//			table.operate_tou_zi_effect(table.tou_zi_dian_shu[0], table.tou_zi_dian_shu[1], 800, 300);
	...
	private void player_reconnect(Table_ZhuZhouWang table, int seat_index) {
