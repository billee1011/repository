...
public class DDZHandlerOutCardOperate<T extends DDZTable> extends DDZHandler<T> {

	public int _out_card_player = GameConstants.INVALID_SEAT; // 出牌用户
	public int[] _out_cards_data = new int[GameConstants.DDZ_MAX_COUNT_JD]; // 出牌扑克
	public int[] _out_change_cards_data = new int[GameConstants.DDZ_MAX_COUNT_JD]; // 出牌扑克
	public int _out_card_count = 0;
	public int _b_out_card = 0;

	public int _seat_index = GameConstants.INVALID_SEAT; // 出牌用户
	public int[] _cards_data = new int[GameConstants.DDZ_MAX_COUNT_JD]; // 出牌扑克
	public int[] _change_cards_data = new int[GameConstants.DDZ_MAX_COUNT_JD]; // 出牌扑克
	public int _card_count = 0;
	public int _out_type = 0;
	...
	public void reset_status(int seat_index, int cards[], int change_cards[], int card_count, int b_out_card) {
		_out_card_player = seat_index;
		for (int i = 0; i < card_count; i++) {
			_out_cards_data[i] = cards[i];
			_out_change_cards_data[i] = change_cards[i];
		}
		_out_card_count = card_count;
		_b_out_card = b_out_card;
	}
