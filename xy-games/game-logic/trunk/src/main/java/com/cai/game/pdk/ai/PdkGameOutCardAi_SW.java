...
import com.cai.game.pdk.PDKGameLogicAI_SW;
import com.cai.game.pdk.PDKTable;

import protobuf.clazz.Protocol.RoomResponse;

@IRootAi(gameIds = { GameConstants.GAME_TYPE_PDK_SW }, desc = "十五张跑得快", msgIds = { MsgConstants.RESPONSE_PDK_GAME_START,
		MsgConstants.RESPONSE_PDK_OUT_CARD })
public class PdkGameOutCardAi_SW extends AbstractAi<PDKTable> {

	public PDKGameLogicAI_SW _logic = new PDKGameLogicAI_SW();

	public PdkGameOutCardAi_SW() {
	}
