...
public class MJHandlerPao_KFZZ extends AbstractMJHandler<MJTable_KFZZ> {
	...
	public boolean handler_pao_qiang(MJTable_KFZZ table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_KFZZ table, int seat_index) {
