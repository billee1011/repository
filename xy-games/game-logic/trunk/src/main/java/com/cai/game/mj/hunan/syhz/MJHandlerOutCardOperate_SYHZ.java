...
public class MJHandlerOutCardOperate_SYHZ extends MJHandlerOutCardOperate<MJTable_SYHZ> {
    ...
    public void exe(MJTable_SYHZ table) {
        ...
        // 玩家出牌 响应判断,是否有吃碰杠补胡
        boolean bAroseAction = table.estimate_player_out_card_respond_hz(_out_card_player, _out_card_data);// ,
