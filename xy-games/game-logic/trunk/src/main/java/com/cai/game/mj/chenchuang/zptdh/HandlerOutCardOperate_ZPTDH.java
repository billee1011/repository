...
public class HandlerOutCardOperate_ZPTDH extends MJHandlerOutCardOperate<Table_ZPTDH> {
	...
	private void handler_operate_bu_tong_pao(Table_ZPTDH table, int seat_index,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_ZPTDH.CHR_FANG_PAO);
