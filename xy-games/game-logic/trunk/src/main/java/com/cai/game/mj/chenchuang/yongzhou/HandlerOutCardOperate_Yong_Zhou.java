...
public class HandlerOutCardOperate_Yong_Zhou extends MJHandlerOutCardOperate<Table_Yong_Zhou> {
	...
	private void handler_operate_bu_tong_pao(Table_Yong_Zhou table, int seat_index,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_YONG_ZHOU.CHR_FANG_PAO);
