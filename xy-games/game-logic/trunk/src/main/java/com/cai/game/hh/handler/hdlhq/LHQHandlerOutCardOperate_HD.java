package com.cai.game.hh.handler.hdlhq;
...
public class LHQHandlerOutCardOperate_HD extends HHHandlerOutCardOperate<HHTable> {
	@Override
	...
	public boolean handler_operate_card(HHTable table, int seat_index, int operate_code, int operate_card, int luoCode) {
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table._shang_zhuang_player = target_player;
			table.process_chi_hu_player_score_lhq(target_player, this._out_card_player, operate_card, false);
			table.process_chi_hu_player_operate_lhq(target_player, operate_card, false);

			table.countChiHuTimes_lhq(target_player, this._out_card_player, false);
