...
public class GameConstants_PC extends GameConstants {
	...
	public static final int CHR_QING_YI_SE_QI_XIAO_DUI = 0x000000100; // 清一色七小对
	public static final int CHR_QING_YI_SE_QI_DA_DUI= 0x000000200; // 清一色七大对
	public static final int CHR_QING_YI_SE_HH_QI_XIAO_DUI = 0x000000400; // 清一色豪华七小对
	public static final int CHR_TIAN_HU = 0x000000800; // 天胡
	public static final int CHR_DI_HU = 0x0000001000; // 地胡
	public static final int CHR_PING_HU = 0x0000002000; // 平胡
	public static final int CHR_QING_GANG_HU = 0x0000004000; // 抢杠胡
}
