...
public class HandlerChiPeng_PING_XIANG extends MJHandlerChiPeng<Table_PING_XIANG> {
	...
	public HandlerChiPeng_PING_XIANG() {
	...
	public void exe(Table_PING_XIANG table) {
		if(_action == GameConstants.WIK_CENTER ||
				_action == GameConstants.WIK_LEFT || _action == GameConstants.WIK_RIGHT)
		table.chi_color[_seat_index] = table._logic.get_card_color(_card) + 1;
		// 把碰的牌添加到落地组合中
