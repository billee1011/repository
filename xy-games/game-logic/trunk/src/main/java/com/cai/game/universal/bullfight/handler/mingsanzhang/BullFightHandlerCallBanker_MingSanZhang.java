package com.cai.game.universal.bullfight.handler.mingsanzhang;
...
public class BullFightHandlerCallBanker_MingSanZhang extends BullFightHandlerCallBanker {
    ...
    public boolean handler_call_banker(BullFightTable table, int seat_index, int call_banker) {
        if (_game_status != GameConstants.GS_OX_CALL_BANKER) {
            table.log_error("游戏状态不对 " + _game_status + "用户叫庄:" + GameConstants.GS_OX_CALL_BANKER);
            return false;
        }
