...
public class HandlerGang_TDH extends MJHandlerGang<Table_TDH> {
	...
	@Override
	public boolean exe_gang(Table_TDH table) {
	...
	public boolean handler_operate_card(Table_TDH table, int seat_index, int operate_code, int operate_card) {
		...
		if (jie_pao_count > 0) {
			...
			for (int i = 0; i < table.getTablePlayerNumber(); i++) {
				...
				table.process_chi_hu_player_score(seat, _seat_index, operate_card, false, Table_TDH.HU_TYPE_QIANG_GANG_HU);
