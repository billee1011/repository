...
public class PHHandlerChiPeng_YX extends PHHandlerChiPeng<PHAITable> {
	...
	public void exe(PHAITable table) {
        ...
        table._logic.calculate_game_weave_score(table._game_mid_score,table._game_weave_score,score,table.getTablePlayerNumber(),false);
...
//			table.operate_player_get_card(table._last_player, 0, null, GameConstants.INVALID_SEAT,false);
	 ...
	 */
	@Override
	public boolean handler_operate_card(PHAITable table,int seat_index, int operate_code, int operate_card,int lou_pai){
