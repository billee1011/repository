...
import com.cai.game.pdk.PDKGameLogicAI_JD_LL;
import com.cai.game.pdk.PDKTable;

import protobuf.clazz.Protocol.RoomResponse;

@IRootAi(gameIds = { GameConstants.GAME_TYPE_PDK_JD_LL }, desc = "经典跑得快", msgIds = {
		MsgConstants.RESPONSE_PDK_GAME_START, MsgConstants.RESPONSE_PDK_OUT_CARD })
public class PdkGameOutCardAi_JD_LL extends AbstractAi<PDKTable> {

	public PDKGameLogicAI_JD_LL _logic = new PDKGameLogicAI_JD_LL();

	public PdkGameOutCardAi_JD_LL() {
	}
