...
///////////////////////////////////////////////////////////////////////////////////////////////
public class DDZ_JD_Table extends DDZTable {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_call_banker = new DDZHandlerCallBanker_JD();
	...
	public boolean operate_out_card(int seat_index, int count, int cards_data[], int type, int to_player) {
		...
		if (GRR._card_count[seat_index] == 0 && this.GRR._banker_player != GameConstants.INVALID_SEAT) {
			boolean bChunTian = true;
			for (int i = 0; i < this.getTablePlayerNumber(); i++) {
				if (seat_index == i) {
					continue;
