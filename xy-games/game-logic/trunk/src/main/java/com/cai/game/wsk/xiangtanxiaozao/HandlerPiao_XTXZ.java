...
public class HandlerPiao_XTXZ extends AbstractHandler_XTXZ {
	@Override
	...
	public boolean handler_pao_qiang(Table_XTXZ table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_XTXZ table, int seat_index) {
