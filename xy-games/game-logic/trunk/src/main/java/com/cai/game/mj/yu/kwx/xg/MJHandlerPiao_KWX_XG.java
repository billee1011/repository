...
public class MJHandlerPiao_KWX_XG extends AbstractMJHandler<Table_KWX_XG> {
	...
	public boolean handler_pao_qiang(Table_KWX_XG table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_KWX_XG table, int seat_index) {
