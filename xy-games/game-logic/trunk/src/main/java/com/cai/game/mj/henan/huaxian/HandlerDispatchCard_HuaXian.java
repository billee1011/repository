...
public class HandlerDispatchCard_HuaXian extends MJHandlerDispatchCard<Table_HuaXian> {
	...
	public HandlerDispatchCard_HuaXian() {
	...
	@Override
	public boolean handler_player_out_card(Table_HuaXian table, int seat_index, int card) {
