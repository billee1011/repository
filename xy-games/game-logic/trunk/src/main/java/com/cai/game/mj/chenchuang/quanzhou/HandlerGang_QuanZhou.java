...
public class HandlerGang_QuanZhou extends MJHandlerGang<Table_QuanZhou> {
	...
	@Override
	public boolean exe_gang(Table_QuanZhou table) {
		...
		WeaveItem weaves[] = new WeaveItem[Constants_MJ_QUAN_ZHOU.MAX_WEAVE];
	...
	private void handler_operate_bu_tong_pao(Table_QuanZhou table, int seat_index,
        ...
        case GameConstants.WIK_CHI_HU: {
            ...
            table.GRR._chi_hu_rights[_seat_index].opr_or(Constants_MJ_QUAN_ZHOU.CHR_BEI_QIANG_GANG);
