...
public class MJHandlerOutCardOperate_HNCZ extends MJHandlerOutCardOperate<MJTable_HNCZ> {
    ...
    public void exe(MJTable_HNCZ table) {
        ...
        // 红中麻将,检查听牌
        table._playerStatus[_out_card_player]._hu_card_count = table.get_hncz_ting_card(
    ...
    public boolean handler_player_be_in_room(MJTable_HNCZ table, int seat_index) {
        ...
        if (seat_index == _out_card_player) {
            table._logic.remove_card_by_data(hand_cards, _out_card_data);
        }
        ...
        // 摸牌
        table.operate_player_get_card(_out_card_player, 1, new int[] { real_card }, seat_index);
    ...
    @Override
    public boolean handler_be_set_trustee(MJTable_HNCZ table, int seat_index) {
