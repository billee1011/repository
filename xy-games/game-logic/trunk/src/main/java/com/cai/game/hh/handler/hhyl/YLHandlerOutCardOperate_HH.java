...
public class YLHandlerOutCardOperate_HH extends HHHandlerOutCardOperate<HHTable> {
	@Override
	public void exe(HHTable table) {
		...
		if (bAroseAction == false ) {
			...
			SysParamModel sysParamModel1111 = SysParamDict.getInstance().getSysParamModelDictionaryByGameId(gameId)
					.get(1111);
			if (sysParamModel1111 != null && sysParamModel1111.getVal1() > 0 &&
					table.getRuleValue(GameConstants.GAME_RULE_HGW_SPEED_ADD)==1&&sysParamModel1111.getVal1() < 10000) {
				discard_time = sysParamModel1111.getVal1();
			}
			else if (sysParamModel1105 != null && sysParamModel1105.getVal1() > 0 && sysParamModel1105.getVal1() < 10000) {
			...
			if (sysParamModel1111 != null && sysParamModel1111.getVal2() > 0 && 
					table.getRuleValue(GameConstants.GAME_RULE_HGW_SPEED_ADD)==1&&sysParamModel1111.getVal2() < 10000) {
...
//		}
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_yl(target_player, _out_card_player, _out_card_data, false);
