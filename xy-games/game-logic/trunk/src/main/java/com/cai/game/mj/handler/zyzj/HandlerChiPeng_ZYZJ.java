...
public class HandlerChiPeng_ZYZJ extends MJHandlerChiPeng<Table_ZYZJ> {
	...
	public void exe(Table_ZYZJ table) {
		...
		for(int i = 0; i < table.getTablePlayerNumber();i++){
			table.player_mo_first[i] = false;
		}
		
		if (table.is_ji_card(_card)) {
			if (_card == GameConstants_ZYZJ.BA_TONG_CARD || _card == GameConstants_ZYZJ.YJ_CARD) {
				table.ze_ren_ji[_provider] -= 2;
