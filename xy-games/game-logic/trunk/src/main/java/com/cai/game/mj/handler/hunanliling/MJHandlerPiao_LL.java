...
public class MJHandlerPiao_LL extends AbstractMJHandler<MJTable_LL> {
	...
	public boolean handler_pao_qiang(MJTable_LL table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_LL table, int seat_index) {
