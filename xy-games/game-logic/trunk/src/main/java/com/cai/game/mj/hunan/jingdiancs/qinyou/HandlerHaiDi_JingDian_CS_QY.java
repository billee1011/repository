...
public class HandlerHaiDi_JingDian_CS_QY extends MJHandlerHaiDi<Table_JingDian_CS_QY> {
    private static Logger logger = Logger.getLogger(HandlerHaiDi_JingDian_CS_QY.class);
    ...
    public void exe(Table_JingDian_CS_QY table) {
        ...
        if (isTing) {
        	table.operate_out_card(_seat_index, 1, new int[] { 0 }, GameConstants.OUT_CARD_TYPE_XIA_ZI, GameConstants.INVALID_SEAT);
