...
public class MJHandlerPiao_LLTH extends AbstractMJHandler<MJTable_LLTH> {
	...
	public boolean handler_pao_qiang(MJTable_LLTH table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_LLTH table, int seat_index) {
