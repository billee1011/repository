...
public class SCHCPHandlerDispatchAddCard_DSSMS extends SCHCPDSSHandlerDispatchCard<SCHCPDSSTable_MS> {
	...
	public void exe(SCHCPDSSTable_MS table) {
		...
		if(_seat_index==table._cur_banker)
			table._banker_card = _send_card_data;
...
//		table.exe_chuli_first_card(_seat_index,GameConstants.WIK_NULL,0);
	 ...
	 */
	@Override
	public boolean handler_player_out_card(SCHCPDSSTable_MS table, int seat_index, int card) {
		// 错误断言
