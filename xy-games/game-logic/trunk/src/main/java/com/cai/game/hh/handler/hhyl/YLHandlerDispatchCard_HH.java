 ...
 *
 */
public class YLHandlerDispatchCard_HH extends HHHandlerDispatchCard<HHTable> {
...
//		 }
		...
		if (_seat_index != table.GRR._banker_player) {
			if (table._is_di_hu[_seat_index] == 0)
				table._is_di_hu[_seat_index] = 1;
		}
