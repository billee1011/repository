...
public class MJHandlerOutCardOperate_HNHZ extends MJHandlerOutCardOperate<MJTable> {
    ...
    public void exe(MJTable table) {
        ...
        // 红中麻将,检查听牌
        table._playerStatus[_out_card_player]._hu_card_count = table.get_hnhz_ting_card_new(
