...
public class HandleGang_JiXian extends MJHandlerGang<Table_JiXian> {
	...
	protected boolean exe_gang(Table_JiXian table) {
	...
	public boolean handler_operate_card(Table_JiXian table, int seat_index, int operate_code, int operate_card) {
		...
		if (operate_code == UniversalConstants.WIK_CHI_HU) {
		...
		} else if (operate_code == UniversalConstants.WIK_NULL) {
