...
public class WMQHandlerOutCardOperate_AX extends WMQHandlerOutCardOperate<WMQTable> {
	@Override
	...
	public boolean handler_operate_card(WMQTable table, int seat_index, int operate_code, int operate_card,int luoCode) {
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_wmq(target_player, _out_card_player, _out_card_data, false);
