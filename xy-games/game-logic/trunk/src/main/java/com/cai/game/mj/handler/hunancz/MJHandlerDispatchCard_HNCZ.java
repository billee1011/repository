 ...
 *
 */
public class MJHandlerDispatchCard_HNCZ extends MJHandlerDispatchCard<MJTable_HNCZ> {
    ...
    public void exe(MJTable_HNCZ table) {
        ...
        if (table.GRR._left_card_count == llcard) {
            ...
            table._cur_banker = _seat_index;// 最后摸牌的是下一局的庄家
            // 流局
        ...
        int action = table.analyse_chi_hu_card(table.GRR._cards_index[_seat_index], table.GRR._weave_items[_seat_index],
                table.GRR._weave_count[_seat_index], _send_card_data, chr, GameConstants.HU_CARD_TYPE_ZIMO, 0);// 自摸
