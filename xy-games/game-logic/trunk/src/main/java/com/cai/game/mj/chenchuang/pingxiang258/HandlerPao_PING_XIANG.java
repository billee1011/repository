...
public class HandlerPao_PING_XIANG extends AbstractMJHandler<Table_PING_XIANG> {
	...
	public boolean handler_pao_qiang(Table_PING_XIANG table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_PING_XIANG table, int seat_index) {
