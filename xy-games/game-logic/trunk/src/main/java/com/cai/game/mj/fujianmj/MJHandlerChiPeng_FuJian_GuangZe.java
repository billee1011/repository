...
public class MJHandlerChiPeng_FuJian_GuangZe extends MJHandlerChiPeng<MJTable_FuJian_GuangZe> {
	...
	public MJHandlerChiPeng_FuJian_GuangZe() {
		_type = 0;
	...
	@Override
	public boolean handler_player_out_card(MJTable_FuJian_GuangZe table, int seat_index, int card) {
