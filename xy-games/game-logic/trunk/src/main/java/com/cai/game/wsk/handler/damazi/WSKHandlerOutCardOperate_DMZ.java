package com.cai.game.wsk.handler.damazi;
...
public class WSKHandlerOutCardOperate_DMZ extends WSKHandlerOutCardOperate<WSKTable_DMZ> {
	
	@Override
	public void exe(WSKTable_DMZ table) {
	...
	public void table_pai_socre(WSKTable_DMZ table){
		int pai_score=0;
...
//			return;	
	...
	public void user_pass_card(WSKTable_DMZ table){
	...
	public int adjust_out_card_right(WSKTable_DMZ table){
	...
	@Override
	public boolean handler_player_be_in_room(WSKTable_DMZ table,int seat_index) {
