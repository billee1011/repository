...
public class PHZHandlerChiPeng_LBA extends PHZHandlerChiPeng<CHDPHZTable> {
	
	private GangCardResult m_gangCardResult;
	
	public PHZHandlerChiPeng_LBA(){
	 ...
	 */
	@Override
	public boolean handler_operate_card(CHDPHZTable table,int seat_index, int operate_code, int operate_card,int lou_pai){
