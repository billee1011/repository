...
public class WSKTable_DMZ extends AbstractWSKTable {
	...
	protected void onInitTable() {
		...
		_handler_out_card_operate = new WSKHandlerOutCardOperate_DMZ();
	...
	public void deal_ming_pai_request(int seat_index) {
		...
		if (GRR == null || this.GRR._card_count[seat_index] > 20) {
