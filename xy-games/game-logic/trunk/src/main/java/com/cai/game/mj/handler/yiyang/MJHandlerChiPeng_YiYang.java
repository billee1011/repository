...
public class MJHandlerChiPeng_YiYang extends MJHandlerChiPeng<MJTable_YiYang> {
	private GangCardResult m_gangCardResult;

	public MJHandlerChiPeng_YiYang() {
	...
	public void exe(MJTable_YiYang table) {
		...
		if(table.is_mj_type(GameConstants.GAME_TYPE_MJ_YI_YANG_QIN_YOU)){
			table.change_player_status(_seat_index, 9);//亲友版碰牌后隔开一段距离
		}
		// 刷新手牌
		...
		// int cbActionMask =
		// table._logic.analyse_gang_by_card_hand_card(table.GRR._cards_index[_seat_index],
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_YiYang table, int seat_index, int card) {
