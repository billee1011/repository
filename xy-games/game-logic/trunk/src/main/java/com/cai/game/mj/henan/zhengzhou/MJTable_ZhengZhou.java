...
public class MJTable_ZhengZhou extends AbstractMJTable {
	private static final long serialVersionUID = 9171444142458092230L;

	private PerformanceTimer timer;

	public MJHandlerPao_ZhengZhou _handler_pao_henna;
	public MJHandlerQiShouHun_ZhengZhou _handler_qishou_hun;
	public MJHandlerHun_ZhengZhou _handler_hun;
	...
	protected void onInitTable() {
		_handler_dispath_card = new MJHandlerDispatchCard_ZhengZhou();
		_handler_out_card_operate = new MJHandlerOutCardOperate_ZhengZhou();
		_handler_gang = new MJHandlerGang_ZhengZhou();
		_handler_chi_peng = new MJHandlerChiPeng_ZhengZhou();

		_handler_qishou_hun = new MJHandlerQiShouHun_ZhengZhou();
		_handler_pao_henna = new MJHandlerPao_ZhengZhou();
		_handler_hun = new MJHandlerHun_ZhengZhou();
