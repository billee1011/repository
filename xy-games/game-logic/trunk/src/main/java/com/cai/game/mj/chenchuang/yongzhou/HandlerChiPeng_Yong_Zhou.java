...
public class HandlerChiPeng_Yong_Zhou extends MJHandlerChiPeng<Table_Yong_Zhou> {
	...
	public HandlerChiPeng_Yong_Zhou() {
	...
	public void exe(Table_Yong_Zhou table) {
		...
		table.change_player_status(_seat_index, 9);
		...
		if (ting_count > 0) {
			...
			table.operate_player_cards_with_ting_gzcg(_seat_index, tmp_hand_card_count, tmp_cards, weave_count, weaves);
		} else {
			// 刷新手牌
			table.operate_player_cards(_seat_index, hand_card_count, cards, weave_count, weaves);
		}
