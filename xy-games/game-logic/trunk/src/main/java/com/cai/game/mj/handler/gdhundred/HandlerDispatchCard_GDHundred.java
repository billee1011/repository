...
public class HandlerDispatchCard_GDHundred extends MJHandlerDispatchCard<Table_GDHundred> {
	...
	public HandlerDispatchCard_GDHundred() {
	...
	public void exe(Table_GDHundred table) {
		...
		// 判断是否是杠后抓牌,杠开花只算接杠
		int card_type = GameConstants_GD_HUNDRED.HU_CARD_TYPE_ZI_MO;
		if (_type == GameConstants.GANG_TYPE_JIE_GANG && table.has_rule(GameConstants_GD_HUNDRED.GAME_RULE_GANG_BAO_QUAN_BAO)) {
			card_type = GameConstants_GD_HUNDRED.HU_CARD_TYPE_GANG_KAI_HUA;
		}
		// 检查牌型，是否是七对，4鬼，听牌
	...
	@Override
	public boolean handler_player_out_card(Table_GDHundred table, int seat_index, int card) {
	...
	@Override
	public boolean handler_operate_card(Table_GDHundred table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_ZI_MO: {
			...
			if (table.has_rule(GameConstants_GD_HUNDRED.GAME_RULE_MAI_MA))
				table.set_niao_card(seat_index);
			table.process_chi_hu_player_operate(_seat_index, operate_card, true);
			table.process_chi_hu_player_score(_seat_index, HandlerGang_GDHundred._provide_player, operate_card, true);
	...
	@Override
	public boolean handler_player_be_in_room(Table_GDHundred table, int seat_index) {
