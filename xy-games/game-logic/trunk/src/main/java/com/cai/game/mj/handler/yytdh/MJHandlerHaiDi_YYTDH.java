...
public class MJHandlerHaiDi_YYTDH extends MJHandlerHaiDi<MJTable_YYTDH> {

    private static Logger logger = Logger.getLogger(MJHandlerHaiDi_YYTDH.class);
    ...
    public void exe(MJTable_YYTDH table) {
        ...
        boolean isTing = table.is_yytdh_ting_card(table.GRR._cards_index[_seat_index],
