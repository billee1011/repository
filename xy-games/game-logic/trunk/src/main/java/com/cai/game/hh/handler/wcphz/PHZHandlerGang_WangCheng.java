...
public class PHZHandlerGang_WangCheng extends HHHandlerGang<WangChengHHTable> {
	 ...
	 */
	@Override
	public boolean handler_operate_card(WangChengHHTable table, int seat_index, int operate_code, int operate_card, int luoCode) {
		// 抢杠胡
	 ...
	 ***/
	@Override
	protected boolean exe_gang(WangChengHHTable table) {
