...
public class HandlerBaoTing_LuZhouGui extends AbstractMJHandler<AbstractSiChuanMjTable> {
	private int _out_card_player = GameConstants.INVALID_SEAT;
	private int _out_card_data = GameConstants.INVALID_VALUE;
	private int _type;
	...
	public void exe(AbstractSiChuanMjTable table) {
		...
		table.analyse_state = table.FROM_BAO_JIAO;
	...
	public boolean handler_operate_card(AbstractSiChuanMjTable table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_NULL: {
			table._current_player = table.get_next_seat(_out_card_player);
