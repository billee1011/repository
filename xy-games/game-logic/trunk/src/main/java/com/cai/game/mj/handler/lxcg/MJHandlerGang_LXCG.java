...
public class MJHandlerGang_LXCG extends MJHandlerGang<MJTable> {
    ...
    public boolean handler_operate_card(MJTable table, int seat_index, int operate_code, int operate_card) {
        ...
        if (jie_pao_count > 0) {
            ...
            for (int i = 0; i < GameConstants.GAME_PLAYER; i++) {
                ...
                table.process_chi_hu_player_score_lxcg(i, _seat_index, _center_card, false);
    ...
    protected boolean exe_gang(MJTable table) {
        ...
        // 河南麻将,检查听牌
        table._playerStatus[_seat_index]._hu_card_count = table.get_lxcg_ting_card(
