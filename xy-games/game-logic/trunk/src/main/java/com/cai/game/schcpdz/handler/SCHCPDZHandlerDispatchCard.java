...
public class SCHCPDZHandlerDispatchCard<T extends SCHCPDZTable> extends SCHCPDZHandler<T> {
	...
	public SCHCPDZHandlerDispatchCard() {
	...
	public boolean handler_player_be_in_room(T table, int seat_index) {
		...
		if(table.is_mj_type(GameConstants.GAME_TYPE_CHQ_YDR))
			tableResponse.setBankerPlayer(table.GRR._banker_player);
