...
public class ShanXiTDZSendTouZiRunnable extends BaseFuture {

	private static Logger logger = LoggerFactory.getLogger(ShanXiTDZSendTouZiRunnable.class);

	private int _room_id;

	public ShanXiTDZSendTouZiRunnable(int roomId) {
		super(roomId);
