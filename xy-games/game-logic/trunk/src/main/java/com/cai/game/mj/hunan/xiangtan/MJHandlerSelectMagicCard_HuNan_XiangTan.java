...
import com.cai.future.runnable.NewRemoveMiddleCardRunnable;
...
public class MJHandlerSelectMagicCard_HuNan_XiangTan extends AbstractMJHandler<MJTable_HuNan_XiangTan> {
	...
	public void exe(MJTable_HuNan_XiangTan table) {
		...
		table.operate_show_card(_banker, GameConstants.Show_Card_Center, 1,
				new int[] { _da_dian_card + GameConstants.CARD_ESPECIAL_TYPE_DING_GUI }, GameConstants.INVALID_SEAT);
		...
		// 延迟调度打点结束
		GameSchedule.put(new NewRemoveMiddleCardRunnable(table.getRoom_id(), _banker), 3, TimeUnit.SECONDS);
	}
