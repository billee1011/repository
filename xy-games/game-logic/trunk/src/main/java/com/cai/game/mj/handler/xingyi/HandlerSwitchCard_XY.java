...
public class HandlerSwitchCard_XY extends AbstractMJHandler<Table_XY> {
	...
	public boolean handler_switch_cards(Table_XY table, int seat_index, int[] switch_cards) {
