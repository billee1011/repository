...
public class HandlerPao_XiAn extends AbstractMJHandler<Table_XiAn> {
	...
	public boolean handler_pao_qiang(Table_XiAn table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_XiAn table, int seat_index) {
