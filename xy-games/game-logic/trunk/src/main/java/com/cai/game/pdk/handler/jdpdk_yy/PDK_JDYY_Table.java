 ...
 * 
 */
package com.cai.game.pdk.handler.jdpdk_yy;
...
///////////////////////////////////////////////////////////////////////////////////////////////
public class PDK_JDYY_Table extends PDKTable {

	public PDK_JDYY_Table() {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_JDYY();
		_bomb_cell_score = 10;
		if (this.matchId != 0) {
			_bomb_cell_score = 4;
		}
	...
	private void test_cards() {
		// int cards[] = new int[] { 0x0d, 0x1d, 0x2d, 0x1c, 0x2c, 0x3c, 0x15,
		// 0x25, 0x35, 0x06, 0x16, 0x26, 0x36, 0x07,
		// 0x07, 0x07 };
