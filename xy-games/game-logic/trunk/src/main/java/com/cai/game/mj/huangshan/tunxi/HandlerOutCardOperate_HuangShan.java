...
public class HandlerOutCardOperate_HuangShan extends MJHandlerOutCardOperate<Table_HuangShan> {
	...
	public void exe(Table_HuangShan table) {
		...
		if (_out_card_data == table.joker_card_2) {
			table.piao_fei[_out_card_player]++;
		}
		...
		if (_out_card_data == table.joker_card_2) {
			table.exe_add_discard(_out_card_player, 1, new int[] { _out_card_data + GameConstants.CARD_ESPECIAL_TYPE_WANG_BA }, false, GameConstants.DELAY_SEND_CARD_DELAY);
		} else {
