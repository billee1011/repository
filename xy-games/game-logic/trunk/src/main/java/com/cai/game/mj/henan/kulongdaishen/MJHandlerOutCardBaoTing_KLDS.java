...
public class MJHandlerOutCardBaoTing_KLDS extends AbstractMJHandler<MJTable_KLDS> {
    ...
    public boolean handler_player_be_in_room(MJTable_KLDS table, int seat_index) {
        ...
        /*
         * } else { for (int i = 0; i < GameConstants.MAX_COUNT; i++) {
         * tableResponse.addCardsData(cards[i]); } }
         */
    ...
    @Override
    public boolean handler_be_set_trustee(MJTable_KLDS table, int seat_index) {
