package com.cai.game.nn.handler.tbox;
...
public class NNHandlerOpenCard_tbOX extends NNHandlerOpenCard{
	...
	public boolean handler_open_cards(NNTable table, int seat_index,boolean open_flag) {
		...
		table._card_type_ox[seat_index] = table._logic.get_card_type(table.GRR._cards_data[seat_index], GameConstants.OX_MAX_CARD_COUNT,table._game_rule_index,table._game_type_index);
