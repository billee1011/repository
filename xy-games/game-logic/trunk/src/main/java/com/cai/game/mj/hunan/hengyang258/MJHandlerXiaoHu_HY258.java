...
public class MJHandlerXiaoHu_HY258 extends AbstractMJHandler<MJTable_HY258> {
    private static Logger logger = Logger.getLogger(MJHandlerXiaoHu_HY258.class);
    ...
    private void show_shai_zi(MJTable_HY258 table, int seat_index) {
    ...
    private void show_xiao_hu(MJTable_HY258 table, int seat_index) {
        ChiHuRight start_hu_right = table.GRR._start_hu_right[seat_index];
