...
public class PHZHandlerOutCardOperate_CHD extends PHZHandlerOutCardOperate<CHDPHZTable> {
	@Override
...
//			table._is_di_hu = false;
		...
		case GameConstants.WIK_CHI_HU: // 胡
		{
			...
			table.process_chi_hu_player_score_phz_chd(target_player, _out_card_player, _out_card_data, false);
