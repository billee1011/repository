...
public class SCHCPHandlerDispatchFirstCard_DSSMS extends SCHCPDSSHandlerDispatchCard<SCHCPDSSTable_MS> {
...
//					% table.getTablePlayerNumber();
	 ...
	 */
	@Override
	public boolean handler_operate_card(SCHCPDSSTable_MS table, int seat_index, int operate_code, int operate_card,
			int luoCode) {
