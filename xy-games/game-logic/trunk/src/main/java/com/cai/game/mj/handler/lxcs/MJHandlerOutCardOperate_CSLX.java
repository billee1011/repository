...
public class MJHandlerOutCardOperate_CSLX extends MJHandlerOutCardOperate<MJTable> {
    ...
    public void exe(MJTable table) {
        ...
        // 红中麻将,检查听牌
        table._playerStatus[_out_card_player]._hu_card_count = table.get_lxcs_ting_card(
    ...
    public boolean handler_player_be_in_room(MJTable table, int seat_index) {
        ...
        /*
         * // 把出的牌加入到废弃牌堆 table.exe_add_discard(_out_card_player, 1, new int[] {
         * _out_card_data }, false, GameConstants.DELAY_SEND_CARD_DELAY); // 出牌
         * table.operate_out_card(_out_card_player, 1, new int[] { _out_card_data },
