...
public class HandlerPiao_JingDian_CS extends AbstractMJHandler<Table_JingDian_CS> {
	@Override
	...
	public boolean handler_pao_qiang(Table_JingDian_CS table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(Table_JingDian_CS table, int seat_index) {
