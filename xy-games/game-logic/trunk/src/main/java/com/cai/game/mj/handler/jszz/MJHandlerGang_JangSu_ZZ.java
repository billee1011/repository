...
public class MJHandlerGang_JangSu_ZZ extends MJHandlerGang<MJTable_JangSu_ZZ> {
    @Override
    ...
    public boolean handler_operate_card(MJTable_JangSu_ZZ table, int seat_index, int operate_code, int operate_card) {
        ...
        if (table.has_rule(GameConstants.GAME_RULE_JIANGSU_PEI_CHONG)) {
            ...
            table.process_chi_hu_player_score_jszz(target_player, _seat_index, operate_card, false, false,
                    false, false);
        } else {
            int hu_count = 0;
            for (int i = 0; i < table.getTablePlayerNumber(); i++) {
            ...
            for (int i = 0; i < table.getTablePlayerNumber(); i++) {
                ...
                if (!(table.GRR._chi_hu_rights[i].opr_and(GameConstants.CHR_ZI_MO)).is_empty()){
                	int a=0;
                }
                if (hu_count == 3) {
                    table.process_chi_hu_player_score_jszz(i, _seat_index, operate_card, false, true, false,
                            false);
                } else {
                    if (table.bao_pei_palyer[i] == GameConstants.INVALID_SEAT) {
                        table.process_chi_hu_player_score_jszz(i, _seat_index, operate_card, false, false,
                                false, false);
                    } else {
                        table.process_chi_hu_player_score_jszz(i, table.bao_pei_palyer[i], operate_card, false,
                                false, true, false);
                    }
     ...
     ***/
    @Override
    protected boolean exe_gang(MJTable_JangSu_ZZ table) {
        ...
        if (GameConstants.GANG_TYPE_AN_GANG == _type) {
            ...
            table._peng_palyer_count[_seat_index][_provide_player]++;
            // 删掉出来的那张牌
        ...
        table._bu_gang_provide_player = _provide_player;
        ...
        if (GameConstants.GANG_TYPE_AN_GANG == _type) {
            ...
            if (table.has_rule(GameConstants.GAME_RULE_JIANGSU_PEI_CHONG)) {
                ...
                if (table.has_rule(GameConstants.GAME_RULE_JIANGSU_YUAN_ZI)) {
                    ...
                    // if(table._peng_palyer_count[_seat_index][_provide_player] >= 2){
                    // gang_cell*=2;
                    // }
