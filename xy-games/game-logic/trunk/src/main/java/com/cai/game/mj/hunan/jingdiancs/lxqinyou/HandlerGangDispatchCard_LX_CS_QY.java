...
public class HandlerGangDispatchCard_LX_CS_QY extends AbstractMJHandler<Table_LX_CS_QY> {
    private int _seat_index;

    private GangCardResult m_gangCardResult;
    private CardsData _gang_card_data;

    public HandlerGangDispatchCard_LX_CS_QY() {
            ...
            for (int k = 0; k < table.getTablePlayerNumber(); k++) {
                if (k == _seat_index) {
                    ...
                    int action = table.analyse_chi_hu_card(table.GRR._cards_index[k], table.GRR._weave_items[k],
                            table.GRR._weave_count[k], bu_card, chr, Constants_LX_CS_QY.HU_CARD_TYPE_GANG_KAI, k);
    ...
    public boolean operate_player_action_gang(Table_LX_CS_QY table, int seat_index, boolean close) {
