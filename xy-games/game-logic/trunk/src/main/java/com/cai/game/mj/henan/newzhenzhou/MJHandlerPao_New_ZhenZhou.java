...
public class MJHandlerPao_New_ZhenZhou extends AbstractMJHandler<MJTable_New_ZhenZhou> {
	...
	public boolean handler_pao_qiang(MJTable_New_ZhenZhou table, int seat_index, int pao, int qiang) {
	...
	private void player_reconnect(MJTable_New_ZhenZhou table, int seat_index) {
