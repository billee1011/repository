...
public class MJHandlerDispatchCard_SYHZ extends MJHandlerDispatchCard<MJTable_SYHZ> {
     ...
     */
    @Override
    public boolean handler_operate_card(MJTable_SYHZ table, int seat_index, int operate_code, int operate_card) {
    ...
    @Override
    public boolean handler_be_set_trustee(MJTable_SYHZ table, int seat_index) {
        handler_check_auto_behaviour(table, seat_index, _send_card_data);
        return false;
    }
}
