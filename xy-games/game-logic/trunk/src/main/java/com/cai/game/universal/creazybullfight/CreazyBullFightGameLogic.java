...
public class CreazyBullFightGameLogic {
    ...
    public int get_card_type(int card_data[], int card_count, int game_rule_index) {
        ...
        if ((same_color == true) && (line_card == true))
            return GameConstants.FKN_TONGHUASHUN;
        ...
        if (king_count == GameConstants.OX_MAX_CARD_COUNT)
            return GameConstants.FKN_WUHUANIU;
        ...
        if ((same_color == true) && (line_card == false))
            return GameConstants.FKN_TONGHUA;

        if ((same_color == false) && (line_card == true))
            return GameConstants.FKN_SHUNZI;
    ...
    public int get_times_two(int card_data[], int card_count, int game_rule_index) {
        ...
        if (times <= 1)
            ...
            times = 10;
        else if (times == GameConstants.FKN_SHUNZI)
            times = 15;
        else if (times == GameConstants.FKN_TONGHUA)
            times = 16;
        else if (times == GameConstants.FKN_HULU)
            times = 17;
        else if (times == GameConstants.FKN_WUXIAONIU)
            times = 18;
        else if (times == GameConstants.FKN_WUHUANIU)
            times = 19;
        else if (times == GameConstants.FKN_BOOM)
            times = 20;
        else if (times == GameConstants.FKN_TONGHUASHUN)
            times = 25;
        return times;
    }
