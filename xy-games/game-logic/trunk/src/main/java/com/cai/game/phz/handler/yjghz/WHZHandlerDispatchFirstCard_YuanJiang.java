...
public class WHZHandlerDispatchFirstCard_YuanJiang extends PHZHandlerDispatchCard<YuanJiangGHZTable> {
	...
	public void exe(YuanJiangGHZTable table) {
		...
		table.exe_chuli_first_card(_seat_index, GameConstants.WIK_NULL, 100);
		_send_card_data = 0;
