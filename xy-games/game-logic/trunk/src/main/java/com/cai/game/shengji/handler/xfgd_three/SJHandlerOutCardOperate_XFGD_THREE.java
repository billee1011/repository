...
public class SJHandlerOutCardOperate_XFGD_THREE extends SJHandlerOutCardOperate<SJTable_XFGD_Three> {

	@Override
	public void exe(SJTable_XFGD_Three table) {
	...
	public int adjust_out_card_right(SJTable_XFGD_Three table) {
	...
	@Override
	public boolean handler_player_be_in_room(SJTable_XFGD_Three table, int seat_index) {
