...
public class HandlerOutCardOperate_CZ_SR extends HHHandlerOutCardOperate<Table_CZ_SR> {
	...
	public boolean handler_operate_card(Table_CZ_SR table, int seat_index, int operate_code, int operate_card,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			if (table.GRR._left_card_count == 19) {
				table.GRR._chi_hu_rights[target_player].opr_or(Constants_CZ_SR.CHR_DI_HU);
			}
