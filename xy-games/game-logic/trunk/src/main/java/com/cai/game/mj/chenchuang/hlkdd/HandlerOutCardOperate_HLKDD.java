...
public class HandlerOutCardOperate_HLKDD extends MJHandlerOutCardOperate<Table_HLKDD> {
	...
	public void exe(Table_HLKDD table) {
		...
		if(_type == Constants_MJ_HLKDD.HU_CARD_TYPE_BAO_TING)
			data = Constants_MJ_HLKDD.CARD_ESPECIAL_TYPE_HIDE;
		table.operate_out_card(_out_card_player, 1, new int[] { data }, GameConstants.OUT_CARD_TYPE_MID,
				GameConstants.INVALID_SEAT);
		//得到打出那些牌听牌
		table.exe_ting_card(_out_card_player);
	...
	private void handler_operate_bu_tong_pao(Table_HLKDD table, int seat_index,
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.GRR._chi_hu_rights[_out_card_player].opr_or(Constants_MJ_HLKDD.CHR_FANG_PAO);
