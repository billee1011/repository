...
import com.cai.game.zhadan.handler.AbstractZhaDanHandler;
import com.cai.game.zhadan.handler.ZhaDanHandlerCallBanker;
import com.cai.game.zhadan.handler.ZhaDanHandlerFinish;
...
///////////////////////////////////////////////////////////////////////////////////////////////
public class AbstractZhaDanTable extends AbstractRoom {
	/**
	 * 
	 */
	protected static final long serialVersionUID = 7060061356475703643L;

	protected static Logger logger = Logger.getLogger(AbstractZhaDanTable.class);
	...
	public ZhaDanGameLogic _logic = null;
	...
	public AbstractZhaDanHandler _handler;
	// public HHHandlerDispatchLastCard_YX _handler_dispath_last_card;
	public ZhaDanHandlerOutCardOperate _handler_out_card_operate;
	public ZhaDanHandlerCallBanker _handler_call_banker;
	public ZhaDanHandlerFinish _handler_finish; // 结束
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_finish = new ZhaDanHandlerFinish();
	...
	public boolean reset_init_data() {
		...
		GRR = new GameRoundRecord(this.getTablePlayerNumber(), GameConstants.MAX_WEAVE_HH, get_hand_card_count_max(),
	...
	protected void shuffle(int repertory_card[], int card_cards[]) {
		...
		for (int i = 0; i < count; i++) {
			...
			_logic.SortCardList(GRR._cards_data[i], GRR._card_count[i], this._score_type[i]);
		}
	...
	public boolean handler_operate_out_card_mul(int get_seat_index, List<Integer> list, int card_count, int b_out_card,
		...
		if (this._handler_out_card_operate != null) {
			...
			this._handler_out_card_operate.reset_status(this._out_card_player, this._turn_out_card_data,
					this._turn_out_card_count, this._turn_out_card_type);
		}
		return true;
	}
	...
	public void set_handler(AbstractZhaDanHandler _handler) {
