package com.cai.game.hh.handler.hhyl;
...
public class YLHandlerGang_HH extends HHHandlerGang<HHTable> {
...
//			}
			...
			table.process_chi_hu_player_score_yl(target_player, _seat_index, operate_card, true);
