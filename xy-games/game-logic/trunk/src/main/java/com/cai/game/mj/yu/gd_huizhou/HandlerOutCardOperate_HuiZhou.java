...
public class HandlerOutCardOperate_HuiZhou extends MJHandlerOutCardOperate<Table_HuiZhou> {
	...
	public void exe(Table_HuiZhou table) {
		...
		if (table._logic.is_magic_card(_out_card_data)) {
			table.operate_out_card(_out_card_player, 1, new int[] { _out_card_data + GameConstants.CARD_ESPECIAL_TYPE_GUI }, GameConstants.OUT_CARD_TYPE_MID, GameConstants.INVALID_SEAT);
		} else {
		...
		if (table._logic.is_magic_card(_out_card_data)) {
			table.exe_add_discard(_out_card_player, 1, new int[] { _out_card_data + GameConstants.CARD_ESPECIAL_TYPE_GUI }, false, GameConstants.DELAY_SEND_CARD_DELAY);
		} else {
	...
	public boolean handler_operate_card(Table_HuiZhou table, int seat_index, int operate_code, int operate_card) {
		...
		case GameConstants.WIK_CHI_HU: {
			...
			table.set_niao_card(target_player, GameConstants.INVALID_VALUE, true); // 抓鸟
