...
public class HandlerChiPeng_HuangZhou extends MJHandlerChiPeng<Table_HuangZhou> {
	...
	public HandlerChiPeng_HuangZhou() {
	...
	public void exe(Table_HuangZhou table) {
		...
		if (table.GRR._left_card_count > 0) {
			int cbActionMask = table._logic.analyse_gang_by_card_hand_card_hu_bei(table.GRR._cards_index[_seat_index],
					table.GRR._weave_items[_seat_index], table.GRR._weave_count[_seat_index], m_gangCardResult, table.da_dian_card);
