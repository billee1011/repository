...
public class SCHCPHandlerDispatchTouCard_DSSMS extends SCHCPDSSHandlerDispatchCard<SCHCPDSSTable_MS> {
...
//				_send_card_data = 0;
		...
		case GameConstants.DSS_WIK_TOU:
		{
			...
			table.exe_gang(target_player, _seat_index, operate_card, GameConstants.DSS_WIK_TOU,GameConstants.CHI_PENG_TYPE_ADD,true, true, false,700);
			_send_card_data = 0;
			table._send_card_data = 0;
			return true;
		}
