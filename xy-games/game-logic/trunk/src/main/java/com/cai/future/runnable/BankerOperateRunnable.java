...
public class BankerOperateRunnable extends BaseFuture {
	private static Logger logger = LoggerFactory.getLogger(BankerOperateRunnable.class);

	
	private int _room_id;
	private int _seat_index;
	public BankerOperateRunnable(int room_id){
		super(room_id);
		_room_id = room_id;
	}
