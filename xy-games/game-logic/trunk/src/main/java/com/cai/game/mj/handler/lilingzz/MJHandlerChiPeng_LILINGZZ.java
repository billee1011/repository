...
public class MJHandlerChiPeng_LILINGZZ extends MJHandlerChiPeng<MJTable_LILINGZZ> {
	 ...
	 */
	@Override
	public boolean handler_player_out_card(MJTable_LILINGZZ table, int seat_index, int card) {
