...
import com.cai.game.shengji.handler.AbstractSJHandler;
...
import protobuf.clazz.xfgd.xfgdRsp.Card_Arrary;
import protobuf.clazz.xfgd.xfgdRsp.GameStart_Xfgd;
import protobuf.clazz.xfgd.xfgdRsp.LiShiCard_Xfgd;
import protobuf.clazz.xfgd.xfgdRsp.Qie_Pai_End;

///////////////////////////////////////////////////////////////////////////////////////////////
public class SJTable extends AbstractRoom {
	/**
	 * 
	 */
	protected static final long serialVersionUID = 7060061356475703643L;

	protected static Logger logger = Logger.getLogger(SJTable.class);

	protected static final int ID_TIMER_START_TO_SEND_CARD = 1;// 开始到发牌
	protected static final int ID_TIMER_SEND_CARD_TO_CALL_BANKER = 2;// 发牌到叫庄
	...
	public SJGameLogic _logic = null;

	public int _banker_select = GameConstants.INVALID_SEAT;
	public int _other_banker = GameConstants.INVALID_SEAT;
	...
	public AbstractSJHandler _handler;
	// public HHHandlerDispatchLastCard_YX _handler_dispath_last_card;
	public SJHandlerOutCardOperate _handler_out_card_operate;
	public SJHandlerCallBanker _handler_call_banker;
	public SJHandlerFinish _handler_finish; // 结束

	public boolean _is_call_action[];
	public int _select_dang[];
	public int _min_dang;
	public int _max_dang;
	public int _prv_call_player;
	public int _zhu_type;
	public int _di_pai[];
	public int _di_pai_count;
	public int _init_di_pai[];
	public int _get_score[];
	public int _table_score;
	public int _max_card_seat;
	public boolean _is_po_dang;
	public int _tou_xiang_agree[];
	public int _is_banker_tou_xiang;
	...
	public int _turn_out_shuai_pai_data[];
	public int _turn_out_shuai_pai_count;
	public int _origin_out_card_data[];
	public int _origin_out_card_count;
	public int _origin_out_card_type;
	public int _extra_out_card_data[];
	public int _extra_out_card_count;
	public int _history_out_card[][][];
	public int _history_out_count[][];
	public int _out_card_player;
	public int _origin_out_card_player;
	public int _out_card_times[] = new int[this.getTablePlayerNumber()];// 出牌次数
	public int _max_end_socre_limit;
	public int _get_score_card[];
	public int _get_score_count;
	public int _user_get_score_card[][];
	public int _user_get_score_count[];

	public int _pai_score_card[];
	public int _pai_score_count;
	public int _pai_score;

	public int _zhu_value = 0x1000;
	public int _fu_2_value = 0x3000;
	public int _kill_ed = GameConstants.INVALID_SEAT;
	public int _kill_ing = GameConstants.INVALID_SEAT;

	public SJTable() {

		super(RoomType.HH, 6);

		_logic = new SJGameLogic();
		_operate_time = 60;
		_start_time = 20;
		// 设置等待状态
	...
	public boolean handler_player_be_in_room(int seat_index) {
		if ((GameConstants.GS_MJ_FREE != _game_status && GameConstants.GS_MJ_WAIT != _game_status) && this.get_players()[seat_index] != null) {
			if (_handler != null) {
				if (this._game_status == GameConstants.GS_XFGD_SEND_CARD) {
					// 初始化游戏变量
					RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
	...
	public boolean handler_operate_out_card_mul(int get_seat_index, List<Integer> list, int card_count, int b_out_card, String desc) {
		if (this._game_status != GameConstants.GS_XFGD_PLAY) {
			return false;
		}
		if (this._handler_out_card_operate != null) {
			...
			this._handler_out_card_operate.reset_status(this._out_card_player, this._out_cards_data, this._out_card_count, this._turn_out_card_type);
		}
		return true;
	}
	...
	public void QiePaiEnd(int seat_index, int card_index) {
		if (this._game_status != GameConstants.GS_XFGD_SEND_CARD) {
			return;
		}
		this._game_status = GameConstants.GS_XFGD_CALL_BANKER;// 设置状态
		animationSchedule(ID_TIMER_START_TO_SEND_CARD, 1500);
		// 发送数据
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_XFGD_QIE_PAI);
		Qie_Pai_End.Builder qie_pai_end = Qie_Pai_End.newBuilder();
		qie_pai_end.setCardIndex(card_index);

		roomResponse.setCommResponse(PBUtil.toByteString(qie_pai_end));
		send_response_to_room(roomResponse);
	}
	...
	public void send_history(int seat_index) {
		// 发送数据
		RoomResponse.Builder roomResponse = RoomResponse.newBuilder();
		roomResponse.setType(MsgConstants.RESPONSE_XFGD_LI_SHI_CARD);
		LiShiCard_Xfgd.Builder history_card = LiShiCard_Xfgd.newBuilder();
		for (int i = 0; i < this.getTablePlayerNumber(); i++) {
			Card_Arrary.Builder card_array = Card_Arrary.newBuilder();
			for (int j = 0; j < 2; j++) {
