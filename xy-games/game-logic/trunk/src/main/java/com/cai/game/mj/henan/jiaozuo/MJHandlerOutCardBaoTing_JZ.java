 ...
 *
 */
public class MJHandlerOutCardBaoTing_JZ extends AbstractMJHandler<MJTable_JZ> {
	...
	public void exe(MJTable_JZ table) {
		...
		table.ting_count[_out_card_player] = table.get_ting_card(table._playerStatus[_out_card_player]._hu_cards, table.GRR._cards_index[_out_card_player],
