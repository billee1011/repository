...
public class MJHandlerQiShouHongZhong_TT extends AbstractMJHandler<MJTable_TT> {
    ...
    public boolean handler_operate_card(MJTable_TT table, int seat_index, int operate_code, int operate_card) {
        ...
        table.set_niao_card_hz(_seat_index, GameConstants.INVALID_VALUE, true, add_niao, 0x35); // 结束后设置鸟牌
