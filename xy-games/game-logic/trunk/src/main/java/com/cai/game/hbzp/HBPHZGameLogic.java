...
public class HBPHZGameLogic {

	private static Logger logger = Logger.getLogger(HBPHZGameLogic.class);
	...
	public int get_action_chi_card(int cards_index[], int cur_card, ChiCardInfo chi_card_info[]) {
		...
		if ((cards_index[cur_index] >= 1) && (cards_index[reverse_index] >= 1) && (cards_index[reverse_index] < 3)) {
			...
			if (temp_card_index[cur_index] == 0) {
				...
				chi_card_info[chi_card_count++].cbChiKind = (get_card_color(cur_card) == 0x00) ? GameConstants.WIK_HBZP_XXD
						: GameConstants.WIK_HBZP_DDX;
			}
		}
		...
		if (cards_index[reverse_index] == 2) {
			...
			if (temp_card_index[cur_index] == 0) {
				...
				chi_card_info[chi_card_count].cbCardData[0][2] = switch_to_card_data(reverse_index);
				chi_card_info[chi_card_count++].cbChiKind = (get_card_color(cur_card) == 0x00) ? GameConstants.WIK_HBZP_DDX
						: GameConstants.WIK_HBZP_XXD;
			}
		}
		...
		if ((card_value == 0x02) || (card_value == 0x07) || (card_value == 0x0A)) {
			...
			if (i == excursion.length) {
				...
				while (temp_card_index[cur_index] > 0) {
					int result[] = chi_card_info[chi_card_count].cbCardData[cbResultCount];
					if (take_out_chi_card(temp_card_index, cur_card, result) != GameConstants.WIK_HBZP_EQS)
						cbResultCount++;
					else
						break;
				}
				...
				// 设置结果
				if (temp_card_index[cur_index] == 0) {
					chi_card_info[chi_card_count].cbChiKind = GameConstants.WIK_HBZP_EQS;
					chi_card_info[chi_card_count].cbCenterCard = cur_card;
					chi_card_info[chi_card_count].cbResultCount = cbResultCount;
		...
		for (int i = 0; i < excursion.length; i++) {
			...
			if ((value_index >= excursion[i]) && ((value_index - excursion[i]) <= 7)) {
				...
				if (j == excursion.length) {
					...
					// 设置结果
					if (temp_card_index[cur_index] == 0) {
						int cbChiKind[] = { GameConstants.WIK_HBZP_LEFT, GameConstants.WIK_HBZP_CENTER, GameConstants.WIK_HBZP_RIGHT };
	...
	public int take_out_chi_card(int cards_index[], int cur_card, int result_card[]) {
		...
		if ((cards_index[cur_index] >= 2) && (cards_index[reverse_index] >= 1) && (cards_index[reverse_index] < 3)) {
			...
			return (get_card_color(cur_card) == 0x00) ? GameConstants.WIK_HBZP_XXD : GameConstants.WIK_HBZP_DDX;
		}
		...
		if (cards_index[reverse_index] == 2) {
			...
			return (get_card_color(cur_card) == 0x00) ? GameConstants.WIK_HBZP_DDX : GameConstants.WIK_HBZP_XXD;
		}
		...
		if ((card_value == 0x02) || (card_value == 0x07) || (card_value == 0x0A)) {
			...
			if (i == excursion.length) {
				...
				return GameConstants.WIK_HBZP_EQS;
			}
		}
		...
		for (int i = 0; i < excursion.length; i++) {
			...
			if ((cbValueIndex >= excursion[i]) && ((cbValueIndex - excursion[i]) <= 7)) {
				...
				int chi_kind[] = { GameConstants.WIK_HBZP_LEFT, GameConstants.WIK_HBZP_CENTER, GameConstants.WIK_HBZP_RIGHT };
				return chi_kind[i];
			}
		}
	...
	public int check_chi_phz(int cards_index[], int cur_card, int type_count[], int type_eat_count[], boolean yws_type) {
		...
		if ((cards_index[cur_card_index] >= 1) && (cards_index[reverse_index] >= 1) && (cards_index[reverse_index] < 3)) {
			...
			int action = (get_card_color(cur_card) == 0x00) ? GameConstants.WIK_HBZP_XXD : GameConstants.WIK_HBZP_DDX;
			eat_type |= action;
		...
		if (cards_index[reverse_index] == 2) {
			...
			int action = (get_card_color(cur_card) == 0x00) ? GameConstants.WIK_HBZP_DDX : GameConstants.WIK_HBZP_XXD;
			eat_type |= action;
			type_count[count++] = action;
		}
		// 二七十吃
		...
		if ((card_value == 2) || (card_value == 7) || (card_value == 10)) {
			...
			if (i == excursion.length) {
				...
				eat_type |= GameConstants.WIK_HBZP_EQS;
				type_count[count++] = GameConstants.WIK_HBZP_EQS;
			}
		}
		// 一五十吃
		if (yws_type == true) {
	...
	public int check_chi_yyzhz(int cards_index[], int cur_card, int type_count[], int type_eat_count[]) {
		 ...
		 * GameConstants.WIK_HBZP_XXD : GameConstants.WIK_HBZP_DDX; eat_type |=
		 * action; type_count[count++] = action; } // 大小搭吃 if
		 * (cards_index[reverse_index] == 2) {
		 * 
		 * int action = (get_card_color(cur_card) == 0x00) ?
		 * GameConstants.WIK_HBZP_DDX : GameConstants.WIK_HBZP_XXD; eat_type |=
		 * action; type_count[count++] = action; }
		 */
		// 二七十吃
		int card_value = get_card_value(cur_card);
		if ((card_value == 2) || (card_value == 7) || (card_value == 10)) {
	...
	public boolean is_shi_ba_xiao(AnalyseItem analyseItem) {
		...
		for (int i = 0; i < analyseItem.cbWeaveKind.length; i++) {
			...
			case GameConstants.WIK_HBZP_LONG:
			case GameConstants.WIK_AN_LONG:
			case GameConstants.WIK_HBZP_ZHAO:
			...
			case GameConstants.WIK_HBZP_KAN:
	...
	public boolean check_lou_weave_phz(int cards_index[], int cur_card, int action, int type_count[], int type_eat_count,
		...
		if ((temp_cards_index[cur_card_index] == 0) && (card_count > 2)) {
			for (int i = 0; i < temp_eat_count[0]; i++) {
				...
				case GameConstants.WIK_HBZP_LEFT:
					lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][0] = GameConstants.WIK_HBZP_LEFT;
					bAction = true;
					break;
				case GameConstants.WIK_HBZP_CENTER:
					lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][0] = GameConstants.WIK_HBZP_CENTER;
					bAction = true;
					break;
				case GameConstants.WIK_HBZP_RIGHT:
					lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][0] = GameConstants.WIK_HBZP_RIGHT;
					bAction = true;
					break;
				case GameConstants.WIK_HBZP_DDX:
					lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][0] = GameConstants.WIK_HBZP_DDX;
					bAction = true;
					break;
				case GameConstants.WIK_HBZP_XXD:
					lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][0] = GameConstants.WIK_HBZP_XXD;
					bAction = true;
					break;
				case GameConstants.WIK_HBZP_EQS:
					lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][0] = GameConstants.WIK_HBZP_EQS;
					bAction = true;
					break;
				case GameConstants.WIK_YWS:
			...
			for (int i = 0; i < temp_eat_count[0]; i++) {
				...
				case GameConstants.WIK_HBZP_LEFT: {
					...
					for (int j = 0; j < sec_eat_count[0]; j++) {
						...
						case GameConstants.WIK_HBZP_LEFT:
							lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][1] = GameConstants.WIK_HBZP_LEFT;
							bAction = true;
							break;
						case GameConstants.WIK_HBZP_CENTER:
							lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][1] = GameConstants.WIK_HBZP_CENTER;
							bAction = true;
							break;
						case GameConstants.WIK_HBZP_RIGHT:
							lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][1] = GameConstants.WIK_HBZP_RIGHT;
							bAction = true;
							break;
						case GameConstants.WIK_HBZP_DDX:
							lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][1] = GameConstants.WIK_HBZP_DDX;
							bAction = true;
							break;
						case GameConstants.WIK_HBZP_XXD:
							lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][1] = GameConstants.WIK_HBZP_XXD;
							bAction = true;
							break;
						case GameConstants.WIK_HBZP_EQS:
							lou_weave_item[sub_lou_index].nLouWeaveKind[lou_index++][1] = GameConstants.WIK_HBZP_EQS;
							bAction = true;
							break;
						case GameConstants.WIK_YWS:
	...
	public int check_peng(int card_index[], int cur_card) {
		...
		// 碰牌判断
		return (card_index[switch_to_card_index(cur_card)] == 2) ? GameConstants.WIK_HBZP_PENG : GameConstants.WIK_NULL;
	}
	...
	public int check_pao(int card_index[], int cur_card) {
		...
		// 碰牌判断
		return (card_index[switch_to_card_index(cur_card)] == 3) ? GameConstants.WIK_HBZP_ZHAO : GameConstants.WIK_NULL;
	}
	...
	public int get_weave_hu_xi(WeaveItem weave_item, int fan_jiang_card) {

		if (get_card_value(fan_jiang_card) == 10)
			fan_jiang_card = 1;
		else
			fan_jiang_card = get_card_value(fan_jiang_card) + 1;

		switch (weave_item.weave_kind) {
		case GameConstants.WIK_HBZP_LONG:
			if (fan_jiang_card == get_card_value(weave_item.center_card)) {
				return (get_card_color(weave_item.center_card) != 0) ? 24 : 12;
			}
			return (get_card_color(weave_item.center_card) != 0) ? 12 : 9;
		case GameConstants.WIK_HBZP_ZHAO:
			if (fan_jiang_card == get_card_value(weave_item.center_card)) {
				return (get_card_color(weave_item.center_card) != 0) ? 18 : 9;
			}
			return (get_card_color(weave_item.center_card) != 0) ? 9 : 6;
		case GameConstants.WIK_HBZP_KAN:
			if (fan_jiang_card == get_card_value(weave_item.center_card)) {
				return (get_card_color(weave_item.center_card) != 0) ? 12 : 6;
			}
	...
	public int get_analyse_hu_xi(int cbWeaveKind, int center_card, int fan_jiang_card) {
		if (get_card_value(fan_jiang_card) == 10)
			fan_jiang_card = 1;
		else
			fan_jiang_card = get_card_value(fan_jiang_card) + 1;
		switch (cbWeaveKind) {
		case GameConstants.WIK_HBZP_LONG:
			if (fan_jiang_card == get_card_value(center_card)) {
				return (get_card_color(center_card) != 0) ? 24 : 12;
			}
			return (get_card_color(center_card) != 0) ? 12 : 9;
		case GameConstants.WIK_HBZP_ZHAO:
			if (fan_jiang_card == get_card_value(center_card)) {
				return (get_card_color(center_card) != 0) ? 18 : 9;
			}
			return (get_card_color(center_card) != 0) ? 9 : 6;
		case GameConstants.WIK_HBZP_KAN:
			if (fan_jiang_card == get_card_value(center_card)) {
				return (get_card_color(center_card) != 0) ? 12 : 6;
			}
	...
	public int analyse_first_pao_card_all(int cards_index[], WeaveItem WeaveItem[], int cbWeaveCount, GangCardResult gangCardResult,
		...
		for (int i = 0; i < GameConstants.MAX_HH_INDEX; i++) {
			...
			if (cards_index[i] == 4) {
				cbActionMask |= GameConstants.WIK_HBZP_ZHAO;
	...
	public int analyse_pao_card_all(int cards_index[], WeaveItem WeaveItem[], int cbWeaveCount, GangCardResult gangCardResult, boolean check_weave) {
		...
		if (check_weave == true) {
			...
			for (int i = 0; i < cbWeaveCount; i++) {
				if (WeaveItem[i].weave_kind == GameConstants.WIK_HBZP_PENG) {
	...
	public boolean is_dan_diao(WeaveItem weaveItem[], int weave_count, int cards_index[], int cur_card) {
		...
		for (int i = 0; i < weave_count; i++) {
			if (weaveItem[i].weave_kind != GameConstants_YYZHZ.WIK_HBZP_PENG) {
				return false;
			}
		}
	...
	public boolean is_quan_hun(AnalyseItem analyseItem) {
		...
		for (int i = 0; i < analyseItem.cbWeaveKind.length; i++) {
			...
			case GameConstants.WIK_HBZP_XXD:
			case GameConstants.WIK_HBZP_DDX: {
				if (this.get_analyse_hu_xi(analyseItem.cbWeaveKind[i], analyseItem.cbCenterCard[i], 10) == 0) {
					return false;
				}
			}
	...
	public int is_jie_jie_liang(AnalyseItem analyseItem) {
		int count = 0;
		for (int i = 0; i < analyseItem.cbWeaveKind.length; i++) {
			switch (analyseItem.cbWeaveKind[i]) {
			case GameConstants.WIK_HBZP_LONG:
	...
	public boolean is_kuai_bian(AnalyseItem analyseItem) {
		int count = 0;
		boolean hu_xi = false;
		for (int i = 0; i < analyseItem.cbWeaveKind.length; i++) {
			switch (analyseItem.cbWeaveKind[i]) {
			...
			case GameConstants.WIK_HBZP_DDX: {
				...
				if (this.get_analyse_hu_xi(analyseItem.cbWeaveKind[i], analyseItem.cbCenterCard[i], 10) == 0 && is_hong == true) {
					return false;
				}
				break;
			}
	...
	public int calculate_tuan_count(WeaveItem hu_weave_item[], int hu_weave_count) {
		...
		for (int i = 0; i < hu_weave_count - 1; i++) {
			if (!(hu_weave_item[i].weave_kind == GameConstants.WIK_HBZP_ZHAO || hu_weave_item[i].weave_kind == GameConstants.WIK_HBZP_LONG
					|| hu_weave_item[i].weave_kind == GameConstants.WIK_AN_LONG))
				continue;
			for (int j = i + 1; j < hu_weave_count; j++) {
				if (!(hu_weave_item[j].weave_kind == GameConstants.WIK_HBZP_ZHAO || hu_weave_item[j].weave_kind == GameConstants.WIK_HBZP_LONG
	...
	public boolean calculate_shun(WeaveItem hu_weave_item[], int hu_weave_count) {
		...
		index = 0;
		for (int i = 0; i < hu_weave_count - 1; i++) {
			if (!(hu_weave_item[i].weave_kind == GameConstants.WIK_WEI || hu_weave_item[i].weave_kind == GameConstants.WIK_HBZP_PENG
					|| hu_weave_item[i].weave_kind == GameConstants.WIK_CHOU_WEI || hu_weave_item[i].weave_kind == GameConstants.WIK_HBZP_KAN))
				continue;
			if (index == 0)
				card[index++] = hu_weave_item[i].center_card;
			else if (card[index - 1] > hu_weave_item[i].center_card) {
	...
	public boolean is_pengpeng_hu(AnalyseItem analyseItem) {
		for (int i = 0; i < analyseItem.cbWeaveKind.length; i++) {
			if ((analyseItem.cbWeaveKind[i] & (GameConstants.WIK_HBZP_LEFT | GameConstants.WIK_HBZP_CENTER | GameConstants.WIK_HBZP_RIGHT)) != 0)
				return false;
		}
		boolean same = true;
		int lastCard = 0;
	...
	public boolean is_pengpeng_hu_down(WeaveItem weaveItems[], int weaveCount) {
		...
		for (int i = 0; i < weaveCount; i++) {
			if ((weaveItems[i].weave_kind != GameConstants.WIK_HBZP_PENG && weaveItems[i].weave_kind != GameConstants.WIK_GANG
	...
	public boolean isChengJu(int cards_index[], AnalyseItem analyseItem) {
		...
		for (int i = 0; i < mj_count; i++) {
			...
			if (cbMagicCardIndex[i] == 3) {
				...
				// = switch_to_card_data(i);
				// }
				analyseItem.eyeKind = GameConstants.WIK_HBZP_PENG;
			...
			if ((i < (GameConstants.MAX_HH_INDEX - 2)) && ((i % 3) == 0)) {
				...
				if (chi_count >= 3) {
					if (cbMagicCardIndex[i] >= 1 && cbMagicCardIndex[i + 1] >= 1 && cbMagicCardIndex[i + 2] >= 1) {
						...
						// }
						analyseItem.eyeKind = GameConstants.WIK_HBZP_LEFT;
						analyseItem.eyeCenterCard = switch_to_card_data(i);
						return true;
					}
				}
	...
	private boolean isCurCardEye(AnalyseItem analyseItem, int cur_card) {
		...
		if ((analyseItem.eyeKind == GameConstants.WIK_HBZP_LEFT || analyseItem.eyeKind == GameConstants.WIK_HBZP_PENG) && isEyes
	...
	public boolean analyse_card(int cards_index[], WeaveItem weaveItem[], int cbWeaveCount, int seat_index, int provider_index, int cur_card,
			List<AnalyseItem> analyseItemArray, boolean has_feng, int fan_jiang, boolean is_tian_hu) {
		// 计算数目
		int cbCardCount = get_card_count_by_index(cards_index);
		if (cbCardCount == 0)
			return false;
		...
		for (int i = 0; i < GameConstants.MAX_HH_INDEX; i++) {
			if (cards_index[i] == 4) {
				...
				if ((seat_index == provider_index) || (switch_to_card_index(cur_card) != i))
					pao_WeaveItem.weave_kind = GameConstants.WIK_HBZP_LONG;
				else
					pao_WeaveItem.weave_kind = GameConstants.WIK_HBZP_ZHAO;
				b_pao = true;
				cbCardCount -= 4;
		...
		if (cbCardCount == 0) {
			...
			for (int j = 0; j < cbWeaveCount; j++) {
				...
				analyseItem.hu_xi[j] = get_weave_hu_xi(weaveItem[j], fan_jiang);
			...
			if (b_pao == true) {
				...
				analyseItem.hu_xi[count] = get_weave_hu_xi(pao_WeaveItem, fan_jiang);
		...
		for (int i = 0; i < GameConstants.MAX_HH_INDEX; i++) {
			...
			if (cards_index[i] == 3) {
				...
				if ((cur_card == switch_to_card_data(i)) && (seat_index == provider_index) && is_tian_hu == false)
					kindItem[cbKindItemCount].cbWeaveKind = GameConstants.WIK_HBZP_KAN;
				else if (cur_card != switch_to_card_data(i)) {
					kindItem[cbKindItemCount].cbWeaveKind = GameConstants.WIK_HBZP_KAN;
				} else
					kindItem[cbKindItemCount].cbWeaveKind = GameConstants.WIK_HBZP_PENG;
			...
			if ((i < 10) && ((cards_index[i] == 2) || ((i == switch_to_card_index(cur_card)) && (cards_index[i] == 3)))
				...
				kindItem[cbKindItemCount].cbWeaveKind = i >= 10 ? GameConstants.WIK_HBZP_DDX : GameConstants.WIK_HBZP_XXD;
				kindItem[cbKindItemCount].cbCenterCard = switch_to_card_data(i);
				cbKindItemCount++;
			}
			// 大小搭吃
			if ((i < 10) && (cards_index[i] >= 1)
				...
				kindItem[cbKindItemCount].cbValidIndex[2] = (i + 10) % GameConstants.MAX_HH_INDEX;
				kindItem[cbKindItemCount].cbWeaveKind = i > 10 ? GameConstants.WIK_HBZP_XXD : GameConstants.WIK_HBZP_DDX;
				kindItem[cbKindItemCount].cbCenterCard = switch_to_card_data(i);
			...
			if ((card_date & GameConstants.LOGIC_MASK_VALUE) == 0x02) {
				for (int j = 1; j <= cards_index[i]; j++) {
					if (((cards_index[i] < 3) || (i == switch_to_card_index(cur_card)))
						...
						kindItem[cbKindItemCount].cbWeaveKind = GameConstants.WIK_HBZP_EQS;
						kindItem[cbKindItemCount].cbCenterCard = switch_to_card_data(i);
						cbKindItemCount++;
					}
				}
			...
			if ((i < (GameConstants.MAX_HH_INDEX - 2)) && (cards_index[i] > 0) && ((i % 10) <= 7)) {
				for (int j = 1; j <= cards_index[i]; j++) {
					...
					if (((cards_index[i] < 3) || (i == switch_to_card_index(cur_card)))
						...
						kindItem[cbKindItemCount].cbWeaveKind = GameConstants.WIK_HBZP_LEFT;
						kindItem[cbKindItemCount].cbCenterCard = switch_to_card_data(i);
						cbKindItemCount++;
					}
				}
				...
				if (bEnoughCard == true) {
					...
					if ((bNeedCardEye == false) || (cbCardEye != 0)) {
						...
						for (int i = 0; i < cbLessKindItem; i++) {
							...
							analyseItem.hu_xi[i + cbWeaveCount] = get_weave_hu_xi(weave_item, fan_jiang);
	...
	public int get_action_rank(int player_action) {
		...
		// 跑等级
		if (player_action == GameConstants.WIK_HBZP_ZHAO) {
			return 40;
		}
		// 吃胡牌等级
		...
		// 碰牌等级
		if (player_action == GameConstants.WIK_HBZP_PENG) {
			return 20;
		}

		// 上牌等级
		if (player_action == GameConstants.WIK_HBZP_RIGHT || player_action == GameConstants.WIK_HBZP_CENTER
				|| player_action == GameConstants.WIK_HBZP_LEFT || player_action == GameConstants.WIK_HBZP_XXD
				|| player_action == GameConstants.WIK_HBZP_DDX || player_action == GameConstants.WIK_HBZP_EQS) {
			return 10;
		}
	...
	public int get_chi_hu_action_rank_dy(ChiHuRight chiHuRight) {
		int wFanShu = 5;
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_PIAO_HU)).is_empty()) {
			wFanShu = 6;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_TAI_HU)).is_empty()) {
			wFanShu = 6;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_CHUANG_SHUANG)).is_empty()) {
			wFanShu = 6;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_MAN_30)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_SAN_ZHAO)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_PIAO_TAI)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_SHI_HONG)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_SHI_HONG_TAI)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_SHI_HONG_PIAO)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_CHUANG_TAI)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_CHUANG_PIAO)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_YI_ZHI_YAN)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_YI_KUAI_BIAN)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_YI_KUAI_BIAN)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_QUAN_HUN)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_QUAN_HEI)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_TIAN_HU)).is_empty()) {
			wFanShu = 12;
		}
		if (!(chiHuRight.opr_and_long(GameConstants.CHR_HBZP_DI_HU)).is_empty()) {
			wFanShu = 12;
		}
	...
	public int get_weave_card(int cbWeaveKind, int cbCenterCard, int cbCardBuffer[]) {
		// 组合扑克
		switch (cbWeaveKind) {
		case GameConstants.WIK_HBZP_LEFT: // 左吃类型
		{
			// 设置变量
		...
		case GameConstants.WIK_HBZP_RIGHT: // 右吃类型
		{
			// 设置变量
			cbCardBuffer[0] = cbCenterCard;
			cbCardBuffer[1] = cbCenterCard - 1;
		...
		case GameConstants.WIK_HBZP_CENTER: // 中吃类型
		{
			// 设置变量
			cbCardBuffer[0] = cbCenterCard;
			cbCardBuffer[1] = cbCenterCard - 1;
		...
		case GameConstants.WIK_HBZP_XXD:// 吃小
		{
			// 设置变量
			if (cbCenterCard > 16)
		...
		case GameConstants.WIK_HBZP_DDX:// 吃大
		{
			// 设置变量
			if (cbCenterCard < 16)
				cbCenterCard = cbCenterCard + 16;
		...
		case GameConstants.WIK_HBZP_EQS:// 吃小
		{
			// 设置变量
		...
		case GameConstants.WIK_HBZP_PENG: // 碰牌操作
		case GameConstants.WIK_CHOU_SAO:
		case GameConstants.WIK_WEI:
		case GameConstants.WIK_XIAO:
		case GameConstants.WIK_CHOU_XIAO:
	...
	public static void main(String[] args) {
		// 插入扑克
		HBPHZGameLogic logic = new HBPHZGameLogic();
