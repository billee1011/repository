...
public class HandlerOutCardBaoTing_JiXian extends AbstractMJHandler<Table_JiXian> {
	...
	public void exe(Table_JiXian table) {
		...
		table.operate_out_card_bao_ting(_out_card_player, 1, new int[] { _out_card_data }, GameConstants.OUT_CARD_TYPE_MID,
				GameConstants.INVALID_SEAT);
