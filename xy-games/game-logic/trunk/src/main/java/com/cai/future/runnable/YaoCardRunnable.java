...
public class YaoCardRunnable extends BaseFuture {
	private static Logger logger = LoggerFactory.getLogger(YaoCardRunnable.class);

	
	private int _room_id;
	
	public YaoCardRunnable(int room_id){
		super(room_id);
		_room_id = room_id;
	}
