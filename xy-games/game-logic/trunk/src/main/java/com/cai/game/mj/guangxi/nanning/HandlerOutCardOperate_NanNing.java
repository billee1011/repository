...
public class HandlerOutCardOperate_NanNing extends MJHandlerOutCardOperate<Table_NanNing> {
    ...
    public boolean handler_operate_card(Table_NanNing table, int seat_index, int operate_code, int operate_card) {
        ...
        case GameConstants.WIK_CHI_HU: {
            // 客户端播放放炮动画
            table.GRR._chi_hu_rights[_out_card_player].opr_or(GameConstants_NanNing.CHR_FANG_PAO);
