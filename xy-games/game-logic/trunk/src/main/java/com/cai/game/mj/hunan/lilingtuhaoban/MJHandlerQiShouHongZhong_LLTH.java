...
public class MJHandlerQiShouHongZhong_LLTH extends AbstractMJHandler<MJTable_LLTH> {
    ...
    public void exe(MJTable_LLTH table) {
      ...
      /*  if (table.has_rule(GameConstants.GAME_RULE_HUNAN_JIANPAOHU)) {
            this.handler_operate_card(table, _seat_index, GameConstants.WIK_ZI_MO,
                    table._logic.switch_to_card_data(table._logic.get_magic_card_index(0)));
        } else {*/
