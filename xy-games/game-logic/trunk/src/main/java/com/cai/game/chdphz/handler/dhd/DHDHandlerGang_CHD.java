...
public class DHDHandlerGang_CHD extends PHZHandlerGang<CHDPHZTable> {
...
//			}
			...
			table.process_chi_hu_player_score_dhd_chd(_seat_index, _provide_player, operate_card, true);
