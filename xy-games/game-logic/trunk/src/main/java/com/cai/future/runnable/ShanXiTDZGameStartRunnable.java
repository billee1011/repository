...
public class ShanXiTDZGameStartRunnable extends BaseFuture {

	private static Logger logger = LoggerFactory.getLogger(ShanXiTDZGameStartRunnable.class);

	private int _room_id;

	public ShanXiTDZGameStartRunnable(int roomId) {
		super(roomId);
