...
public class PHZHandlerChiPeng_ER extends HHHandlerChiPeng<HHTable_ER> {

	@SuppressWarnings("unused")
	private GangCardResult m_gangCardResult;

	public PHZHandlerChiPeng_ER() {
	 ...
	 */
	@Override
	public boolean handler_operate_card(HHTable_ER table, int seat_index, int operate_code, int operate_card, int lou_pai) {
