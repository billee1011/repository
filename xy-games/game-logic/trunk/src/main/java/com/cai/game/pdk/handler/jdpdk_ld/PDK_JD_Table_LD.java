 ...
 * 
 */
package com.cai.game.pdk.handler.jdpdk_ld;
...
public class PDK_JD_Table_LD extends PDKTable {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_LD();
	...
	public boolean handler_player_ready(int seat_index, boolean is_cancel) {
		if (is_cancel) {//
			...
			if (this._cur_round > 0) {
				...
				godViewObservers().sendAll(roomResponse2);
			}
			return false;
		}
		if (this.get_players()[seat_index] == null) {
