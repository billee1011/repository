...
public class HandlerGangDispatchCard_THJ_JingDian_CS_QY extends AbstractMJHandler<Table_JingDian_CS_QY> {
	...
	public HandlerGangDispatchCard_THJ_JingDian_CS_QY() {
			...
			for (int k = 0; k < table.getTablePlayerNumber(); k++) {
				if (k == _seat_index) {
					...
					int action = table.analyse_chi_hu_card(table.GRR._cards_index[k], table.GRR._weave_items[k], table.GRR._weave_count[k], bu_card,
							chr, Constants_JingDian_CS_QY.HU_CARD_TYPE_GANG_KAI, k);
