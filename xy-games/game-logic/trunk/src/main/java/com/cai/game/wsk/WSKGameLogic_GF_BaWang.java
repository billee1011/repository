...
public class WSKGameLogic_GF_BaWang extends WSKGameLogic {

	public WSKGameLogic_GF_BaWang() {
	...
	public int GetCardType(int cbCardData[], int cbCardCount, boolean isLast) {
		...
		// 四王
		if ((card_index.card_index[13] == 4 || card_index.card_index[14] == 4) && cbCardCount == 4) {
			return GameConstants.WSK_GF_CT_KING_FOUR;
		}
		if ((card_index.card_index[13] == 4 || card_index.card_index[14] == 4) && cbCardCount == 5
				&& card_index.card_index[13] + card_index.card_index[14] == cbCardCount) {
			return GameConstants.WSK_GF_CT_KING_FIVE;
		}
		if ((card_index.card_index[13] == 4 || card_index.card_index[14] == 4) && cbCardCount == 6
				&& card_index.card_index[13] + card_index.card_index[14] == cbCardCount) {
			return GameConstants.WSK_GF_CT_KING_SIX;
		}
		if (cbCardCount == 7 && card_index.card_index[13] + card_index.card_index[14] == cbCardCount) {
			return GameConstants.WSK_GF_CT_KING_SEVEN;
		}
		if (cbCardCount == 8 && card_index.card_index[13] + card_index.card_index[14] == cbCardCount) {
			return GameConstants.WSK_GF_CT_KING_EIGHT;
		}
		// 王加4炸
		if (wang_count > 0) {
	...
	public int search_out_card(int cbCardData[], int cbCardCount, int turn_card_data[], int turn_card_count,
		...
		case GameConstants.WSK_GF_CT_KING_FOUR:
		case GameConstants.WSK_GF_CT_KING_FIVE:
		case GameConstants.WSK_GF_CT_KING_SIX:
		case GameConstants.WSK_GF_CT_KING_SEVEN:
		case GameConstants.WSK_GF_CT_KING_EIGHT: {
			tip_type_count += search_out_card_king_boom(cbCardData, cbCardCount, turn_card_data, turn_card_count,
	...
	public int search_boom(int cbCardData[], int cbCardCount, int tip_out_card[][], int tip_out_count[],
		...
		// 王炸
		if (hand_card_idnex.card_index[14] == 4 || hand_card_idnex.card_index[13] == 4) {
	...
	public int search_out_card_king_boom(int cbCardData[], int cbCardCount, int turn_card_data[], int turn_card_count,
		...
		AnalysebCardDataToIndex(cbCardData, cbCardCount, hand_card_idnex);
		int wang_count = hand_card_idnex.card_index[13] + hand_card_idnex.card_index[14];
		if (turn_card_count == 4) {
			turn_card_count = 9;
		} else if (turn_card_count == 5) {
			turn_card_count = 10;
	...
	public int search_out_card_boom(int cbCardData[], int cbCardCount, int turn_card_data[], int turn_card_count,
		...
		if (wang_count >= 4) {
			...
			} else if (hand_card_idnex.card_index[14] == 4 || hand_card_idnex.card_index[13] == 4) {
				if (turn_card_count == 9 && wang_count >= 4 || (turn_card_count == 10 && wang_count >= 5)
						|| (turn_card_count == 11 && wang_count >= 6) || wang_count == 8) {
					// 王炸
	...
	public int GetCardXianScore(int cbCardData[], int cbCardCount, int card_type) {
		...
		if ((card_index.card_index[13] == 4 || card_index.card_index[14] == 4) && wang_count == cbCardCount) {
			if (cbCardCount == 4) {
				return 16;
			}
			if (cbCardCount == 5) {
				if (has_rule(GameConstants.GAME_RULE_WSK_GF_SCORE_LIMIT_16)) {
					score = 16;
				} else {
					score = 20;
				}
	...
	public int GetHandCardXianScore(int cbCardData[], int cbCardCount, int sheng_dang_biaozhi,
		...
		if (card_index.card_index[13] == 14 || card_index.card_index[14] == 4) {
			if (card_index.card_index[13] + card_index.card_index[14] >= 7) {
				if (has_rule(GameConstants.GAME_RULE_WSK_GF_SCORE_LIMIT_20)) {
					score += 20;
					...
					score += 24;
					userdatascore[userCardDataBuilder.getCardsDataCount()] = 24;
				}
				Int32ArrayResponse.Builder cards_card = Int32ArrayResponse.newBuilder();
				for (int i = 0; i < card_index.card_index[13]; i++) {
					cards_card.addItem(card_index.card_data[13][i]);
				}
				for (int i = 0; i < card_index.card_index[14]; i++) {
					cards_card.addItem(card_index.card_data[14][i]);
				}
				userCardDataBuilder.addCardsData(cards_card);
				wang_count = 0;
				card_index.card_index[13] = 0;
				card_index.card_index[14] = 0;
			} else {
				if (card_index.card_index[13] == 4 || card_index.card_index[14] == 4) {
					if (card_index.card_index[13] + card_index.card_index[14] == 6) {
						if (has_rule(GameConstants.GAME_RULE_WSK_GF_SCORE_LIMIT_20)) {
							score += 20;
							userdatascore[userCardDataBuilder.getCardsDataCount()] = 20;
						} else if (has_rule(GameConstants.GAME_RULE_WSK_GF_SCORE_LIMIT_16)) {
					...
					} else if (card_index.card_index[13] + card_index.card_index[14] == 5) {
						if (has_rule(GameConstants.GAME_RULE_WSK_GF_SCORE_LIMIT_16)) {
							score += 16;
							userdatascore[userCardDataBuilder.getCardsDataCount()] = 16;
						} else {
