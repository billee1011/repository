...
public class PHZHandlerOutCardOperate_XT extends HHHandlerOutCardOperate<HHTable> {
	@Override
	public void exe(HHTable table) {
		...
		if (bAroseAction == false) {
			...
			if (table.has_rule(GameConstants.GAME_RULE_ADD_SPEED) && sysParamModel1111 != null && sysParamModel1111.getVal1() > 0
			...
			if (table.has_rule(GameConstants.GAME_RULE_ADD_SPEED) && sysParamModel1111 != null && sysParamModel1111.getVal2() > 0
