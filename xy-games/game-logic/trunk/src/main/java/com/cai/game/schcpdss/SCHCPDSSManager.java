...
public class SCHCPDSSManager {
	...
	private static class HHManagerHolder {  
	      private static SCHCPDSSManager INSTANCE = new SCHCPDSSManager();
	 } 
	
	private SCHCPDSSManager(){}
	
	public static final SCHCPDSSManager getInstance(){
