...
class GenerateFengTable_258 {
    ...
    private static void generate() {
        System.out.println("Generating 258 feng table begin ...");
        initialize();
        generate_table(false, false, true);
        TableManager.getInstance().dump_ewb_feng();
        System.out.println("Generating 258 feng table finished ...");
    }
