 ...
 * 
 */
package com.cai.game.pdk.handler.fifteenpdk_ah;
...
///////////////////////////////////////////////////////////////////////////////////////////////
public class PDK_FIFTEENAH_Table extends PDKTable {

	public PDK_FIFTEENAH_Table() {
	...
	public void on_init_table(int game_type_index, int game_rule_index, int game_round) {
		...
		_handler_out_card_operate = new PDKHandlerOutCardOperate_FIFTEENAH();
	...
	private void test_cards() {
		// int cards[] = new int[] {59, 55, 54, 10, 41, 37, 25, 28, 44, 60, 53,
		// 20, 8, 12, 58, 21, 38, 7, 22, 56, 24, 57, 45, 40, 19, 11, 49, 52, 35,
		// 9, 6, 3, 29, 42, 61, 27, 36, 50, 5, 23, 26, 51, 43, 39, 4};
	...
	public boolean handler_requst_message_deal(Player player, int seat_index, RoomRequest room_rq, int type) {
		...
		if (type == MsgConstants.REQUST_ENTER_BACK) {
			_enter_back[seat_index] = !_enter_back[seat_index];
