...
public abstract class IClientExHandler<T extends GeneratedMessage> {
	...
	public void doExecute(Object message, TransmitProto topReq, Session session) throws Exception {
	 ...
	 * @throws Exception
	 */
	protected abstract void execute(T req, TransmitProto topReq, Session session) throws Exception;
