...
import com.cai.http.interceptor.DebugInterceptor;
...
public class FastJsonJsonView extends AbstractView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, //
        ...
        //TODO 自定义打印测试
		Map<String,Object> myMap = DebugInterceptor.myhreadLocal.get();
		if(myMap!=null){
			String jsonResult = outnew.toString();
			myMap.put("jsonResult", jsonResult);
		}
		//
