...
public class Global {
	 ...
	 * 业务逻辑处理耗时任务异步单线程 
	 */
	public static ScheduledThreadPoolExecutor logicService = new ScheduledThreadPoolExecutor(1,
	 ...
	 * db批处理
	 */
	public static ScheduledExecutorService dbExecutorService = Executors.newScheduledThreadPool(1,new MyThreadFactory(ThreadNameEnum.DB_BATCH_THREAD.getCode()));
	 ...
	 * db批处理
	 */
	public static ScheduledExecutorService getDbBatchService() {
