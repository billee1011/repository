...
@Document(collection = "game_item_log")
@CompoundIndexes({ @CompoundIndex(name = "index_crate_time", def = "{'create_time': -1}", background = true),
		@CompoundIndex(name = "index_log_type", def = "{'log_type': 0}", background = true),
		@CompoundIndex(name = "index_account_id", def = "{'account_id': 0}", background = true),
		@CompoundIndex(name = "index_appId", def = "{'appId': 0}", background = true),
		@CompoundIndex(name = "index_openRoomWay", def = "{'openRoomWay': 0}", background = true),
		@CompoundIndex(name = "index_gameTypeIndex", def = "{'gameTypeIndex': 0}", background = true) })
public class GameItemLogModel implements Serializable {
