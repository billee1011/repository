...
@CompoundIndexes({ @CompoundIndex(name = "index_crate_time", def = "{'create_time': -1}", background = true),
		@CompoundIndex(name = "index_account", def = "{'account_id': 0}"), @CompoundIndex(name = "index_game_id", def = "{'game_id': 0}"),
		@CompoundIndex(name = "index_log_type", def = "{'log_type': 0}"), @CompoundIndex(name = "index_brand_id", def = "{'brand_id': 0}"),
		@CompoundIndex(name = "index_v1", def = "{'v1': 0}"), @CompoundIndex(name = "index_room_id", def = "{'v3': 0}", background = true),
		@CompoundIndex(name = "index_create_account_id", def = "{'create_account_id': 0}", background = true),
		@CompoundIndex(name = "index_club_id", def = "{'club_id': 0}", background = true),
		@CompoundIndex(name = "index_groupID", def = "{'groupID': 0}", background = true),
		@CompoundIndex(name = "index_createType", def = "{'createType': 0}", background = true),
		@CompoundIndex(name = "index_match_id", def = "{'match_id': 0}", background = true),
		@CompoundIndex(name = "index_randomNum", def = "{'randomNum': 0}", background = true),
		@CompoundIndex(name = "index_accountIds", def = "{'accountIds': 0}", background = true),
		...
		@CompoundIndex(name = "index_clubbrandquery", def = "{'create_time': 0, 'log_type':0, 'club_id':0, 'isRealKouDou':0, 'clubMatchId':0}", background = true) })
