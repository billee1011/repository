...
@CompoundIndexes({ @CompoundIndex(name = "index_account_id", def = "{'account_id': 0}", background = true),
		@CompoundIndex(name = "index_notes_date", def = "{'notes_date': 0}", background = true),
