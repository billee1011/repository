...
@CompoundIndexes({ 
		@CompoundIndex(name = "index_matchId", def = "{'matchId': 0}"),
		@CompoundIndex(name = "index_matchName", def = "{'matchName': 0}"),
		@CompoundIndex(name = "index_accountId", def = "{'accountId': 0}"),
		@CompoundIndex(name = "index_accountName", def = "{'accountName': 0}"),
		@CompoundIndex(name = "index_gameId", def = "{'gameId': 0}"),
		@CompoundIndex(name = "index_unqueueId", def = "{'unqueueId': 0}"),
