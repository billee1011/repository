 ...
 *
 * @author WalkerGeek 
 * date: 2018年8月24日 上午10:19:34 <br/>
 */
public class Constants_MJ_NANCHANG extends GameConstants{
	// 单选
	public static final int GAME_RULE_MJ_NC_DIANPAO3 = 1; // 点炮三家付
	public static final int GAME_RULE_MJ_NC_DIANPAO1 = 2; // 点炮一家付
	public static final int GAME_RULE_MJ_NC_BU_PA = 3; // 不爬
	public static final int GAME_RULE_MJ_NC_KUAI_XIA = 4; // 快下
	public static final int GAME_RULE_MJ_NC_MANG_XIA = 5; // 慢下
	public static final int GAME_RULE_MJ_NC_CHAOZHUANG = 6; // 抄庄
	public static final int GAME_RULE_MJ_NC_WU_PING_HU = 7; // 无平胡
	public static final int GAME_RULE_MJ_NC_HUI_TOU_XIAO = 8; // 回头一笑
	public static final int GAME_RULE_MJ_NC_FANGBEI = 9; // 翻倍
	public static final int GAME_RULE_MJ_NC_JIA10 = 10; // +10
	public static final int GAME_RULE_MJ_NC_SHANGXIA_FANG_JING = 12; // 上下翻精
	public static final int GAME_RULE_MJ_NC_ZHAO_JIN_ZI = 13; // 照镜子
	public static final int GAME_RULE_MJ_NC_MAI_LEI = 14; // 埋雷
	public static final int GAME_RULE_MJ_NC_FA_DIAN = 15; // 发电
	public static final int GAME_RULE_MJ_NC_TON_YI_SHOU_GE = 16; // 同一首歌
	public static final int GAME_RULE_MJ_NC_SHAI_YUE_LIANG = 17; //晒月亮
	public static final int GAME_RULE_MJ_NC_SXZZYY = 18; //上下左左右右
	public static final int GAME_RULE_MJ_NC_SHUIJING = 19;  //随精
	public static final int GAME_RULE_MJ_NC_PIAOJING = 20;  //飘精
	public static final int GAME_RULE_MJ_NC_FENGDING300 = 21;  //300封顶
	public static final int GAME_RULE_MJ_NC_BI_PIAO_YI_JING = 22;  //必飘一精
	...
	public static final int CHR_DE_ZHON_DE = 0x10000; // 德中德
	...
	public static final int FAN_DE_ZHON_DE = 4; // 德中德
	public static final int FAN_JING_DIAO = 2; // 精钓
	public static final int FAN_TIAN_HU = 20; // 天胡地胡8翻
	public static final int FAN_DA_QI_DUI = 2; // 大七对
