...
public class HttpClientUtils {
	...
	public static String httpPostWithJSON(String url, String jsonString) throws Exception {
	...
	public static void main(String[] args) {
		try {
			// String str=
			// post("https://localhost:443/ssl/test.shtml","name=12&page=34","application/x-www-form-urlencoded",
			// "UTF-8", 10000, 10000);
//			// String str=
...
//				String str = postParameters("https://192.168.1.64:8080/init/scheduled/data", params);
...
//			roomJson.setContent("@我叫仙女文----仙女文新功能上线了,请早上组织客服测试XXX游戏");
//			ClubRoomJsonModel clubJson = new ClubRoomJsonModel(0, "10384936334@chatroom", 9130767, "大厅", roomJson);
//			HttpClientUtils.httpPostWithJSON("http://39.108.11.126/api/route/init/scheduled/data", JSON.toJSONString(clubJson));
			...
			roomJson.setContent("仙女文同志  新功能上线了,请早上组织客服测试XXX游戏，如有紧急问题微信未回复,请拨打电话13670139534或者群里找焕才");
