...
public class GameConstants_HSDZ extends GameConstants {
	...
	public static final int WSK_FA_PAI = GAME_STATUS_PLAY + 1; // 发牌状态,
	public static final int WSK_CALLBANKER = GAME_STATUS_PLAY + 2; // 叫庄状态,
	public static final int WSK_PLAY = GAME_STATUS_PLAY + 3; // 游戏状态,
}
