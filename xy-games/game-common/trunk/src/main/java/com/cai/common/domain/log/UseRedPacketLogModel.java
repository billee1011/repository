...
@CompoundIndexes({ @CompoundIndex(name = "index_create_time", def = "{'create_time': -1}", background = true),
		@CompoundIndex(name = "index_account_id", def = "{'accountId': 0}", background = true),
		@CompoundIndex(name = "index_orderId", def = "{'orderId': 0}", background = true),
		@CompoundIndex(name = "index_itemId", def = "{'itemId': 0}", background = true),
		@CompoundIndex(name = "index_state", def = "{'state': 0}", background = true),
		@CompoundIndex(name = "index_finishDate", def = "{'finishDate': 0}", background = true)})
