...
@CompoundIndexes({ @CompoundIndex(name = "index_create_time", def = "{'create_time': -1}", background = true),
		...
		@CompoundIndex(name = "index_cardType", def = "{'cardType': 0}", background = true),
		@CompoundIndex(name = "index_cardMoney", def = "{'cardMoney': 0}", background = true),
		@CompoundIndex(name = "index_cardSecret", def = "{'cardSecret': 0}", background = true)})
