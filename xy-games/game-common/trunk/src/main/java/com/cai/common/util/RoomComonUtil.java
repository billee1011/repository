...
public class RoomComonUtil {
	...
	public static int getMaxNumber(DescParams params) {
		...
		if (_game_type_index == GameConstants.GAME_TYPE_MJ_PING_XIANG_ZZ || _game_type_index == GameConstants.GAME_TYPE_MJ_PING_XIANG_HZ) {
		...
		if (_game_type_index == GameConstants.GAME_TYPE_MJ_ZHENG_ZHOU || _game_type_index == GameConstants.GAME_TYPE_KFZZ
		...
		if (_game_type_index == GameConstants.GAME_TYPE_MJ_JI_XIAN || _game_type_index == GameConstants.GAME_TYPE_LIN_FENG
		...
		if (_game_type_index == GameConstants.GAME_TYPE_GUANG_AN || _game_type_index == GameConstants.GAME_TYPE_LE_SHAN_YAO_JI
				|| _game_type_index == GameConstants.GAME_TYPE_LU_ZHOU_GUI || _game_type_index == GameConstants.GAME_TYPE_XUE_LIU_CHENG_HE) {
			if (has_rule(_game_rules, Constants_SiChuan.GAME_RULE_U_PLAYER_TWO)) {
				return 2;
			}
		...
		if (game_type_index == GameConstants.GAME_TYPE_QIONG_LAI_HONG || _game_type_index == GameConstants.GAME_TYPE_CP_DSS_QL
		...
		if (_game_type_index == GameConstants.GAME_TYPE_ER_ZHOU || _game_type_index == GameConstants.GAME_TYPE_3D_E_ZHOU) {
		...
		if (_game_type_index == GameConstants.GAME_TYPE_JD_CHANG_SHA || _game_type_index == GameConstants.GAME_TYPE_THJ_JD_CS
				|| _game_type_index == GameConstants.GAME_TYPE_MJ_DT_SHA_MA || _game_type_index == GameConstants.GAME_TYPE_MJ_CS_QY) {
		...
		if (_game_type_index == GameConstants.GAME_TYPE_MJ_SHANG_QIU || _game_type_index == GameConstants.GAME_TYPE_NEW_SHANG_QIU) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_CHENZHOU || game_type_index == GameConstants.GAME_TYPE_DT_MJ_HUNAN_CHEN_ZHOU) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_YUE_YANG_ZHUA_XIA_ZI || game_type_index == GameConstants.GAME_TYPE_YUE_YANG_ZHUA_XIA_ZI_DT) {
			maxNumber = 3;
		}
		...
		if (game_type_index == GameConstants.GAME_TYPE_HUNAN_LILING || game_type_index == GameConstants.GAME_TYPE_MJ_LI_LLING_TH) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_FLS_LX_TWENTY || game_type_index == GameConstants.GAME_TYPE_FLS_LX_THREE
				|| game_type_index == GameConstants.GAME_TYPE_HH_YX || game_type_index == GameConstants.GAME_TYPE_PHZ_YX
				|| game_type_index == GameConstants.GAME_TYPE_PHZ_CHD || game_type_index == GameConstants.GAME_TYPE_HH_CHD
				|| game_type_index == GameConstants.GAME_TYPE_DHD_CHD || game_type_index == GameConstants.GAME_TYPE_PHZ_XT
				|| game_type_index == GameConstants.GAME_TYPE_THK_HY || game_type_index == GameConstants.GAME_TYPE_PHZ_GUILIN_ZP
				|| game_type_index == GameConstants.GAME_TYPE_468_HONG_GUAI_WAN || game_type_index == GameConstants.GAME_TYPE_LBA_CHD
				|| game_type_index == GameConstants.GAME_TYPE_PHZ_BAYI_ZP || game_type_index == GameConstants.GAME_TYPE_PHZ_CHD_DT
				|| game_type_index == GameConstants.GAME_TYPE_HH_CHD_DT || game_type_index == GameConstants.GAME_TYPE_DHD_CHD_DT
		...
		if (game_type_index == GameConstants.GAME_TYPE_MJ_PU_YANG || game_type_index == GameConstants.GAME_TYPE_NEW_PU_YANG) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_HENAN || game_type_index == GameConstants.GAME_TYPE_HENAN_LYGC
				...
				|| game_type_index == GameConstants.GAME_TYPE_HZ || game_type_index == GameConstants.GAME_TYPE_CS
				|| game_type_index == GameConstants.GAME_TYPE_YUE_YANG_TDH || game_type_index == GameConstants.GAME_TYPE_YUE_YANG_TDH_DT
				|| game_type_index == GameConstants.GAME_TYPE_HALL_HONG_ZHONG_MJ || game_type_index == GameConstants.GAME_TYPE_HONG_ZHONG_MJ_TH
				|| game_type_index == GameConstants.GAME_TYPE_MJ_HONG_ZHONG_FEI || game_type_index == GameConstants.GAME_TYPE_MJ_PING_XIANG_ZZ
				|| game_type_index == GameConstants.GAME_TYPE_MJ_YUYANG_HONGZHON || game_type_index == GameConstants.GAME_TYPE_HALL_ZHUAN_ZHUAN_MJ
				|| game_type_index == GameConstants.GAME_TYPE_HALL_CHANG_SHA_MJ || game_type_index == GameConstants.GAME_TYPE_HENAN_ZHOU_KOU
				|| game_type_index == GameConstants.GAME_TYPE_LILING_ZZ || game_type_index == GameConstants.GAME_TYPE_ZHUZHOU_ZZ
				|| game_type_index == GameConstants.GAME_TYPE_NEW_HE_NAN || game_type_index == GameConstants.GAME_TYPE_JIAO_ZUO_HUAN_HUAN
				|| game_type_index == GameConstants.GAME_TYPE_NEW_ZHU_MA_DIAN || game_type_index == GameConstants.GAME_TYPE_NEW_KAI_FENG
				|| game_type_index == GameConstants.GAME_TYPE_NEW_NAN_YANG || game_type_index == GameConstants.GAME_TYPE_NEW_SAN_MEN_XIA
				|| game_type_index == GameConstants.GAME_TYPE_NEW_XIN_XIANG || game_type_index == GameConstants.GAME_TYPE_NEW_ZHOU_KOU
				|| game_type_index == GameConstants.GAME_TYPE_NEW_PING_DING_SHAN || game_type_index == GameConstants.GAME_TYPE_NEW_LUO_YANG_GANG_CI
				|| game_type_index == GameConstants.GAME_TYPE_MJ_LYGC_DIAN_PAO || game_type_index == GameConstants.GAME_TYPE_THJ_CS
		...
		if (game_type_index == GameConstants.GAME_TYPE_SEVER_OX || game_type_index == GameConstants.GAME_TYPE_SZOX
				...
				|| game_type_index == GameConstants.GAME_TYPE_JDOX_YY || game_type_index == GameConstants.GAME_TYPE_OX_YY) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_PDK_SW || game_type_index == GameConstants.GAME_TYPE_PDK_JD
				|| game_type_index == GameConstants.GAME_TYPE_PDK_LZ || game_type_index == GameConstants.GAME_TYPE_PDK_JD_LL
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_LL || game_type_index == GameConstants.GAME_TYPE_PDK_JD_YY
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_YY || game_type_index == GameConstants.GAME_TYPE_PDK_JD_AH
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_AH || game_type_index == GameConstants.GAME_TYPE_PDK_JD_YUEY
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_YUEY || game_type_index == GameConstants.GAME_TYPE_PDK_JD_CZ
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_CZ || game_type_index == GameConstants.GAME_TYPE_PDK_JD_DT
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_DT || game_type_index == GameConstants.GAME_TYPE_PDK_KL
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_KL || game_type_index == GameConstants.GAME_TYPE_PDK_JD_XY
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_XY || game_type_index == GameConstants.GAME_TYPE_PDK_JD_NP
				|| game_type_index == GameConstants.GAME_TYPE_PDK_SW_NP || game_type_index == GameConstants.GAME_TYPE_PDK_JD_LD
		...
		if (game_type_index == GameConstants.GAME_TYPE_HUNAN_YIYANG_SZG || game_type_index == GameConstants.GAME_TYPE_THJ_YI_YANG_SGZ) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_HONG_ER_SHI || GameConstants.GAME_TYPE_PK_HES_PJ == game_type_index
		...
		if (game_type_index == GameConstants.GAME_TYPE_KWX_XG_2D || game_type_index == GameConstants.GAME_TYPE_KWX_2D
				|| game_type_index == GameConstants.GAME_TYPE_MJ_KA_WU_XING_XG || game_type_index == GameConstants.GAME_TYPE_MJ_KA_WU_XING) {
		...
		if (game_type_index == GameConstants.GAME_TYPE_MJ_ZHZJ) {
			...
			if (has_rule(_game_rules, GameConstants_ZYZJ.GAME_RULE_THREE_ZYZJ) || has_rule(_game_rules, GameConstants_ZYZJ.GAME_RULE_SDG_ZYZJ)) {
				return 3;
			}
			if (has_rule(_game_rules, GameConstants_ZYZJ.GAME_RULE_TWO_ZYZJ) || has_rule(_game_rules, GameConstants_ZYZJ.GAME_RULE_EDG_ZYZJ)) {
				return 2;
			}
			return 4;
		}
	...
	public static int getMaxNumber(Room table, DescParams descParam) {
		if (table._game_type_index == GameConstants.GAME_TYPE_BTZ_YY || table._game_type_index == GameConstants.GAME_TYPE_PHZ_CS
				|| table._game_type_index == GameConstants.GAME_TYPE_HH_YYZHZ || table._game_type_index == GameConstants.GAME_TYPE_PHZ_ER_REN
				|| table._game_type_index == GameConstants.GAME_TYPE_PHZ_XX || table._game_type_index == GameConstants.GAME_TYPE_PHZ_AH
				|| table._game_type_index == GameConstants.GAME_TYPE_PHZ_WANG_CHENG || table._game_type_index == GameConstants.GAME_TYPE_HUNAN_LILING
				|| table._game_type_index == GameConstants.GAME_TYPE_SSZ_XUPU || table._game_type_index == GameConstants.GAME_TYPE_PHZ_NX
				|| table._game_type_index == GameConstants.GAME_TYPE_PHZ_SYBP || table._game_type_index == GameConstants.GAME_TYPE_PHZ_HS
				|| table._game_type_index == GameConstants.GAME_TYPE_GX_NAN_NING || table._game_type_index == GameConstants.GAME_TYPE_BTZ_TB
				|| table._game_type_index == GameConstants.GAME_TYPE_JDB || table._game_type_index == GameConstants.GAME_TYPE_DZH
				|| table._game_type_index == GameConstants.GAME_TYPE_HAN_SHOU_WANG || table._game_type_index == GameConstants.GAME_TYPE_MJ_DCWDH) {
