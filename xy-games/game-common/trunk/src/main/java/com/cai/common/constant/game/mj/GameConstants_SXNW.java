...
public class GameConstants_SXNW extends GameConstants {
	public static final int GAME_RULE_PLAYER_NUM_2 = 2; // 2人玩法
	public static final int GAME_RULE_PLAYER_NUM_3 = 3; // 3人玩法
