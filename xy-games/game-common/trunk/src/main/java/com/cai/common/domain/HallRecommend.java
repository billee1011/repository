...
@Document(collection="hall_recommend")
//@CompoundIndexes({
...
//})
public class HallRecommend implements Serializable{
	...
	private Long v2;//每个值代表 0，自己推荐的，2，二级代理推荐，3，三级代理推荐,
	// 4,一级推广员的代理充值返利，5，二级推广员的代理充值返利，6三级推广员的代理充值返现
