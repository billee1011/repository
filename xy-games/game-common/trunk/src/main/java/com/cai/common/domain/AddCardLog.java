...
@CompoundIndexes({ @CompoundIndex(name = "index_accountId", def = "{'accountId': 0}"),
		@CompoundIndex(name = "index_nickname", def = "{'nickname': 0}"), @CompoundIndex(name = "index_shopId", def = "{'shopId': 0}"),
		@CompoundIndex(name = "index_sellType", def = "{'sellType': 0}"),
		@CompoundIndex(name = "index_cashAccountName", def = "{'cashAccountName': 0}"),
		@CompoundIndex(name = "index_ossName", def = "{'ossName': 0}"), @CompoundIndex(name = "index_accountType", def = "{'accountType': 0}"),
		@CompoundIndex(name = "index_sellType", def = "{'sellType': 0}"),
