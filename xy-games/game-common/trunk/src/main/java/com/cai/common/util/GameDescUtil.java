...
public class GameDescUtil {
	...
	public static String getGameDescBase(DescParams descParam) {
		...
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MJ_HE_ZE)) {
			return GameDescUtil.get_game_des_lygc_dian_pao(_game_rule_index, descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE_GANG),
					descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE_PAO), descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE),
					descParam);
		}
		...
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_THJ_YI_YANG)) {
			return get_game_des_hnyiyang(rules, _game_rule_index);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MJ_YUAN_JIANG) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DDZ_KL)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WSK_YSDZ) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_QJQF)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WSK_YXZD)) {
			return getCommonDesc(descParam.getMap(), descParam.groupConfig);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_YI_YANG_BA_SHI) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DDZ_LF)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_TXW) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WSK_ZZSHA)
		...
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MJ_ZPTDH)) {
			return get_game_des_zptdh(descParam.getMap(), descParam.groupConfig);
		}
		...
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PHZ_XX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_ZN)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WSK_XNDG) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_GDY_NP)) {
			return getCommonDesc(descParam.getMap(), descParam.groupConfig);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_CP_DZHUA)) {
			return getCommonDesc(descParam.getMap(), descParam.groupConfig);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MJ_RUI_JIN) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MJ_WEINAN)) {
			return getCommonDescEx(descParam.getMap(), descParam.groupConfig);
		}

		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WHZ_YIYANG) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WHZ_YY)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LAOPAI_XUPU) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PHZ_SYBP)
		...
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_YY) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_YY)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DEH_MG) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DEH_MQ)
				...
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_AH) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_AH)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_YUEY)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_YUEY) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DDZ_JX)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_CZ) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_CZ)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_DT) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_DT)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_ZN_CZ) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_XY)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_XY) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_NP)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_NP) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_LD)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_LD) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_DL)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_DL) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_HN)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_HN) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_GDY_RAR)) {
			return getCommonDescEx(descParam.getMap(), descParam.groupConfig);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WSK_DMZ_YY) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SC)) {
			return getCommonDescEx(descParam.getMap(), descParam.groupConfig);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_KL) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_KL)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_ZN_KL)) {
			return getCommonDescEx(descParam.getMap(), descParam.groupConfig);
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_WSK_DMZ) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MJ_XU_PU)
		...
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_XTHH)) {
			...
			return get_game_des_henan_xinxiang(_game_type_index, _game_rule_index);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HENAN) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HENAN_ZMD)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HENAN_KF) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HENAN_NY)
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HENAN_PDS) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_NEW_HE_NAN)
		...
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_CS) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HALL_CHANG_SHA_MJ)
			...
			return get_game_des_gxzp(_game_rule_index);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PHZ_CHD)) {
			return get_game_des_phz_chd(_game_rule_index, _game_type_index, descParam);
			...
			return get_game_des_phz_chd(_game_rule_index, _game_type_index, descParam);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LHQ_HD) || (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LHQ_HY))
				|| (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LHQ_QD))) {
			return get_game_des_lhq(_game_type_index, _game_rule_index);
			...
			return get_game_des_wmq(_game_rule_index);
			...
			return get_game_des_ox(_game_type_index, _game_rule_index, descParam);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_BTZ_YY) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_TTZ)) {
			return get_game_des_BTZ(_game_type_index, _game_rule_index);
				...
				|| (GameConstants.GAME_TYPE_BTZ_TB_BEGIN <= _game_type_index && GameConstants.GAME_TYPE_BTZ_TB_END >= _game_type_index)) {
			...
			return get_game_des_sg(_game_rule_index);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_JD_LL)) {
			...
			return get_game_des_pdk(_game_rule_index, _game_type_index);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_PDK_SW_LL)) {
			return get_game_des_pdk(_game_rule_index, _game_type_index);
		} else if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DDZ_JD) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_DDZ_DL)) {
			...
			return get_henanxc_game_des(_game_type_index, rules, descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE),
			...
			return GameDescUtil.get_game_des_lygc(_game_rule_index, descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE_GANG),
					descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE_CI), descParam.getRuleValue(GameConstants.GAME_RULE_BASE_SCORE),
					descParam);
			...
			return get_game_des_hnll(_game_type_index, _game_rule_index, rules);
		...
		if ((_game_type_index == GameConstants.GAME_TYPE_ZZ) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HZ)
				...
				|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LILING_ZZ) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_ZHUZHOU_ZZ)
			...
			if ((is_mj_type(_game_type_index, GameConstants.GAME_TYPE_HALL_ZHUAN_ZHUAN_MJ)
					...
					|| is_mj_type(_game_type_index, GameConstants.GAME_TYPE_ZHUZHOU_ZZ)) && has_rule(rules, GameConstants.GAME_RULE_ZHUANG_NIAO)) {
				if (hasFirst) {
					des += " 按庄家中鸟";
				} else {
					des += "按庄家中鸟";
	...
	private static String get_game_des_zptdh(Map<Integer, Integer> ruleMaps,
			GameGroups groupConfig) {
		StringBuffer b = new StringBuffer();
		groupConfig.getGroupModels().forEach((group) -> {
	 ...
	 * @return
	 */
	public static String get_game_des_lygc(int _game_rule_index, Integer gang_di_feng, Integer ci_di_feng, Integer zimo_di_feng,
	...
	public static String get_game_des_lygc_dian_pao(int _game_rule_index, Integer gang_di_feng, Integer pao_di_feng, Integer zimo_di_feng,
			DescParams descParam) {
		if (gang_di_feng == null) {
			gang_di_feng = 0;
		}
	...
	private static String get_game_des_pdk(int _game_rule_index, int game_type_index) {
		...
		String des = "";
		if (is_mj_type(game_type_index, GameConstants.GAME_TYPE_PDK_JD) || is_mj_type(game_type_index, GameConstants.GAME_TYPE_PDK_JD_LL)) {
			des += "经典玩法";
		...
		if (is_mj_type(game_type_index, GameConstants.GAME_TYPE_PDK_SW) || is_mj_type(game_type_index, GameConstants.GAME_TYPE_PDK_SW_LL)) {
			des += "十五张玩法";
			if (has_rule(_game_rule_index, GameConstants.GAME_RULE_HONGTAO10_ZANIAO)) {
				des += "扎鸟";
			}
	...
	private static String get_game_des_ox(int _game_type_index, int _game_rule_index, DescParams descParam) {
		String des = "";
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_TBOX_LX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_TBOX)) {
			des += "通比牛牛" + "\n";
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_SEVER_OX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_SEVER_OX_LX)) {
			des += "房主上庄" + "\n";
		}

		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LZOX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_LZOX_LX)) {
			des += "轮流上庄" + "\n";
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_SZOX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_SZOX_LX)) {
			des += "牛牛上庄" + "\n";
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_ZYQOX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_ZYQOX_LX)) {
			des += "自由抢庄" + "\n";
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MFZOX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MFZOX_LX)) {
			des += "看四张抢庄" + "\n";
		}
		if (is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MSZOX) || is_mj_type(_game_type_index, GameConstants.GAME_TYPE_MSZOX_LX)) {
			des += "明三张抢庄" + "\n";
		}
	...
	private static String get_game_des_lhq(int game_type_index, int _game_rule_index) {
		...
		if (is_mj_type(game_type_index, GameConstants.GAME_TYPE_LHQ_QD) || is_mj_type(game_type_index, GameConstants.GAME_TYPE_LHQ_HY)) {
			if (has_rule(_game_rule_index, GameConstants.GAME_RULE_DI_AN_WEI)) {
				des += "暗偎" + " ";
			}
		}
	...
	private static String get_game_des_henan_xinxiang(int game_type_index, int _game_rule_index) {
		String des = "";
		boolean hasFirst = false;
		if (has_rule(_game_rule_index, GameConstants.GAME_RULE_HENAN_THREE)) {
			if (hasFirst) {
	...
	private static String get_game_des_henan(int game_type_index, int _game_rule_index, int[] rules) {
		...
		if ((is_mj_type(game_type_index, GameConstants.GAME_TYPE_HENAN_NY) || is_mj_type(game_type_index, GameConstants.GAME_TYPE_NEW_NAN_YANG))) {
			if (has_rule(_game_rule_index, GameConstants.GAME_RULE_HENAN_HZBHG)) {
				if (hasFirst) {
					des += " 荒庄不荒杠";
				} else {
	...
	public static String get_game_des_hnyiyang(int[] rules, int _game_rule_index) {
		String des = "";
		boolean hasFirst = false;
	...
	public static String getGameDesc(ClubRuleModel rules, GameGroups groups) {
		...
		if (GameConstants.SYS_GAME_TYPE_DBN == rules.getGame_type_index() || GameConstants.GAME_TYPE_TDZ_SHAN_XI == rules.getGame_type_index()) {
