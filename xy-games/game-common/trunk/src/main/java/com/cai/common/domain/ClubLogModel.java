...
@CompoundIndexes({ @CompoundIndex(name = "index_accountId", def = "{'accountId': 0}"), @CompoundIndex(name = "index_clubId", def = "{'clubId': 0}"),
		@CompoundIndex(name = "index_create_time", def = "{'create_time': 0}"), @CompoundIndex(name = "index_v1", def = "{'v1': 0}") })
