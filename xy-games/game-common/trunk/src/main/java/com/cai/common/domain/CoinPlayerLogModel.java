...
@CompoundIndexes({ @CompoundIndex(name = "index_detailId", def = "{'detailId': 0}"), @CompoundIndex(name = "index_timeFlag", def = "{'timeFlag': 0}"),
		@CompoundIndex(name = "index_flag", def = "{'flag': 0}"), })
