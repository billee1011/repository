...
public class GameRoomRecord implements Serializable {
	 ...
	 * 房间里的人
	 */
	private Player[] players = {null,null,null,null};//new RoomPlayer[4];
	...
	public int release_players[]={0,0,0,0};
	
	public int request_player_seat=MJGameConstants.INVALID_SEAT;
