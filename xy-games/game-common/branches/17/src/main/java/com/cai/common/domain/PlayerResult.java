...
public class PlayerResult {
	...
	public PlayerResult(long create_player_id,int room_id,int game_type_index,int game_rule_index,int game_round,String game_rule_des){
		...
		game_score = new float[MJGameConstants.GAME_PLAYER]; 
		lost_fan_shu = new int[MJGameConstants.GAME_PLAYER][MJGameConstants.GAME_PLAYER]; 
		win_order= new int[MJGameConstants.GAME_PLAYER];
		
		zi_mo_count= new int[MJGameConstants.GAME_PLAYER];
		jie_pao_count= new int[MJGameConstants.GAME_PLAYER];
		dian_pao_count= new int[MJGameConstants.GAME_PLAYER];
		an_gang_count= new int[MJGameConstants.GAME_PLAYER];
		ming_gang_count= new int[MJGameConstants.GAME_PLAYER];
		
		
		da_hu_zi_mo= new int[MJGameConstants.GAME_PLAYER];
		da_hu_jie_pao= new int[MJGameConstants.GAME_PLAYER];
		da_hu_dian_pao= new int[MJGameConstants.GAME_PLAYER];
		xiao_hu_zi_mo= new int[MJGameConstants.GAME_PLAYER];
		xiao_hu_jie_pao= new int[MJGameConstants.GAME_PLAYER];
		xiao_hu_dian_pao= new int[MJGameConstants.GAME_PLAYER];
		
		piao_lai_count= new int[MJGameConstants.GAME_PLAYER];
