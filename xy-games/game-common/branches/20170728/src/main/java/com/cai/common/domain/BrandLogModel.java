...
@CompoundIndexes({
	...
	@CompoundIndex(name = "index_account", def = "{'account_id': 0}"),
    @CompoundIndex(name = "index_game_id", def = "{'game_id': 0}"),
    @CompoundIndex(name = "index_log_type", def = "{'log_type': 0}"),
    @CompoundIndex(name = "index_brand_id", def = "{'brand_id': 0}"),
    @CompoundIndex(name = "index_v1", def = "{'v1': 0}"),
    @CompoundIndex(name = "index_brand_parent_id", def = "{'brand_parent_id': 0}",background=true),
	@CompoundIndex(name = "index_room_id", def = "{'v3': 0}",background=true),
